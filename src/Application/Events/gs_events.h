...
#include "Infrastructure/DataStructures/blocking_queue.h"
...
class GolfSimEventBase
{
  public:
    ...
    {
        return "GolfSimEventBase - Should have been overridden";
    };
};
...
class BeginWatchingForBallHit : public GolfSimEventBase
{
  public:
    ...
    virtual std::string Format() override
    {
        return "BeginWatchingForBallHit";
    };
};
...
class BeginWaitingForBallPlaced : public GolfSimEventBase
{
  public:
    ...
    virtual std::string Format() override
    {
        return "BeginWaitingForBallPlaced";
    };
};
...
class BallHit : public GolfSimEventBase
{
  public:
    ...
    {
        ball_ = ball; ball_hit_image_ = ball_hit_image;
    };
    ~BallHit()
    {
    };
...
class ControlMessage : public GolfSimEventBase
{
  public:
    ...
    virtual std::string Format() override
    {
        return "ControlMessage - " + GsIPCControlMsg::FormatControlMessageType(message_type_);
    };
...
class BeginWaitingForSimulatorArmed : public GolfSimEventBase
{
  public:
    ...
    virtual std::string Format() override
    {
        return "BeginWaitingForSimulatorArmed";
    };
};
...
class CheckForCam2ImageReceived : public GolfSimEventBase
{
  public:
    ...
    virtual std::string Format() override
    {
        return "CheckForCam2ImageReceived";
    };
};
...
{
  public:
    Camera2PreImageReceived(const cv::Mat &ball_pre_image)
    {
        ball_pre_image_ = ball_pre_image;
    };
...
class ArmCamera2MessageReceived : public GolfSimEventBase
{
  public:
    ...
    virtual std::string Format() override
    {
        return "ArmCamera2MessageReceived";
    };

    // TBD - Not sure if the camera1 system will send any additional information
};

// The camera2 has been triggered and a picture of the ball in flight has been
// taken.
class Camera2Triggered : public GolfSimEventBase
{
  public:
    Camera2Triggered(cv::Mat &ball_flight_image)
    {
        ball_flight_image_ = ball_flight_image;
    };
    ~Camera2Triggered()
    {
    };
...
struct GolfSimEventElement
{
    ...
    // TBD - Do we need a std::move constructor and assignment here?  Will that
    // work with a variant?
