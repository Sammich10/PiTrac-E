...
// Certain states have associated state information, such as a golf_ball
// structure or image.
...
// Signal to (for example), any threads that the FSM is going to be shutdown
// soon.
void StartFsmShutdown();
}

#endif //#ifndef GS_FSM_H
