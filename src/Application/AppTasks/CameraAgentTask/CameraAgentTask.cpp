...
{
    std::unique_ptr<GSCameraInterface> camera_1 = std::make_unique<IMX296Camera>(1456, 1088, 2.8f, PiTrac::TriggerMode::FREE_RUNNING);
    // std::unique_ptr<GSCameraInterface> camera_2 = std::make_unique<IMX296Camera>(1456, 1088, 2.8f, PiTrac::TriggerMode::FREE_RUNNING);
