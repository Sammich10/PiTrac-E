...
#include "ImageAnalysis/domain/interfaces.hpp"
#include "ImageAnalysis/domain/analysis_results.hpp"
#include <memory>
#include <map>
...
{
    std::string type = "opencv";               // "opencv", "yolo",
                                               // "tensorflow_lite", etc.
...
class ImageAnalysisService
{
  public:
    ...
    mutable std::map<CacheKey, std::string> result_cache_;      // JSON
                                                                // serialized
                                                                // results
    // Helper methods
