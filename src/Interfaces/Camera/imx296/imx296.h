...
public:
     ...
     */
    IMX296Camera(int width, int height, float focalLength, TriggerMode mode = TriggerMode::FREE_RUNNING) 
     ...
     */
    CAMERA_TYPE getCameraType() const final { return CAMERA_TYPE::CAMERA_INNOMAKER_IMX296GS; }
