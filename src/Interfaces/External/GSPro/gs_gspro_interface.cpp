...
namespace PiTrac {
    ...
    GsGSProInterface::GsGSProInterface() {
        ...
        if (!GolfSimOptions::GetCommandLineOptions().gspro_host_address_.empty()) {
            ...
            GolfSimConfiguration::SetConstant("gs_config.PiTraculator_interfaces.GSPro.kGSProConnectAddress", socket_connect_address_);
        }
        GolfSimConfiguration::SetConstant("gs_config.PiTraculator_interfaces.GSPro.kGSProConnectPort", socket_connect_port_);
    }
