 ...
 */
    ...
    (
        const std::string &camera_uuid,
        CameraControlSettings_Type &settings
    );
    ...
    bool putExtrinsicCalibration
    (
        uint32_t calibration_id,
        const CameraExtrinsics_Type &extrinsics
    );
  ...
  private:
    ...
    enum CalibrationDataQuery_Type
    {
        ...
        PUT_EXTRINSIC_CALIBRATION,
        GET_EXTRINSIC_CALIBRATION,
