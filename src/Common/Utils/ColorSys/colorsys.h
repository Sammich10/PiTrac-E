...
namespace PiTrac {
    ...
    private:
        ...
        /**
         * @brief Computes the floating-point modulus of two numbers, ensuring a non-negative result.'
         * 
         * @param a The dividend (numerator).
         * @param b The divisor (denominator).
         * @return The floating-point modulus of `a` and `b`, adjusted to be non-negative with respect to `b`.
         */
