...
void GSLogger::Init() {
    ...
    // Create formatter with timestamp, PID, process name, thread ID, severity, and message
    // Format: [YYYY-MM-DD HH:MM:SS.ffffff] [PID:0x12345] [ProcessName] [TID:0x12345] [SEVERITY] Message
