...
bool GolfSimCamera::kUsePreImageSubtraction = false;      // Ultimately, this
                                                          // concept was not as
                                                          // helpful as hoped
                                                          // for
...
// Fixed amount to subtract or add to an expected radius to produce a reasonable
// range
...
int GolfSimCamera::kExternallyStrobedEnvPreHoughBlurSize = 13;      // 6 for
                                                                    // External
                                                                    // Strobe, 9
                                                                    // for
                                                                    // normal
...
CameraHardware::CameraModel GolfSimCamera::kSystemSlot1CameraType =
...
GolfSimCamera::GolfSimCamera()
{
    ...
    // The following constants are only used internal to the GolfSimCamera
    // class, and so can be initialized in the constructor
    GolfSimConfiguration::SetConstant("gs_config.logging.kLogIntermediateExposureImagesToFile",
                                      kLogIntermediateExposureImagesToFile);
    GolfSimConfiguration::SetConstant("gs_config.logging.kLogWebserverImagesToFile",
                                      kLogWebserverImagesToFile);
    GolfSimConfiguration::SetConstant("gs_config.logging.kLogDiagnosticImagesToUniqueFiles",
                                      kLogDiagnosticImagesToUniqueFiles);


    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaximumOffTrajectoryDistance",
        kMaximumOffTrajectoryDistance);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kNumberHighQualityBallsToRetain",
        kNumberHighQualityBallsToRetain);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxStrobedBallColorDifferenceStrict",
        kMaxStrobedBallColorDifferenceStrict);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxStrobedBallColorDifferenceRelaxed",
        kMaxStrobedBallColorDifferenceRelaxed);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kBallProximityMarginPercentRelaxed",
        kBallProximityMarginPercentRelaxed);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxPuttingBallColorDifferenceRelaxed",
        kMaxPuttingBallColorDifferenceRelaxed);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kBallProximityMarginPercentStrict",
        kBallProximityMarginPercentStrict);

    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kColorDifferenceRgbPostMultiplierForDarker",
        kColorDifferenceRgbPostMultiplierForDarker);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kColorDifferenceRgbPostMultiplierForLighter",
        kColorDifferenceRgbPostMultiplierForLighter);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kColorDifferenceStdPostMultiplierForDarker",
        kColorDifferenceStdPostMultiplierForDarker);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kColorDifferenceStdPostMultiplierForLighter",
        kColorDifferenceStdPostMultiplierForLighter);

    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxDistanceFromTrajectory",
        kMaxDistanceFromTrajectory);

    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kClosestBallPairEdgeBackoffPixels",
        kClosestBallPairEdgeBackoffPixels);
    GolfSimConfiguration::SetConstant("gs_config.ball_exposure_selection.kMaxBallsToRetain",
                                      kMaxBallsToRetain);

    GolfSimConfiguration::SetConstant("gs_config.strobing.kStandardBallSpeedSlowdownPercentage",
                                      kStandardBallSpeedSlowdownPercentage);
    GolfSimConfiguration::SetConstant("gs_config.strobing.kPracticeBallSpeedSlowdownPercentage",
                                      kPracticeBallSpeedSlowdownPercentage);
    GolfSimConfiguration::SetConstant("gs_config.strobing.kPuttingBallSpeedSlowdownPercentage",
                                      kPuttingBallSpeedSlowdownPercentage);
    GolfSimConfiguration::SetConstant("gs_config.strobing.kCameraRequiresFlushPulse",
                                      kCameraRequiresFlushPulse);


    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxIntermediateBallRadiusChangePercent",
        kMaxIntermediateBallRadiusChangePercent);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxPuttingIntermediateBallRadiusChangePercent",
        kMaxPuttingIntermediateBallRadiusChangePercent);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxOverlappedBallRadiusChangeRatio",
        kMaxOverlappedBallRadiusChangeRatio);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxRadiusDifferencePercentageFromBest",
        kMaxRadiusDifferencePercentageFromBest);

    GolfSimConfiguration::SetConstant("gs_config.calibration.kCamera1CalibrationDistanceToBall",
                                      kCamera1CalibrationDistanceToBall);
    GolfSimConfiguration::SetConstant("gs_config.calibration.kCamera2CalibrationDistanceToBall",
                                      kCamera2CalibrationDistanceToBall);

    GolfSimConfiguration::SetConstant("gs_config.ball_position.kTeedBallSearchAreaMaskRadiusRatio",
                                      kTeedBallSearchAreaMaskRadiusRatio);

    GolfSimConfiguration::SetConstant("gs_config.cameras.kCamera1XOffsetForTilt",
                                      kCamera1XOffsetForTilt);
    GolfSimConfiguration::SetConstant("gs_config.cameras.kCamera1YOffsetForTilt",
                                      kCamera1YOffsetForTilt);
    GolfSimConfiguration::SetConstant("gs_config.cameras.kCamera2XOffsetForTilt",
                                      kCamera2XOffsetForTilt);
    GolfSimConfiguration::SetConstant("gs_config.cameras.kCamera2YOffsetForTilt",
                                      kCamera2YOffsetForTilt);

    GolfSimConfiguration::SetConstant("gs_config.ball_position.kExpectedBallPositionXcm",
                                      kExpectedBallPositionXcm);
    GolfSimConfiguration::SetConstant("gs_config.ball_position.kExpectedBallPositionYcm",
                                      kExpectedBallPositionYcm);
    GolfSimConfiguration::SetConstant("gs_config.ball_position.kExpectedBallPositionZcm",
                                      kExpectedBallPositionZcm);
    GolfSimConfiguration::SetConstant("gs_config.ball_position.kExpectedBallRadiusPixelsAt40cm",
                                      kExpectedBallRadiusPixelsAt40cm);
    GolfSimConfiguration::SetConstant("gs_config.ball_position.kMaxMovedBallRadiusRatio",
                                      kMaxMovedBallRadiusRatio);
    GolfSimConfiguration::SetConstant("gs_config.ball_position.kMinMovedBallRadiusRatio",
                                      kMinMovedBallRadiusRatio);
    ...
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kUnlikelyAngleMinimumDistancePixels",
        kUnlikelyAngleMinimumDistancePixels);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxQualityExposureLaunchAngle",
        kMaxQualityExposureLaunchAngle);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMinQualityExposureLaunchAngle",
        kMinQualityExposureLaunchAngle);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMaxPuttingQualityExposureLaunchAngle",
        kMaxPuttingQualityExposureLaunchAngle);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kMinPuttingQualityExposureLaunchAngle",
        kMinPuttingQualityExposureLaunchAngle);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_exposure_selection.kNumberAngleCheckExposures",
        kNumberAngleCheckExposures);

    GolfSimConfiguration::SetConstant("gs_config.ball_exposure_selection.kUsePreImageSubtraction",
                                      kUsePreImageSubtraction);

    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvFilterImage",
                                      kExternallyStrobedEnvFilterImage);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvBottomIgnoreHeight",
                                      kExternallyStrobedEnvBottomIgnoreHeight);

    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvFilterHsvLowerH",
                                      kExternallyStrobedEnvFilterHsvLowerH);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvFilterHsvUpperH",
                                      kExternallyStrobedEnvFilterHsvUpperH);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvFilterHsvLowerS",
                                      kExternallyStrobedEnvFilterHsvLowerS);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvFilterHsvUpperS",
                                      kExternallyStrobedEnvFilterHsvUpperS);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvFilterHsvLowerV",
                                      kExternallyStrobedEnvFilterHsvLowerV);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvFilterHsvUpperV",
                                      kExternallyStrobedEnvFilterHsvUpperV);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvCannyLower",
                                      kExternallyStrobedEnvCannyLower);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvCannyUpper",
                                      kExternallyStrobedEnvCannyUpper);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvPreHoughBlurSize",
                                      kExternallyStrobedEnvPreHoughBlurSize);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvPreCannyBlurSize",
                                      kExternallyStrobedEnvPreCannyBlurSize);
    GolfSimConfiguration::SetConstant(
        "gs_config.testing.kExternallyStrobedEnvHoughLineIntersections",
        kExternallyStrobedEnvHoughLineIntersections);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvLinesAngleLower",
                                      kExternallyStrobedEnvLinesAngleLower);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvLinesAngleUpper",
                                      kExternallyStrobedEnvLinesAngleUpper);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvMaximumHoughLineGap",
                                      kExternallyStrobedEnvMaximumHoughLineGap);
    GolfSimConfiguration::SetConstant(
        "gs_config.testing.kExternallyStrobedEnvMinimumHoughLineLength",
        kExternallyStrobedEnvMinimumHoughLineLength);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallUseLargestBall",
                                      kPlacedBallUseLargestBall);
}
                                        ...
                                        GolferOrientation &handedness)
{
    GS_LOG_TRACE_MSG(trace,
                     "DetermineHandedness called with " + std::to_string(input_balls.size()) +
                     " balls.");
    ...
    // Counts the pairs of balls where the left ball is lower than the right
    // ball
    ...
    handedness = (positive_slope_count >=
                  0) ? GolferOrientation::kRightHanded : GolferOrientation::kLeftHanded;
    std::string handedness_string = (handedness ==
                                     GolferOrientation::kRightHanded) ? "right_handed" :
                                    "left_handed";
    GS_LOG_TRACE_MSG(trace,
                     "DetermineHandedness result: " + handedness_string +
                     ", with positive_slope_count = " + std::to_string(positive_slope_count));

    return true;
}

int GolfSimCamera::getExpectedBallRadiusPixels(const CameraHardware &camera_hardware,
                                               const int resolution_x_,
                                               const double distance)
{
    if (!camera_hardware.cameraInitialized || resolution_x_ <= 0)
    {
        GS_LOG_MSG(warning,
                   "Camera hardware (or resolution x value) not initialized in getExpectedBallRadiusPixels!");
        // TBD - For now, just ignore.    return false;
    }

    // Get a reasonable default in case (for some reason), the camera's expected
    // radius has not been set
    double radius = kExpectedBallRadiusPixelsAt40cm;

    // Get the camera's expected ball radius.  There might be two different
    // cameras, or two different
    ...
    else
    {
        GS_LOG_TRACE_MSG(warning,
                         "expected_ball_radius_pixels_at_40cm_ not set in camera in GolfSimCamera::getExpectedBallRadiusPixels().  Setting to default instead.");
    }

    GS_LOG_TRACE_MSG(trace,
                     "getExpectedBallRadiusPixels called with resolution: " +
                     std::to_string(resolution_x_) +
                     ", distance: " + std::to_string(distance) +
                     ", and with expected radius at 40cm of: " + std::to_string(radius));
    ...
    GS_LOG_TRACE_MSG(trace,
                     "getExpectedBallRadiusPixels returning: " +
                     std::to_string(std::round(radius)));

    return (int)std::round(radius);
}

std::vector<cv::Scalar> GolfSimCamera::GetBallHSVRange(const cv::Scalar &ball_color_RGB)
{
    // Create an HSV range around the average color that will be broad enough to
    // encompass
    // any expected HSV values of pixes in the golf ball as it moves through the
    // frame
    //hsv = cs.rgb_to_hsv(ball_color_[2], ball_color_[1], ball_color_[0])
    cv::Scalar hsvAvg = CvUtils::ConvertRgbToHsv(ball_color_RGB);

    //GS_LOG_TRACE_MSG(trace, "GetBallHSVRange COLORSYS computed HSV of: " +
    // std::to_string(hsvAvg))

    // Note that the consumer of this function will need to loop around the 360
    // degree circle if the widened hue numbers
    // go belore zero
    ...
    float smax = (float)std::min((int)CvUtils::kOpenCvSatMax,
                                 (int)hsvAvg[1] + S_MAX_CAL_COLOR_WIDENING_AMOUNT);
    float vmax = (float)std::min((int)CvUtils::kOpenCvValMax,
                                 (int)hsvAvg[2] + V_MAX_CAL_COLOR_WIDENING_AMOUNT);

    cv::Scalar hsvMin{ hmin, smin, vmin };
    cv::Scalar hsvMax{ hmax, smax, vmax };

    std::vector<cv::Scalar> r;
    r.push_back(hsvMin);
    r.push_back(hsvMax);

    GS_LOG_TRACE_MSG(trace,
                     "GetBallHSVRange for average (" + LoggingTools::Formatcv::Scalar(hsvAvg) +
                     ") = "
                     + LoggingTools::Formatcv::Scalar(hsvMin) + " | " +
                     LoggingTools::Formatcv::Scalar(hsvMax));
                                      ...
                                      const bool expectBall)
{
    ...
    if (rgbImg.rows != camera_hardware_.resolution_y_ ||
        rgbImg.cols != camera_hardware_.resolution_x_)
    {
    ...
    else
    {
        ...
        GS_LOG_TRACE_MSG(trace,
                         "GetCalibratedBall called for camera2 (usually used for camera1 images).");
    }

    // If we are calibrating the focal length, then override the distance to
    // that specified in
    // the JSON file
    if (GolfSimOptions::GetCommandLineOptions().system_mode_ == SystemMode::kCamera1Calibrate ||
        ...
        SystemMode::kCamera1TestStandalone ||
        GolfSimOptions::GetCommandLineOptions().system_mode_ == SystemMode::kCamera2TestStandalone)
    {
        ...
        {
            if (GolfSimOptions::GetCommandLineOptions().GetCameraNumber() ==
            ...
            GS_LOG_TRACE_MSG(trace,
                             "GetCalibratedBall overriding expected_distance.  Setting to: " +
                             std::to_string(expected_distance));
        }
    }

    GS_LOG_TRACE_MSG(trace,
                     "GetCalibratedBall using expected ball distance of: " +
                     std::to_string(expected_distance));

    // TBD - Will want to be able to vary the calibration distance later
    double expectedRadius = getExpectedBallRadiusPixels(camera.camera_hardware_,
                                                        rgbImg.cols,
                                                        expected_distance);
    ...
    GS_LOG_TRACE_MSG(trace,
                     "GetCalibratedBall Looking for a ball with min/max radius (pixels) of: " +
    ...
    if (expected_ball_X == 0 && expected_ball_Y == 0)
    {
        ...
        double search_area_radius = max * 1.1;      // add a little buffer to
                                                    // make sure we can find
                                                    // things at the edge
        roi = cv::Rect{ (int)(expected_ball_X - search_area_radius),
                        (int)(expected_ball_Y - search_area_radius),
    ...
    if (kTeedBallSearchAreaMaskRadiusRatio > 0.01)
    {
        ...
        GS_LOG_TRACE_MSG(trace,
                         "GetCalibratedBall using search mask_radius (computed using kTeedBallSearchAreaMaskRadiusRatio="
                         + std::to_string(kTeedBallSearchAreaMaskRadiusRatio) + " of: " +
                         std::to_string(mask_radius));
        ip->area_mask_image_ = CvUtils::GetAreaMaskImage(rgbImg.cols,
                                                         rgbImg.rows,
                                                         expected_ball_X,
                                                         expected_ball_Y,
                                                         mask_radius,
    ...
    else
    {
        ...
        GS_LOG_TRACE_MSG(trace,
                         "GetCalibratedBall not using a search mask_radius (because kTeedBallSearchAreaMaskRadiusRatio was = "
                         + std::to_string(kTeedBallSearchAreaMaskRadiusRatio));
    }

    // The whole point here is that we don't know the color until we calibrate,
    // so force a
    // very broad color range mask
    // NOTE - the entire color thing is pretty much deprecated now - signal that
    ...
    ShowAndLogBalls("GetBallReturnedBalls",
                    rgbImg,
                    return_balls,
                    kLogIntermediateExposureImagesToFile);

    // Assign the returned ball's information to the ball this function will
    // return
    ...
    ShowAndLogBalls("GetBallReturnedBalls Final Ball:",
                    rgbImg,
                    final_ball,
                    kLogIntermediateExposureImagesToFile);

    // We were able to discern a circle that the system thinks is a ball -
    // return the ball with the information corresponding to it inside

    // Setup a ball to return with all the pertinent information
    b.measured_radius_pixels_ = b.ball_circle_[2];

    // We might also try to force the user to put the ball at a specific
    // distance from the camera and calibrate from that
    // Note that the distance being calculated here is not the Z-axis only
    // distance, but instead it is the distance
        ...
        GolfSimOptions::GetCommandLineOptions().system_mode_ == SystemMode::kCamera2Calibrate)
    {
        ...
        // Note - since we are measuring the ball using the standard focal
        // length of the camera hardware,
        // when we compute the length again here, it should be the same.  We'd
        // use this if we have the ball
        // at a known, precise distance and then get the focal length that makes
        // the system find that distance.
        b.calibrated_focal_length_ = computeFocalDistanceFromBallData(camera,
                                                                      b.measured_radius_pixels_,
                                                                      distance_direct_to_ball);
        GS_LOG_MSG(info,
                   "Calibrated focal length for distance " +
                   std::to_string(distance_direct_to_ball) + " and Radius: " +
                   std::to_string(b.measured_radius_pixels_) +
    ...
    // The golf ball may not be centered in the frame of the camera.  Determine
    // the angle at which
    // the ball sits so that it can be taken into account for, e.g., ball
    // rotation perspectives

    if (!ComputeXyzDistanceFromOrthoCamPerspective(camera, b,
                                                   b.distances_ortho_camera_perspective_))
    {
        GS_LOG_MSG(error, "Could not calculate ComputeXyzDistanceFromOrthoCamPerspective");
        return false;
    }
    if (!ComputeBallXYAnglesFromCameraPerspective(b.distances_ortho_camera_perspective_,
                                                  b.angles_camera_ortho_perspective_))
    {
...
{
    std::vector<cv::Scalar> stats = CvUtils::GetBallColorRgb(color_image, b.ball_circle_);
    b.average_color_ = stats[0];
    b.median_color_ = stats[1];
    b.std_color_ = stats[2];
    b.ball_color_ = GolfBall::BallColor::kCalibrated;

    std::vector<cv::Scalar> hsvRange = GetBallHSVRange(b.average_color_);
...
{
    // TBD - Just started work on this.  Not sure we need to negate ALL of the
    // angles
    // If this is wrong, it can scew up the spin analysis.
    // ball.position_deltas_ball_perspective_ =
    // -ball.position_deltas_ball_perspective_;
    ball.angles_ball_perspective_ = -ball.angles_ball_perspective_;
    return true;
}

bool GolfSimCamera::ComputeBallDeltas(GolfBall &ball1,
                                      GolfBall &ball2,
                                      const GolfSimCamera &first_camera,
                                      const GolfSimCamera &second_camera)
{
    if (!ComputeSingleBallXYZOrthoCamPerspective(first_camera, ball1))
    {
        GS_LOG_MSG(error,
                   "ComputeBallDeltas: Could not ComputeSingleBallXYZOrthoCamPerspective for ball1");
        return false;
    }

    // The second ball is assumed always to be related to camera 2, so use
    // kCamera2Angles
    if (!ComputeSingleBallXYZOrthoCamPerspective(second_camera, ball2))
    {
        GS_LOG_MSG(error,
                   "ComputeBallDeltas: Could not ComputeSingleBallXYZOrthoCamPerspective for ball2");
        return false;
    }
    ...
    // At this point, we know the distances and angles of each ball relative to
    // the camera
    // Next, find the delta differences in distance and angles as between the
    // two balls

    if (!ComputeXyzDeltaDistances(ball1,
                                  ball2,
                                  ball2.position_deltas_ball_perspective_,
    ...
    // If the images were taken by different cameras at some distance from each
    // other, we will account for that here
    // For example, if the second camera is to the right of the first (looking
    // at the ball), then that right-direction
    // distance on the X axis should be added to the distance delta in the
    // X-axis of the ball.

    if (first_camera.camera_hardware_.camera_number_ !=
        second_camera.camera_hardware_.camera_number_)
    {
    ...
    if (!getXYDeltaAnglesBallPerspective(ball2.position_deltas_ball_perspective_,
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Calculated DELTA X,Y, Z distances (ball perspective) are: " +
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Calculated currentDistance is: " +
                     std::to_string(ball2.distance_to_z_plane_from_lens_) + " meters = " +
                     std::to_string(12 *
                                    CvUtils::MetersToFeet(ball2.distance_to_z_plane_from_lens_)) +
...
bool GolfSimCamera::ComputeSingleBallXYZOrthoCamPerspective(const GolfSimCamera &camera,
                                                            GolfBall &ball1 )
{
    ball1.distance_to_z_plane_from_lens_ = ComputeDistanceToBallUsingRadius(camera, ball1);

    // The golf ball may not be centered in the frame of the camera.  Determine
    // the distances and angle at which
    // the ball sits so that it can be taken into account for, e.g., ball
    // rotation perspectives
    if (!ComputeXyzDistanceFromOrthoCamPerspective(camera,
                                                   ball1,
                                                   ball1.distances_ortho_camera_perspective_))
    {
        GS_LOG_MSG(error, "Could not calculate ComputeXyzDistanceFromOrthoCamPerspective");
        return false;
    }

    if (!ComputeBallXYAnglesFromCameraPerspective(ball1.distances_ortho_camera_perspective_,
                                                  ball1.angles_camera_ortho_perspective_))
    {
        GS_LOG_MSG(error, "Could not calculate ComputeBallXYAnglesFromCameraPerspective");
        return false;
    }
    ...
    /* DEBUG
     * GS_LOG_TRACE_MSG(trace, "Calculated X,Y angles (camera perspective) (in
     * degrees) are: " + std::to_string(angles_camera_perspective[0]) + ", " +
     *  std::to_string(angles_camera_perspective[1]));
     *
     * GS_LOG_TRACE_MSG(trace, "Calculated X,Y angles (ball perspective) (in
     * degrees) are: " + std::to_string(angles_ball_perspective[0]) + ", " +
...
{
    GS_LOG_TRACE_MSG(trace,
                     "GetCurrentBallLocation(ball).  calibrated_ball = " +
    ...
    // Find where the ball currently is based on where we expected it from the
    // prior information
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Original radius at calibration-time distance of " +
                     std::to_string(distance_at_calibration_) + " was: " +
                     std::to_string(radius_at_calibration_pixels_) +
                     ". Looking for a ball with min/max radius (pixels) of: " +
                     std::to_string(ip->min_ball_radius_) + ", " +
                     std::to_string(ip->max_ball_radius_));
    ...
    {
        GS_LOG_MSG(error,
                   "GolfSimCamera::GetCurrentBallLocation failed to ComputeSingleBallXYZOrthoCamPerspective.");
        return false;
    }
...
cv::Vec2d GolfSimCamera::computeCameraAnglesToBallPlane(cv::Vec3d &camera_positions_from_origin)
{
    ...
    if (camera_height_above_ball < 0.0 || std::abs(zDistanceToBall) <= 0.001)
    {
        LoggingTools::Warning(
            "GolfSimCamera::computeCameraAnglesToBallPlane called, but camera_height_above_ball_ or zDistanceToBall <= 0 (and likely not set)");
    }
                                        ...
                                        const cv::Vec2i &expectedBallCenter)
{
    ...
    // Get the ball data.  We will calibrate based on the first ball and then
    // get the second one
    // using that calibrated data from the first ball.

    // The Vec2i is a hack to deal with the ball in the test images not being in
    // the center (where it would be expected)
    ...
    if (GolfSimOptions::GetCommandLineOptions().system_mode_ == SystemMode::kCamera1Calibrate ||
        GolfSimOptions::GetCommandLineOptions().system_mode_ == SystemMode::kCamera2Calibrate)
    {
        ball1.calibrated_focal_length_ = computeFocalDistanceFromBallData(camera,
                                                                          ball1.
    ...
    // Using the first ball for reference, determine where the second one is in
    ...
    cv::Vec3d rotationResults = BallImageProc::GetBallRotation(grayImg1,
                                                               ball1,
                                                               grayImg2,
                                                               result_ball);
...
void GolfSimCamera::CalculateBallSpinRates(GolfBall &b,
                                           const cv::Vec3d &rotation_results,
                                           long time_delay_us)
{
    b.ball_rotation_angles_camera_ortho_perspective_ = rotation_results;
    b.rotation_speeds_RPM_[0] = 60. * ((rotation_results[0] / 360.) / (double)(time_delay_us)) *
                                1000000.;
    b.rotation_speeds_RPM_[1] = 60. * ((rotation_results[1] / 360.) / (double)(time_delay_us)) *
                                1000000.;
    b.rotation_speeds_RPM_[2] = 60. * ((rotation_results[2] / 360.) / (double)(time_delay_us)) *
                                1000000.;
}

double GolfSimCamera::GetTotalDistance(cv::Vec3d &distance_deltas)
{
    return sqrt(pow(distance_deltas[0], 2) + pow(distance_deltas[1], 2) + pow(distance_deltas[2],
                                                                              2));
}

// Determine the focal length based on a distance and measured radius (in
// pixels)
double GolfSimCamera::computeFocalDistanceFromBallData(const GolfSimCamera &camera,
                                                       double ball_radius_pixels,
                                                       double ball_distance_meters)
{
    // Could reasonably do this with either height or width parameters for the
    // sensors that we are using,
    // but for at least the GS camera, the "correct" divisor is the X axis, not
    // Y.
    return (ball_distance_meters * camera.camera_hardware_.sensor_width_ *
            ((2.0 * ball_radius_pixels) / camera.camera_hardware_.resolution_x_) /
            (2.0 * GolfBall::kBallRadiusMeters));
}

double GolfSimCamera::convertXDistanceToMeters(const GolfSimCamera &camera,
                                               double zDistanceMeters,
                                               double xDistancePixels)
{
    // Note that we are NOT using the calibrated_focal_length
    double halfWidthMeters = (zDistanceMeters / camera.camera_hardware_.focal_length_) *
                             (camera.camera_hardware_.sensor_width_ / 2.0);
    double xDistanceMeters = halfWidthMeters *
                             (xDistancePixels / (camera.camera_hardware_.resolution_x_ / 2.0));
    return (xDistanceMeters);
}

double GolfSimCamera::convertYDistanceToMeters(const GolfSimCamera &camera,
                                               double zDistanceMeters,
                                               double yDistancePixels)
{
    // Note that we are NOT using the calibrated_focal_length
    double halfHeightMeters = (zDistanceMeters / camera.camera_hardware_.focal_length_) *
                              (camera.camera_hardware_.sensor_height_ / 2.0);
    double yDistanceMeters = halfHeightMeters *
                             (yDistancePixels / (camera.camera_hardware_.resolution_y_ / 2.0));
    return (yDistanceMeters);
}

double GolfSimCamera::ComputeDistanceToBallUsingRadius(const GolfSimCamera &camera,
                                                       const GolfBall &ball)
{
    // compute and return the distance from the object to the camera in meters
    // (based on triangle similarity, e.g.,
    ...
    if (ball.ball_ellipse_.size.width > 0 && ball.ball_ellipse_.size.height > 0)
    {
        ...
        // If we have ellipse representation, then use it - it's probably more
        // reliable than a strict circle, but
        // we need to figure out WHICH radius of the ellipse to use

        // TBD -- Seems to work correctly only if we use the (smaller) width.
        // We could also use the largest radius in the hope that it will be more
        // accurate, percentage-wise
        // This should presumably be the height
        chosenRadiusPixels = std::min(ball.ball_ellipse_.size.width,
                                      ball.ball_ellipse_.size.height) / 2.0;

        // The ellipse may be at an angle.
        // Use the effective number of pixels on the sensor at that angle as a
        // measuring stick to determine the real-world distance
        double ellipseAngleDegrees = ball.ball_ellipse_.angle;

        // From vertical
        double ellipseAngleAtSensorCorner =
            CvUtils::RadiansToDegrees(atan(camera.camera_hardware_.sensor_height_ /
                                           camera.camera_hardware_.sensor_width_));
        ...
        // for details of rotatedRect angles.  They are non-intuitive.  Ellipse
        // angle is to the right from vertical
        if ((ellipseAngleDegrees > ellipseAngleAtSensorCorner &&
             ellipseAngleDegrees < 180 - ellipseAngleAtSensorCorner) ||
            (ellipseAngleDegrees > (180 + ellipseAngleAtSensorCorner) &&
             ellipseAngleDegrees < (360 - ellipseAngleAtSensorCorner))
            )
        {
            effectiveSensorWidth = std::abs(camera.camera_hardware_.sensor_width_ /
                                            cos(CvUtils::DegreesToRadians(90 -
                                                                          ellipseAngleDegrees)));
            effectiveCameraResolution = std::abs(camera.camera_hardware_.resolution_x_ /
                                                 cos(CvUtils::DegreesToRadians(90 -
                                                                               ellipseAngleDegrees)));
        }
        else
        {
            effectiveSensorWidth = std::abs((double)camera.camera_hardware_.sensor_height_ /
                                            cos(CvUtils::DegreesToRadians(ellipseAngleDegrees)));                                                           // 90-ellipse
                                                                                                                                                            // angle
            effectiveCameraResolution = std::abs((double)camera.camera_hardware_.resolution_y_ /
                                                 cos(CvUtils::DegreesToRadians(
                                                         ellipseAngleDegrees)));
        }
    }
    else
    ...
    // double ballRadiusMeters = (effectiveCameraResolution / (2.0 *
    // chosenRadiusPixels)) * (2.0 * kBallRadiusMeters) * (camera.focal_length_
    // / effectiveSensorWidth);

    double distanceToBallMeters = (effectiveCameraResolution / (2.0 * chosenRadiusPixels)) *
                                  (2.0 * GolfBall::kBallRadiusMeters) *
                                  (camera.camera_hardware_.focal_length_ / effectiveSensorWidth);

    return distanceToBallMeters;

    // TBD - AlternativelyCreate an upright (non-rotated) rectangle that fits
    // around the ellipse, which is itself a rotated rect.
    // Then, use the X and Y widths of the resulting upright rectangle to figure
    // out how wide/high the ellipse is.
    // Finally, use the pythagorean theory to figure out the diagonal's
    // real-world length.

    std::vector<cv::Point> contours;            // ?? =
                                                // std::vector<cv:Point>(ball.ball_ellipse_.re);
}

bool GolfSimCamera::ComputeXyzDeltaDistances(const GolfBall &b1,
                                             const GolfBall &b2,
                                             cv::Vec3d &position_deltas_ball_perspective,
                                             cv::Vec3d &distance_deltas_camera_perspective)
{
    // Axes are as perceived by the camera -- z is close/far, x is left/right,
    // and y is up/down

    // Distance is already in real-world meters
    distance_deltas_camera_perspective[0] = b2.distances_ortho_camera_perspective_[0] -
                                            b1.distances_ortho_camera_perspective_[0];
    distance_deltas_camera_perspective[1] = b2.distances_ortho_camera_perspective_[1] -
                                            b1.distances_ortho_camera_perspective_[1];
    distance_deltas_camera_perspective[2] = b2.distances_ortho_camera_perspective_[2] -
                                            b1.distances_ortho_camera_perspective_[2];

    // Ball X is -Camera Z, Ball Y is Camera Y, Ball Z is Camera X  (TBD -
    // earlier, this was computed from the other two ??
    position_deltas_ball_perspective[0] = -(b2.distances_ortho_camera_perspective_[2] -
                                            b1.distances_ortho_camera_perspective_[2]);
    position_deltas_ball_perspective[1] = b2.distances_ortho_camera_perspective_[1] -
                                          b1.distances_ortho_camera_perspective_[1];
    position_deltas_ball_perspective[2] = b2.distances_ortho_camera_perspective_[0] -
                                          b1.distances_ortho_camera_perspective_[0];
                                                      ...
                                                      cv::Vec3d &adjusted_distances)
{
    ...
    {
        GS_LOG_MSG(error,
                   "GolfSimCamera::AdjustXYZDistancesForCameraAngles received original Z distance of 0");
        return false;
    }

    GS_LOG_TRACE_MSG(trace,
                     "X,Y camera angles (degrees) = " + std::to_string(camera_angles[kX_index]) +
                     ", " + std::to_string(camera_angles[kY_index]));
    GS_LOG_TRACE_MSG(trace,
                     "X,Y distances (meters) = " + std::to_string(original_distances[kX_index]) +
                     ", " + std::to_string(original_distances[kY_index]));
     ...
     * double hypotenuse = sqrt( pow(original_distances[kX_index],2.) +
     * pow(original_distances[kZ_index], 2.));
     *
     * double b_angle_radians = asin(original_distances[kX_index] /
     * original_distances[kZ_index]);
     * double a_prime_angle_radians = (kPi/2.) -
     * (CvUtils::DegreesToRadians(camera_angles[kX_index]) + b_angle_radians);
     *
     * adjusted_distances[kZ_index] = hypotenuse * sin(a_prime_angle_radians) *
     * cos(CvUtils::DegreesToRadians(camera_angles[kY_index]));
     * adjusted_distances[kX_index] = hypotenuse * cos(a_prime_angle_radians) *
     * cos(CvUtils::DegreesToRadians(camera_angles[kY_index]));
     *
     * GS_LOG_MSG(info, "X hypotenuse = " + std::to_string(hypotenuse) + ",
     * b_angle_radians(X) = " +
     *  std::to_string(b_angle_radians) + ", a_prime_angle_radians(X) = " +
     * std::to_string(a_prime_angle_radians));
     *
     ...
     *
     * // Y adjustment
     * hypotenuse = sqrt(pow(original_distances[kY_index], 2.) +
     * pow(original_distances[kZ_index], 2.));
     *
     * b_angle_radians = atan(original_distances[kY_index] /
     * original_distances[kZ_index]);
     * a_prime_angle_radians = (kPi / 2.) +
     * (CvUtils::DegreesToRadians(camera_angles[kY_index]) + b_angle_radians);
     *
     * GS_LOG_MSG(info, "Y hypotenuse = " + std::to_string(hypotenuse) + ",
     * b_angle_radians(Y) = " +
     *          std::to_string(b_angle_radians) + ", a_prime_angle_radians(Y) =
     * " + std::to_string(a_prime_angle_radians));
     *
     *
    ...
    // Switch the coordinate system so taht the angles here are the angles
    // AROUND the axis, not
    // the angle IN the axis.  The configuation has X as left/right pan and Y as
    // up/down tilt
    ...
    // Perform Y-Axis rotation - NOTE - this re-uses and ajusts the Z distance
    // already calculated just above
    ...
    // TBD - Not certain this is useful - we can make up for the offset of the
    // tilted camera from the
...
// The ball's direct distance to the lens, as well as the x,y coordinates from
// the picture center
// origin both have to be set BEFORE calling this method.
// Axes are as perceived by the camera -- z is close/far, x is left/right, and y
// is up/down
// NOTE that the Z distance is the line-of-sight distance from the lens to the
// ball.
bool GolfSimCamera::ComputeXyzDistanceFromOrthoCamPerspective(const GolfSimCamera &camera,
                                                              const GolfBall &b1,
                                                              cv::Vec3d &distances)
{
    ...
    {
        LoggingTools::Warning(
            "ComputeXyzDistanceFromOrthoCamPerspective called without setting the ball line-of-sight-distance");
        return false;
    }

    // First calculate the distances as if the camera was facing straight ahead
    // toward
    ...
    // However, we do not have the exact direct-to-ball distance due to the
    // lens.
    // We will figure out the Z axis distance (which will generally be a little
    // shorter) first.
    double xDistanceFromCamCenter = convertXDistanceToMeters(camera,
                                                             b1.distance_to_z_plane_from_lens_,
                                                             xFromCameraCenter);
    camera_perspective_distances[0] = xDistanceFromCamCenter;          // X distance,
                                                                       // negative
                                                                       // means
                                                                       // to the
                                                                       // left
    ...
    double yDistanceFromCamCenter = convertYDistanceToMeters(camera,
                                                             b1.distance_to_z_plane_from_lens_,
                                                             yFromCameraCenter);

    camera_perspective_distances[1] = -yDistanceFromCamCenter;          // Y distance,
                                                                        // positive
                                                                        // is
                                                                        // upward
                                                                        // (smaller
                                                                        ...
                                                                        //  //
                                                                        // TBD -
                                                                        // sqrt(pow(b1.distance_to_z_plane_from_lens_,
                                                                        // 2) -
                                                                        // pow(yDistanceFromCamCenter,
                                                                        // 2));
                                                                        //  // Y
                                                                        // distance.
                                                                        //  Positive
    ...
    camera_perspective_distances[2] = b1.distance_to_z_plane_from_lens_;        // FOR
                                                                                // NON_DIRECT
                                                                                // sqrt(pow(b1.distance_to_z_plane_from_lens_,
                                                                                // 2)
                                                                                // -
    ...
    GS_LOG_TRACE_MSG(trace,
                     "GolfSimCamera::ComputeXyzDistanceFromOrthoCamPerspective computed camera_perspective_distances of: "
                     +
                     std::to_string(camera_perspective_distances[0]) + ", " +
                     std::to_string(camera_perspective_distances[1]));

    // If the camera were pointed straight out, the above is all we would need
    // to have in
    // order to compute the x,y,z position of the ball.  The ball would be at
    // the same z-distance,
    // and the x and y distances would just have to be added/subtracted to the
    // point in space
    // directly out from the camera.
    //
    // However, because the camera is at an angle, we need to convert the x,y,z
    // distances from the
    // camera's perspective into x,y,z from a perspective that is orthogonal to
    // the launch monitor.
    // This will entail a polar (or spherical) coordinate system to a cartesian
    // (x,y,z) conversion
    // So, Convert the distances from the camera into a set of angles from the
    // camera's perspective

    // Using the adjusted X and Y distances (lined up with the real world
    ...
    deltaAnglesCameraPerspective[0] =
        -CvUtils::RadiansToDegrees(atan(camera_perspective_distances[0] /
                                        b1.distance_to_z_plane_from_lens_));
    deltaAnglesCameraPerspective[1] =
        CvUtils::RadiansToDegrees(atan(camera_perspective_distances[1] /
                                       b1.distance_to_z_plane_from_lens_));

    // Account for the angle of the camera, which will adjust the camera
    // perspective angles
    // to the real-world orthogonal-to-the-LM-perspective polar coordinates.
    // X angle here is positive in a counter-clockwise movement looking down at
    // the LM from above
    // Y angle is negative as the azimuth angle goes down from horizontal
    cv::Vec2d deltaAnglesLMPerspective;
    deltaAnglesLMPerspective[0] = camera.camera_hardware_.camera_angles_[0] +
                                  deltaAnglesCameraPerspective[0];
    deltaAnglesLMPerspective[1] = camera.camera_hardware_.camera_angles_[1] +
                                  deltaAnglesCameraPerspective[1];

    GS_LOG_TRACE_MSG(trace,
                     "GolfSimCamera::ComputeXyzDistanceFromOrthoCamPerspective computed (LM-perspective) X,Y angles of: "
                     +
    ...
    // This is essentially a polar-coordinate system to cartesian system
    // conversion
    // See
    ...
    // Convert from the model cartesian system into the one used by the launch
    // monitor
...
// The delta angles are the angles between the two balls, in either the camera's
// position,
// or, alternatively, the ball's position (i.e., looking down-range)
bool GolfSimCamera::getXYDeltaAnglesBallPerspective(
    const cv::Vec3d &position_deltas_ball_perspective,
    cv::Vec2d &deltaAnglesBallPerspective)
{
    // Deal with case where the ball may not have moved (or some other problem
    // occurred).
    // In this case, just return 0's.
    if (std::abs(position_deltas_ball_perspective[2]) <= 0.001)
    {
        GS_LOG_MSG(error,
                   "getXYDeltaAnglesBallPerspective:  b2.distance_to_z_plane_from_lens_ was 0!");
    ...
    // Determine from perspective of the camera x-axis, looking in the positive
    // direction (the ball's
    ...
    deltaAnglesBallPerspective[0] =
        CvUtils::RadiansToDegrees(atan(position_deltas_ball_perspective[0] /
                                       position_deltas_ball_perspective[2]));
    // Y angle (left/right) = arctan(y/xf)
    deltaAnglesBallPerspective[1] =
        CvUtils::RadiansToDegrees(atan((position_deltas_ball_perspective[1] /
                                        position_deltas_ball_perspective[2])));

    return true;
}

bool GolfSimCamera::ComputeBallXYAnglesFromCameraPerspective(
    const cv::Vec3d &distances_camera_perspective,
    cv::Vec2d &deltaAnglesCameraPerspective)
{
    if (distances_camera_perspective[2] < 0.0001)
    {
        GS_LOG_MSG(error,
                   "ComputeBallXYAnglesFromCameraPerspective:  b2.distance_to_z_plane_from_lens_ was 0!");
        return false;
    }

    /* First version is for when the distances_camera_perspective[2] was the
     * direct-to-ball distance instead of just the z plane
     * // Positive X angle is counter-clockwise looking down on the camera/ball
     * from above
     * deltaAnglesCameraPerspective[0] =
     * -CvUtils::RadiansToDegrees(asin(distances_camera_perspective[0] /
     * distances_camera_perspective[2]));
     * double directDistance = sqrt(pow(distances_camera_perspective[2], 2) +
     * pow(distances_camera_perspective[0], 2));
     * deltaAnglesCameraPerspective[1] =
     * -CvUtils::RadiansToDegrees(atan(-distances_camera_perspective[1] /
     * directDistance));
     */
    ...
    deltaAnglesCameraPerspective[0] =
        CvUtils::RadiansToDegrees(atan(distances_camera_perspective[0] /
                                       distances_camera_perspective[2]));
    deltaAnglesCameraPerspective[1] =
        -CvUtils::RadiansToDegrees(atan(-distances_camera_perspective[1] /
                                        distances_camera_perspective[2]));
...
{
    // It's expensive to clone an image, so make sure we're here to do at least
    // something
...
{
    if (GolfSimOptions::GetCommandLineOptions().golfer_orientation_ ==
        GolferOrientation::kRightHanded)
    {
        std::sort(balls.begin(), balls.end(), [](const GolfBall &a, const GolfBall &b)
            {
                return (a.x() < b.x());
...
int GolfSimCamera::GetMostCenteredBallIndex(const std::vector<GolfBall> &balls,
                                            const int ball_to_ignore_index)
{
    if (balls.size() < 1)
    {
        GS_LOG_TRACE_MSG(warning,
                         "GetMostCenteredBallIndex - initial_balls vector was empty.  Exiting function.");
        return -1;
    }

    // Randomly pick one ball as the current, initial candidate
    int most_centered_ball_index = -1;
    int smallest_distance_from_center = 10 * camera_hardware_.resolution_x_;           // Ensure
                                                                                       // first
                                                                                       // ball
                                                                                       // will
                                                                                       // be
    ...
    // Loop through the balls, but ignore the ball_to_ignore if it is set (will
    // otherwise be -1)
    for (size_t i = 0; i < balls.size(); i++)
    {
        ...
        int x_distance = (int)(std::abs(CvUtils::CircleX(b.ball_circle_) -
                                        (camera_hardware_.resolution_x_ / 2.)));
        int y_distance = (int)(std::abs(CvUtils::CircleY(b.ball_circle_) -
                                        (camera_hardware_.resolution_y_ / 2.)));

        int distance_from_center = (int)std::round(std::sqrt(x_distance * x_distance + y_distance *
                                                             y_distance));
        ...
        if (distance_from_center < smallest_distance_from_center)
        {
            ...
            GS_LOG_TRACE_MSG(trace,
                             "GetMostCenteredBallIndex - Best current candidate with distance from center of "
                             +
                                              ...
                                              std::vector<double> &distance_ratios)
{
    ...
    {
        GS_LOG_TRACE_MSG(warning,
                         "GetBallDistancesAndRatios - balls vector was empty.  Exiting function.");
        return false;
    }

    // First get the inter-ball distances.  There will be one less distance
    // element
    // than the number of balls.
    // "size()-1" because we need at least two balls for a single inter-ball
    // distance
    ...
    // But there may be times when one of the circles is dropped and we have a
    // lot fewer
    // distances
    for (size_t distance_index = 0; distance_index < distances.size() - 1; distance_index++)
    {
        ...
        // Account for friction forces that would tend to decrease the ideal
        // distance
...
// Look at the balls around the two identified balls to determine (if possible)
// which
// of the two balls is most likely to be on the track-line (really more of an
// arc) that appears
// to be defined by the rest of the balls.  The found ball may be a false
// positive that
// just happened not to be filtered by other techniques.
// If true is returned, then off_track_ball_index will point to the ball that is
// least likely
// to be part of the line of flight.
// The balls must be sorted from left to right by their x coordinate, with
// higher indexes
...
{
    /* This was the original code that used the balls around the ball being
     * analyzed to determine the line
     * if (balls.size() <= 3) {
     ...
     *  // Right ball is all the way to the right of the ball vector (last
     * index)
     ...
     *  }
     * }
     * else if (candidate_ball_index_left > 0 && candidate_ball_index_right <
     * balls.size() - 1) {
     ...
     *
     * ball_1_distance = GetPerpendicularDistanceFromLine(ball1.x(), ball1.y(),
     * left_line_ball.x(), left_line_ball.y(), right_line_ball.x(),
     * right_line_ball.y());
     * ball_2_distance = GetPerpendicularDistanceFromLine(ball2.x(), ball2.y(),
     * left_line_ball.x(), left_line_ball.y(), right_line_ball.x(),
     * right_line_ball.y());
     */
    ...
    ball_1_distance = GetPerpendicularDistanceFromLine(ball1.x(),
                                                       ball1.y(),
                                                       line_ball1.x(),
                                                       line_ball1.y(),
                                                       line_ball2.x(),
                                                       line_ball2.y());
    ball_2_distance = GetPerpendicularDistanceFromLine(ball2.x(),
                                                       ball2.y(),
                                                       line_ball1.x(),
                                                       line_ball1.y(),
                                                       line_ball2.x(),
...
double GolfSimCamera::GetPerpendicularDistanceFromLine(double xc,
                                                       double yc,
                                                       double xa,
                                                       double ya,
                                                       double xb,
                                                       double yb)
{
    ...
    // The following was only for a line SEGMENT:
    // https://stackoverflow.com/questions/849211/shortest-distance-between-a-point-and-a-line-segment

    // If the line is vertical, then the distance is just the x difference to
    // the line
    ...
    // If the line is horizontal, then the distance is just the y difference to
    // the line
...
void GolfSimCamera::RemoveLowScoringBalls(std::vector<GolfBall> &balls,
                                          const int max_balls_to_retain)
{
    ...
    {
        GS_LOG_TRACE_MSG(trace,
                         "RemoveLowScoringBalls asked to remove more balls than were identified.  max_balls_to_retain= "
                         +
                         std::to_string(max_balls_to_retain) + ", but only have " +
                         std::to_string(balls.size()) + " balls.");
        return;
    }
...
void GolfSimCamera::RemoveUnlikelyRadiusChangeBalls(std::vector<GolfBall> &initial_balls,
                                                    ...
                                                    const double
                                                    max_overlapped_ball_radius_change_ratio,
                                                    const bool preserve_high_quality_balls)
{
    if (initial_balls.size() < 3)
    {
        GS_LOG_TRACE_MSG(trace,
                         "GolfSimCamera::RemoveUnlikelyRadiusChangeBalls found too few (< 3) balls.  Not processing anything.");
        return;
    }
    ...
    for (int i = (int)initial_balls.size() - 3; i >= 0; i--)
    {
        ...
        double middle_to_right_ball_proximity_pixels = initial_balls[i +
                                                                     1].PixelDistanceFromBall(
            initial_balls[i + 2]);
        double middle_to_left_ball_proximity_pixels =
            initial_balls[i].PixelDistanceFromBall(initial_balls[i + 1]);

        double middle_to_right_distance_adjustment = (middle_to_right_ball_proximity_pixels /
                                                      150.0) / 100.0;
        double middle_to_left_distance_adjustment = (middle_to_left_ball_proximity_pixels / 150.0) /
                                                    100.0;

        if ((b2_radius >
             (b1_radius * (1.0 + max_change_percent / 100. + middle_to_left_distance_adjustment)) &&
             b2_radius >
             (b3_radius *
              (1.0 + max_change_percent / 100. + middle_to_right_distance_adjustment))) ||
            (b2_radius <
             (b1_radius * (1.0 - max_change_percent / 100. - middle_to_left_distance_adjustment)) &&
             b2_radius <
             (b3_radius * (1.0 - max_change_percent / 100. - middle_to_right_distance_adjustment))))
        {
            if (initial_balls[i + 1].quality_ranking >= kNumberHighQualityBallsToRetain_)
            {
                GS_LOG_TRACE_MSG(trace,
                                 "RemoveUnlikelyRadiusChangeBalls removing ball " +
                                 std::to_string(i + 1) +
                                 " because it was too much smaller/larger than both adjacent balls.");
                initial_balls.erase(initial_balls.begin() + i + 1);
            }
            else
            {
                GS_LOG_TRACE_MSG(trace,
                                 "RemoveUnlikelyRadiusChangeBalls NOT removing ball " +
                                 std::to_string(i + 1) +
                                 " because although it was larger than both adjacent balls, it was a high-quality circle.");
            }
            // Also, if the middle ball is already overlapping with the ball to
            // the left,
            // then it's likely that ALL the balls from the middle ball to the
            // left-most
            // are all overlapped
        ...
        {
            // If not, is the outer of the three balls different enough to
            // discard
            ...
            {
                // The right-most ball shouldn't have changed in size this much
                // when
                // it hasn't moved very far.  Likely it's a mis-identification
                if (right_radius_change >
                    max_overlapped_ball_radius_change_ratio * left_radius_change)
                {
                        ...
                        preserve_high_quality_balls == false)
                    {
                        GS_LOG_TRACE_MSG(trace,
                                         "RemoveUnlikelyRadiusChangeBalls removing ball " +
                                         std::to_string(i + 2) +
                                         " because it was much larger/smaller than the ball it overlaps.");
            ...
            {
                // The left-most ball shouldn't have changed in size this much
                // when
                // it hasn't moved very far.  Likely it's a mis-identification
                if (left_radius_change >
                    max_overlapped_ball_radius_change_ratio * right_radius_change)
                {
                                             ...
                                             const GolfBall &second_best_ball )
{
    ...
    {
        GS_LOG_TRACE_MSG(warning,
                         "RemoveOffTrajectoryBalls - balls vector was empty.  Exiting function.");
        return;
    }
    ...
    for (int i = (int)initial_balls.size() - 1; i >= 0; i--)
    {
        ...
        // Don't both examining the two balls we're using to draw the trajectory
        // line
        ...
        double ball_distance = GetPerpendicularDistanceFromLine(b.x(),
                                                                b.y(),
                                                                best_ball.x(),
                                                                best_ball.y(),
                                                                second_best_ball.x(),
        ...
        {
            // GS_LOG_TRACE_MSG(trace, "Not analyzing ball " + std::to_string(i)
            // + " due to it having off - trajectory distance of : " +
            // std::to_string(ball_distance));
            initial_balls.erase(initial_balls.begin() + i);
        }
    }
}
                                                 ...
                                                 const int max_quality_difference)
{
    ...
    {
        GS_LOG_TRACE_MSG(warning,
                         "RemoveNearbyPoorQualityBalls - balls vector was empty.  Exiting function.");
        return;
    }
    ...
    for (size_t outer_index = 0; outer_index < balls_copy.size(); outer_index++)
    {
        ...
        for (int i = (int)initial_balls.size() - 1; i > (int)outer_index; i--)
        {
            ...
            {
                GS_LOG_TRACE_MSG(trace,
                                 "Not analyzing ball " + std::to_string(i) +
                                 " due to its proximity of : "
                                 + std::to_string(ball_distance) + " and poor quality of " +
                                 std::to_string(b.quality_ranking));
                initial_balls.erase(initial_balls.begin() + i);
            }
        }
    }
                                           ...
                                           const bool preserve_high_quality_balls)
{
    ...
    {
        GS_LOG_TRACE_MSG(warning,
                         "RemoveOverlappingBalls - balls vector was empty.  Exiting function.");
        return -1;
    }

    uint number_removed = 0;

    // We assume that the strobe intervals either constant or increasing in
    // time/distance.
    // Start with the ball that is most likely to be in the clear, and then go
    // toward the tee
    ...
    for (int i = (int)initial_balls.size() - 1; i >= 0; i--)
    {
        ...
        if (i == 0)
        {
            ...
            // and the loop did not drop out on the last iteration, so there was
            // no overlap with this ball,
            // so retain the current ball and the one to it's left and stop the
            // iteration
        ...
        double proximity_limit = ((1. - ball_proximity_margin_percent / 100.) *
                                  (next_closer_ball.measured_radius_pixels_ +
                                   ball.measured_radius_pixels_));

        if (ball_proximity_pixels < proximity_limit)
        {
            if (attempt_removal_of_off_trajectory_balls)
            {
                // The next ball closer to the tee is too close to the ball we
                // are examining
                // Thus, BOTH balls (including the 'current' ball) are
                // overlapping and may have to be
                // ignored for the purpose of for example, spin analysis

                // However, if we can determine that one of the balls is clearly
                // a false positive, such
                // as because that ball is clearly off the line-of-flight
                // defined by the other balls, then
                // we can just drop the false positive and keep the other ball.
                double ball_1_distance = -1;
                double ball_2_distance = -1;

                FindBestBallOnLineOfFlight(initial_balls,
                                           i - 1,
                                           i,
                                           ball_1_distance,
                                           ball_2_distance,
                ...
                // If both balls are on the trajectory (or really close), then
                // assume they were both valid and remove both of them.
                // Otherwise, assume one was a mis-identification and remove
                // only it
                // TBD - We might even want to increase the maximum
                // off-trajectory now that we're doing
                // quite a bit of trajectory checks before this?
                int kMaximumOffTrajectoryDistance_ = 8;

                // The ground can cause a lot of bounch up & down on the balls,
                // so
                // make sure we don't get rid of a good ball just because it
                // moved a bit.
                ...
                if (ball_1_distance < kMaximumOffTrajectoryDistance_ &&
                    ball_2_distance < kMaximumOffTrajectoryDistance_)
                {
                    // This appears to be an overlap of two actual balls
                    // Effectively get rid of both the current (overlapped) ball
                    // and the one to the left
                    // by skipping to the next ball to the left (if it exists).
                    //  They are both unlikely to be
                    // useful for spin analysis (and possibly position) because
                    // of the overlap
                    ...
                    {
                        // Leave the right-most ball (index i) alone and move
                        // ahead
                        ...
                        continue;
                             ...
                             preserve_high_quality_balls == true)
                    {
                        // Preserve the left-most ball by simply skipping
                        // inserting the right-most
                        // ball in the return vector.  Assume the right-most is
                        // not a 'real' ball.
                        continue;
                    }
                    else
                    {
                        ...
                        // special case - if we got rid of both balls and
                        // there's only one more ball
                        // that we would be looking at, there's no way to
                        // compare that ball to the
                        // ones we have just removed.  But, knowing that the
                        // spacing is even closer
                        // as we move to the left, we'll just effectively remove
                        // that last ball as well
                        // since it likely overlapped with the current left-side
                        // ball.
                        if (i == 1)
                        {
                            break;
                ...
                {
                    // At least one of the balls is a misidentified ball.
                    //  Assume one ball is real.
                    // Get rid of the ball that was furthest from the assumed
                    // line of flight
                    // unless that ball is one of the highest-ranked, in which
                    // case, lose the other one.
                    // The off-track ball is the one that is furthest from the
                    // line defined by the end points determined earlier
                    if (ball_1_distance > ball_2_distance)
                    {
                        // The next ball to the left was the ball that is
                        // furthest from the line of flight
                        // Save the current ball (to the right of the other) and
                        // effectively skip the other
                    ...
                    {
                        // The next ball to the left was the ball that is
                        // closest to the line of flight
                        // Effectively skip the current ball and move on to
                        // looking at the next ball to the left
                        // In this case, we don't believe we've removed a real
                        // ball, so don't count it
                        continue;
                    }
                }
            }
            ...
            {
                // we are not allowing for avoiding removing a ball if it is
                // overlapped
                // with an off-trajectory ball.  So just get rid of both
                i--;
                number_removed += 2;
                // See speciai case comment above for an explanation for
                // potentially breaking out of the loop here
                if (i == 1)
                {
                    break;
                }
        ...
        // The current ball was (visually) free and clear.  So retain it on the
        // final ball list.
        return_balls.push_back(ball);
    }
                                             ...
                                             const GolfBall &expected_best_ball)
{
    ...
    {
        GS_LOG_TRACE_MSG(warning,
                         "RemoveTooSmallOrBigBalls - balls vector was empty.  Exiting function.");
        return;
    }

    // Other, valid, strobed balls should have similar radii
    // TBD - What about very hooked/sliced shots?  Would their radii change
    // more?
    const double kMinStrobedBallRadiusRation = 0.80;
    const double kMaxStrobedBallRadiusRation = 1.20;

    int min_strobed_ball_radius = int(expected_best_ball.measured_radius_pixels_ *
                                      kMinStrobedBallRadiusRation);
    int max_strobed_ball_radius = int(expected_best_ball.measured_radius_pixels_ *
                                      kMaxStrobedBallRadiusRation);
    ...
    for (int i = (int)initial_balls.size() - 1; i >= 0 ; i--)
    {
        ...
        {
            GS_LOG_TRACE_MSG(trace,
                             "  Not analyzing found ball due to it having radius = {" +
                                        ...
                                        int &second_ball_index)
{
    ...
    // One question is how to determine which OTHER ball should be used to
    // compare with the face_ball
    // Should it be the nearest or the furthest?  Closest to the center (other
    // than the middle ball)?
    // Answer:  We will focus on the spin analysis
    // Most centered will be better to compare for spin, as the face-on angle
    // will be the
    // most similar.  For high speed spins, the closer the ball images, the
    // higher
    // the recoverable speed, because the ball doesn't have as much time to
    // spin.
...
{
    // Note - the balls must have been ordered in quality order before calling
    // this method.
    ...
    {
        GS_LOG_TRACE_MSG(warning,
                         "initial_balls vector was empty or had only 1 ball.  Exiting function.");
        return;
    }
    ...
    // Examine each of the search balls and remove any near-by balls that are at
    // an unreasonable angle.
    // This process takes care of the (likely) situation when the top (position
    // 0) quality ball is
    // near another high-quality ball (e.g., position 1), but the second ball is
    // a mistake and is
    ...
    while ((outer_index < initial_balls.size() - 1) && (initial_balls.size() > 0))
    {
        ...
        for (size_t i = initial_balls.size() - 1;
             (initial_balls.size() > 0) && (i > outer_index);
             i--)
        {
            GolfBall &b = initial_balls[i];
            ...
            // TBD - This is only an approximation.  It might not work at very
            // high
            ...
            {
                // The balls are too far apart to want to check for unlikely
                // angles
                continue;
            }
            ...
            {
                // GS_LOG_TRACE_MSG(trace, "RemoveUnlikelyAngleLowerQualityBalls
                // not analyzing ball " + std::to_string(i) + " because its X
                // coordinate is too far from ball number " +
                // std::to_string(outer_index));
                // If the balls are right above/below each other, just pick a
                // very big angle to avoid doing a divide by zero
                // The large angle should ensure that the 'bad' ball is removed
                ball_angle_degrees = 89;
            }
            else
            {
                // Calculate angle so that it doesn't matter which ball is to
                // the left
                ball_angle_degrees = CvUtils::RadiansToDegrees(atan((double)(b.y() -
                                                                             current_ball.y()) /
                                                                    (double)std::abs(b.x() -
                                                                                     current_ball.x())));;
            }
            ...
            {
                // The ball to be compared to the outer loop ball is to the
                // right of the outer loop
                ball_angle_degrees = -ball_angle_degrees;
            }
            else
            {
                // The ball to be compared to the outer loop ball is to the left
                // of the outer loop
            ...
            if (ball_angle_degrees < min_angle || ball_angle_degrees > max_angle)
            {
                GS_LOG_TRACE_MSG(trace,
                                 "Not analyzing ball " + std::to_string(i) +
                                 " due to its unlikely angle of "
                                 + std::to_string(ball_angle_degrees) +
                                 " degrees with respect to ball number " +
                                 std::to_string(outer_index));
                                          ...
                                          const double max_strobed_ball_color_difference)
{
    ...
    {
        GS_LOG_TRACE_MSG(warning,
                         "RemoveWrongColorBalls - balls vector was empty.  Exiting function.");
        return;
    }

    // Get the color and std of the ball that is the most likely to be a real
    // ball
    std::vector<cv::Scalar> statistics = CvUtils::GetBallColorRgb(rgbImg,
                                                                  expected_best_ball.ball_circle_);
    cv::Scalar expectedBallRGBAverage{ statistics[0] };
    cv::Scalar expectedBallRGBMedian{ statistics[1] };
    cv::Scalar expectedBallRGBStd{ statistics[2] };

    // Expect that the expected_best_ball will not be removed from the vector,
    // as it's differences
    // should be zero.
    ...
    for (int i = (int)initial_balls.size() - 1; i >= 0; i--)
    {
        ...
        std::vector<cv::Scalar> statistics = CvUtils::GetBallColorRgb(rgbImg, b.ball_circle_);
        cv::Scalar avg_RGB{ statistics[0] };
        cv::Scalar median_RGB{ statistics[1] };
        cv::Scalar std_RGB{ statistics[2] };

        // Save the information for later - TBD - Centralize this earlier
        // somewhere
        ...
        GS_LOG_TRACE_MSG(trace,
                         "\n\nExamining circle No. " + std::to_string(i) + ".  Radius " +
                         std::to_string(b.measured_radius_pixels_) +
                         " pixels. Average RGB is{ " + LoggingTools::Formatcv::Scalar(avg_RGB)
                         + ". Average HSV is{ " +
                         LoggingTools::Formatcv::Scalar(CvUtils::ConvertRgbToHsv(avg_RGB)));

        // Determine how "different" the average color is from the expected ball
        // color
        // If we don't have an expected ball color, than we use the RGB center
        // from the
        // current mask
        ...
        // Even if a potential ball has a really close median color, if the STD
        // is even a little off, we want to down - grade it
        // The following works to mix the three statistics together
        // appropriately
        // Will also penalize balls that are found toward the tail end of the
        // list
        //  NOMINAL - large StdDiff was throwing off? float
        // calculated_color_difference = rgb_avg_diff + (float)(100. *
        // pow(rgb_std_diff, 2.));
        // TBD - this needs to be optimized and should probably be different
        // than the code in the BallImageProc class.
        //                    double calculated_color_difference =
        // pow(rgb_avg_diff,2) + (float)(2. * pow(rgb_std_diff, 2.)) +
        // (float)(125. * pow(i, 4.));
        // NOTE - if the flash-times are different for the ball we are using for
        // the color, this is likely to pick the wrong thing.

        // We are primarily concerned about situations where the median RGB went
        // UP, because that's usually what happens when a ball overlaps
        // with another ball(s).  We are going to weigh that situation more
        // heavily
        ...
        {
            brightness = "darker";
            rgb_difference_component = (double)(kColorDifferenceRgbPostMultiplierForDarker *
                                                pow(1.0 * rgb_avg_diff,
                                                    2.));
            std_difference_component = (double)(kColorDifferenceStdPostMultiplierForDarker *
                                                pow(2.3 * rgb_std_diff,
                                                    2.));
        ...
        {
            brightness = "lighter";
            rgb_difference_component = (double)(kColorDifferenceRgbPostMultiplierForLighter *
                                                pow(1.0 * rgb_avg_diff,
                                                    2.));
            std_difference_component = (double)(kColorDifferenceStdPostMultiplierForLighter *
                                                pow(2.0 * rgb_std_diff,
                                                    2.));
        ...
        GS_LOG_TRACE_MSG(trace,
                         "Found " + brightness + " circle number " + std::to_string(i) +
                         "(x,y) = (" + std::to_string(b.x()) + ", " + std::to_string(b.y()) +
                         "). radius = " + std::to_string(b.measured_radius_pixels_) +
                         " rgb_avg_diff = " + std::to_string(rgb_avg_diff) +
                         " CALCDiff = " + std::to_string(calculated_color_difference) +
                         " rgbDiff = " + std::to_string(rgb_avg_diff) +
                         " rgb_median_diff = " + std::to_string(rgb_median_diff) +
                         " rgb_std_diff = " + std::to_string(rgb_std_diff));
        ...
        {
            GS_LOG_TRACE_MSG(trace,
                             "  Not analyzing found ball No. " + std::to_string(i) +
                             " due to it having too different a color ( difference was " +
                             std::to_string(calculated_color_difference) + "), and the max was " +
                             std::to_string(max_strobed_ball_color_difference) + ".\n");
            GS_LOG_TRACE_MSG(trace,
                             " rgb_difference_component was " +
                             std::to_string(rgb_difference_component) +
                             "), and std_difference_component was " +
                             std::to_string(std_difference_component) + ".\n\n");
            initial_balls.erase(initial_balls.begin() + i);
        }
    }
}
                                           ...
                                           const GolfBall &expected_best_ball )
{
    ...
    for (int i = (int)initial_balls.size() - 1; i > 0; i--)
    {
        ...
        double max_radius_different = nominal_radius *
                                      (kMaxRadiusDifferencePercentageFromBest / 100.0);
        ...
        if (radius_difference > max_radius_different)
        {
            GS_LOG_TRACE_MSG(trace,
                             "  Not analyzing found ball No. " + std::to_string(i) +
                             " due to it having too different a radius from best ball ( difference was "
                             +
                             std::to_string(radius_difference) + "), and the max was " +
                             std::to_string(max_radius_different));
            initial_balls.erase(initial_balls.begin() + i);
        }
    }
}
...
void GolfSimCamera::ReportBallSearchError(const int number_balls_found)
{
    ...
    {
        root_cause_str =
            "Unable to find ANY ball exposures after ball hit.  Did ball move inadvertently?";
    }
    else if (number_balls_found == 1)
    {
        root_cause_str =
            "Unable to find at least two ball exposures after ball hit.  It's possible the ball was hit faster or slower than the system can handle.";
    }
    else
    {
        root_cause_str =
            "An error occurred while processing the post-hit ball image.  Please check logs.";
    }
...
{
    GS_LOG_TRACE_MSG(trace,
                     "AnalyzeStrobedBalls(ball).  calibrated_ball = " + calibrated_ball.Format());
    ...
    LoggingTools::DebugShowImage("GolfSimCamera::TestAnalyzeStrobedBall COLOR input: ",
                                 strobed_balls_color_image);
    LoggingTools::DebugShowImage("GolfSimCamera::TestAnalyzeStrobedBall GRAY input: ",
    ...
    // Approximate the new distance based just on the X/Z plane distance,
    // assuming
    ...
    double expected_strobed_ball_radius = calibrated_ball.radius_at_calibration_pixels_ *
                                          (distance_at_calibration_ / expected_camera2_distance);

    // Setup to search for a ball that has a reasonable size relationship to the
    // calibrated ball
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Original radius at calibration-time distance of " +
                     std::to_string(distance_at_calibration_) + " was: " +
                     std::to_string(calibrated_ball.radius_at_calibration_pixels_) +
                     ".  Adjusted radius for camera2 is: " +
                     std::to_string(expected_strobed_ball_radius) +
                     ". Looking for a ball with min/max radius (pixels) of: " +
                     std::to_string(ip->min_ball_radius_) + ", " +
                     std::to_string(ip->max_ball_radius_));
    ...
    // If we're putting, the ball should only be in the lower one-half to
    ...
    if (GolfSimClubs::GetCurrentClubType() == GolfSimClubs::kPutter)
    {
        ...
        roi = cv::Rect{ 0, (int)(0.5 * strobed_balls_color_image.rows),
                        strobed_balls_color_image.cols,
                        (int)(strobed_balls_color_image.rows * 0.49) };
    }
    else
    {
    ...
    non_const_ball.average_color_ = cv::Scalar(0, 0, 0);

    bool result = ip->GetBall(strobed_balls_color_image,
                              non_const_ball,
                              initial_balls,
                              roi,
                              processing_mode,
    ...
    ShowAndLogBalls("AnalyzeStrobedBall_Initial_Candidate_Balls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);
    ...
    double max_color_difference = (GolfSimClubs::GetCurrentClubType() ==
                                   GolfSimClubs::kPutter) ? kMaxPuttingBallColorDifferenceRelaxed :
                                  kMaxStrobedBallColorDifferenceRelaxed;
    RemoveWrongColorBalls(strobed_balls_color_image,
                          initial_balls,
                          expected_best_ball,
                          max_color_difference);
    ShowAndLogBalls("AnalyzeStrobedBall_After_RemoveWrongColorBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);
    LoggingTools::Trace("Initial_balls after RemoveWrongColorBalls: ", initial_balls);

    // Seems like wrong radius balls can be a better and more-ball-removing
    // early filter than UnlikelyAngle balls
    RemoveWrongRadiusBalls(initial_balls, expected_best_ball);
    ShowAndLogBalls("AnalyzeStrobedBall_After_RemoveWrongRadiusBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);

    RemoveUnlikelyAngleLowerQualityBalls(initial_balls);
    ShowAndLogBalls("AnalyzeStrobedBall_After_RemoveUnlikelyAngleLowerQualityBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);
     ...
     * initial_balls.erase(initial_balls.begin() + 2);
     * ShowAndLogBalls("initial_balls after hack for testing",
     * strobed_balls_color_image, initial_balls,
     * kLogIntermediateExposureImagesToFile);
     ***/
    ...
    // Unlikely that the best balls would have been removed.  However, it is
    // possible.
    // Reset as necessary
    ...
    // TBD - Am putting this back in because we're still getting too many balls
    // with the new edge detector
    RemoveLowScoringBalls(initial_balls, kMaxBallsToRetain);
    ShowAndLogBalls("AnalyzeStrobedBall_After_RemoveLowScoringBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);
    ...
    RemoveWrongRadiusBalls(initial_balls, expected_best_ball);
    ShowAndLogBalls("AnalyzeStrobedBall_After_RemoveWrongRadiusBalls (Normal Mode)",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);
    ...
    // Especially if we are using a loose Hough for initial identification, this
    // could get rid of 100 or more ball candidates
    SortBallsByXPosition(initial_balls);
    RemoveOffTrajectoryBalls(initial_balls, kMaxDistanceFromTrajectory, best_ball,
                             second_best_ball);
    ShowAndLogBalls("AnalyzeStrobedBall_After_0thRemoveOffTrajectoryBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);

    // A frequent problem because of the very-broad net we cast is that crappy
    // balls end up determined
    // right next to a good one.  Get rid of 'em
    if (number_of_initial_balls > 20)
    {
        ShowAndLogBalls("AnalyzeStrobedBall Balls before RemoveNearbyPoorQualityBalls",
                        strobed_balls_color_image,
                        initial_balls,
                        kLogIntermediateExposureImagesToFile);
        RemoveNearbyPoorQualityBalls(initial_balls,
                                     ip->min_ball_radius_,
                                     number_of_initial_balls / 2);
        ShowAndLogBalls("AnalyzeStrobedBall Balls after RemoveNearbyPoorQualityBalls",
                        strobed_balls_color_image,
                        initial_balls,
                        kLogIntermediateExposureImagesToFile);
    }

    // Allow for a couple of misidentifications, but assume that the best
    // scoring
    // balls are all at the front of the herd and that we can get rid of the
    // ones
    ...
    {
        GS_LOG_MSG(warning,
                   "GetBall() found only one ball after initial filtering.  Ball velocity may have been too high or very slow.");
        return false;
    }

    SortBallsByXPosition(initial_balls);
    ShowAndLogBalls("AnalyzeStrobedBall_Before_RemoveUnlikelyRadiusChangeBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);
    ...
    if (GolfSimClubs::GetCurrentClubType() == GolfSimClubs::kPutter)
    {
        max_intermediate_ball_radius_change_percent =
            kMaxPuttingIntermediateBallRadiusChangePercent;
    }
    else
    {
    ...
    RemoveUnlikelyRadiusChangeBalls(initial_balls,
                                    max_intermediate_ball_radius_change_percent,
                                    kMaxOverlappedBallRadiusChangeRatio);

    SortBallsByXPosition(initial_balls);
    ShowAndLogBalls("AnalyzeStrobedBall_After_1stRemoveUnlikelyRadiusChangeBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);
    ...
    SortBallsByXPosition(initial_balls);
    ShowAndLogBalls("AnalyzeStrobedBall_After_2ndRemoveUnlikelyRadiusChangeBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);
    ...
    ShowAndLogBalls("AnalyzeStrobedBall_After_3rdRemoveUnlikelyRadiusChangeBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    kLogIntermediateExposureImagesToFile);

    // Identify any balls that are overlapping with other balls.  Such balls are
    // unlikely to be useful
    // for spin calculations.

    // After sorting, the first ball will be the one that is furthest away from
    // the tee-off spot
    // This is necessary for the RemoveOverlappingBalls to work correctly
    SortBallsByXPosition(initial_balls);

    LoggingTools::Trace(
        "Initial_balls sorted by ascending (or for left-handed--descending) X value: ",
        initial_balls);
    ShowAndLogBalls("AnalyzeStrobedBall_After_1stRemoveOffTrajectoryBalls",
                    strobed_balls_color_image,
                    initial_balls,
                    false);

    // This should be using a tighter trajectory limit, but we're trying to
    // accomodate some slow balls right now
    ...
    // Because some of the overlapping balls have bright colors that will likely
    // be removed
    // in the color-filtering phase, we retain a copy of the overlapped balls
    // BEFORE
    // the color-filter.  That way, we can later determine a set of strictly
    // non-overlapping balls
    // for purposes of, e.g., spin analysis.
    // Otherwise, we might remove balls that were actually overlaps and then not
    // be able to
    ...
    // Balls with a small (say 25%) overlap should still be evaluated and
    // retained if possible
    // During this pass, we will preserve high-quality balls even if they look
    // sketchy
    std::vector<GolfBall> first_pass_balls;
    int number_overlapping_balls_removed = RemoveOverlappingBalls(initial_balls,
                                                                  kBallProximityMarginPercentRelaxed,
                                                                  true,
                                                                  first_pass_balls,
                                                                  best_ball,
    ...
    ShowAndLogBalls("AnalyzeStrobedBall_After_1stRemoveOverlappingBalls",
                    strobed_balls_color_image,
                    first_pass_balls,
                    kLogIntermediateExposureImagesToFile);

    // TBD -Trying these two steps twice to deal with really close balls that
    // remain after the first pass
    // THIS time, do not preserve high-quality balls that look sketchy
    RemoveUnlikelyRadiusChangeBalls(first_pass_balls,
                                    max_intermediate_ball_radius_change_percent,
                                    kMaxOverlappedBallRadiusChangeRatio,
                                    false);
    ShowAndLogBalls("AnalyzeStrobedBall_After_3rdRemoveUnlikelyRadiusChangeBalls",
    ...
    std::vector<GolfBall> return_balls;
    number_overlapping_balls_removed += RemoveOverlappingBalls(first_pass_balls,
                                                               kBallProximityMarginPercentRelaxed,
                                                               true,
                                                               return_balls,
                                                               best_ball,
    ...
    ShowAndLogBalls("AnalyzeStrobedBall Candidates after RemoveOverlappingBalls",
                    strobed_balls_color_image,
                    return_balls,
                    kLogIntermediateExposureImagesToFile);
    GS_LOG_TRACE_MSG(trace,
                     "Number of Return_balls Candidates after RemoveOverlappingBalls: " +
                     std::to_string(return_balls.size()));

    if (return_balls.size() < 2)
    {
        GS_LOG_MSG(error,
                   "GetBall() found only one ball after color filtering.  Ball velocity may have been too high or very slow.");
        return false;
    }

    // If we got rid of so many balls that fewer than two remain, then the speed
    // of the ball
    // (relative to the strobing) was probably too slow because they images were
    // all overlapped.
    if (return_balls.size() < 2)
    {
        GS_LOG_MSG(error,
                   "GetBall() found fewer than two balls after removing overlapping ball images.  Ball velocity may have been too slow.");
        return false;
    }

    // Determine which ball is closest to the center of the image.  That will be
    // the best one to use for spin determination
    SortBallsByXPosition(return_balls);

    ShowAndLogBalls("AnalyzeStrobedBall_After_Size_Color_Filtered_Candidates",
                    strobed_balls_color_image,
                    return_balls,
                    kLogIntermediateExposureImagesToFile);
    GS_LOG_TRACE_MSG(trace,
                     "Return_balls after color and size filter" +
                     std::to_string(return_balls.size()));

    int most_centered_ball_index = GetMostCenteredBallIndex(return_balls);

    GS_LOG_TRACE_MSG(trace,
                     "The closest-to-center-screen ball index was " +
                     std::to_string(most_centered_ball_index));
    ...
    // NOTE - At this point we cannot re-sort the ball vector or else our
    // indexes may not make sense
    // any more.

    // We need a second ball as a ball to compare from one point in time to
    // another and to
    ...
    /**** TBD - No longer doing the ball improvement, because the new edge
     * detector does a
    ...
    // For now, do NOT do any refinement if we are putting and the balls are
    // close
    // to the bottom of the image - the circles are probably as good as they are
    // going to get(?)  They may be near the bottom of the image and hard to
    // isolate
    ...
    if (GolfSimClubs::GetCurrentClubType() == GolfSimClubs::kPutter)
    {
        if (best_ball.y() + best_ball.measured_radius_pixels_ >=
            0.98 * strobed_balls_gray_image.rows)
        {
    ...
    if (BallImageProc::kUseBestCircleRefinement && perform_best_circle_fit_when_putting)
    {
        for (size_t first_index = 0; first_index < return_balls.size(); first_index++)
        {
            ...
            if (first_index == 0)
            {
                LoggingTools::DebugShowImage(
                    "GolfSimCamera::TestAnalyzeStrobedBall GRAY pre-best-circle input: ",
                    strobed_balls_gray_image);
            }

            // TBD - Still trying to figure out of the largest circle (among the
            // top few) is the best?
            if (!BallImageProc::DetermineBestCircle(strobed_balls_gray_image, original_ball,
                                                    BallImageProc::kUseBestCircleLargestCircle,
                                                    best_circle))
            {
                GS_LOG_MSG(warning,
                           "GolfSimCamera::AnalyzeStrobedBalls - failed to DetermineBestCircle spin ball number "
                           +
            ...
            LoggingTools::DebugShowImage(
                "GolfSimCamera::TestAnalyzeStrobedBall GRAY POST-best-circle input: ",
                strobed_balls_gray_image);

            // Replace the ball circle information with this (hopefully) better
            // information
            original_ball.set_circle(best_circle);

            // Also find this ball in the
            // possibly_overlapping_balls_before_color_filter and update it's
            // circle information
            for (size_t nonoverlapping_index = 0;
                 nonoverlapping_index < possibly_overlapping_balls_before_color_filter.size();
                 nonoverlapping_index++)
            {
                GolfBall &nonoverlapping_ball =
                    possibly_overlapping_balls_before_color_filter[nonoverlapping_index];

                // Find the ball by its quality ranking, which should be unique
                // in each set
    ...
    ShowAndLogBalls("AnalyzeStrobedBall - improved ball set",
                    strobed_balls_color_image,
                    return_balls,
                    kLogIntermediateExposureImagesToFile);

    // Figure out how much time passed between the middle and the second ball
    // images, as
    ...
    GS_LOG_TRACE_MSG(trace,
                     "The time between the center-most two images is: " +
                     std::to_string((double)time_between_ball_images_uS / 1000.0) + "ms.");

    // This is a "final" image, so we want to store it
    ShowAndLogBalls("AnalyzeStrobedBall_Final_Candidate_Balls",
                    strobed_balls_color_image,
                    return_balls,
                    true,
                    most_centered_ball_index,
    ...
    // Also return a set of fairly-strictly-non-overlapping balls for use with,
    // e.g., spin analysis
    // NOTE - if there is a negative %, it is here to make sure the balls are
    // well-separated.
    // Otherwise, we sometimes get some overlap with a ball that was missed.

    // TBD - Some question here whether to get rid of the clear overlaps first,
    // and then
    // get rid of the bad colors, or vice versa.  Let's use color as a last
    // resort...

    SortBallsByXPosition(possibly_overlapping_balls_before_color_filter);

    ShowAndLogBalls(
        "AnalyzeStrobedBall - possibly_overlapping_balls_before_color_filter before RemoveOverlappingBalls",
        strobed_balls_color_image,
        possibly_overlapping_balls_before_color_filter,
        false);
    LoggingTools::Trace(
        "AnalyzeStrobedBall - possibly_overlapping_balls_before_color_filter before RemoveOverlappingBalls: ",
        possibly_overlapping_balls_before_color_filter);
    ...
    // The false is to ensure ALL overlapping balls are removed.  We want to
    // check for overlaps
    // between as many possible balls as we can, so we perform this
    // identification on the set
    // of balls before off-color (and possibly overlapping) balls were removed.
    RemoveUnlikelyRadiusChangeBalls(possibly_overlapping_balls_before_color_filter,
                                    max_intermediate_ball_radius_change_percent,
                                    kMaxOverlappedBallRadiusChangeRatio,
                                    false);

    ShowAndLogBalls("AnalyzeStrobedBall - balls after final RemoveUnlikelyRadiusChangeBalls",
                    strobed_balls_color_image,
                    possibly_overlapping_balls_before_color_filter,
                    false);

    // TBD - For some reason, we end up creating the possibly-overlapping-balls
    // vector at a time before the poor quality balls are necessarily removed.
    // So, do so here
    RemoveUnlikelyAngleLowerQualityBalls(possibly_overlapping_balls_before_color_filter);
    ShowAndLogBalls("AnalyzeStrobedBall_After FINAL RemoveUnlikelyAngleLowerQualityBalls",
                    strobed_balls_color_image,
                    possibly_overlapping_balls_before_color_filter,
                    kLogIntermediateExposureImagesToFile);
    ...
    ShowAndLogBalls("AnalyzeStrobedBall - balls after strictly-overlapping are removed",
                    strobed_balls_color_image,
                    non_overlapping_balls,
                    kLogIntermediateExposureImagesToFile);
    ...
    for (int i = (int)(non_overlapping_balls_and_timing.size() - 1); i >= 0; i--)
    {
        ...
        {
            // Need to remove this ball element from the non-overlapping
            // ball/timing vector
            // because it was removed from the ball-only vector.
            // Before we do so, Add it's left-most interval time to the
            // left-most
            // interval time of the ball to the right (if such ball exists)
            if (i < (int)(non_overlapping_balls_and_timing.size() - 1))
            {
                non_overlapping_balls_and_timing[i +
                                                 1].time_interval_before_ball_us +=
                    be.time_interval_before_ball_us;
            }
    ...
    ShowAndLogBalls("AnalyzeStrobedBall - FINAL strictly-non-overlapping balls",
                    strobed_balls_color_image,
                    non_overlapping_balls);
...
// Especially for lightweight practice balls, the ball will slow down
// considerably
// as it traverses the field of view.  Thus, the right-distance will be shorter
// than
...
double GolfSimCamera::AdjustDistanceForSlowing(const double initial_right_distance)
{
    ...
    double right_distance = initial_right_distance *
                            (1.0 + kBallConstantSpeedAdjustmentPercentage / 100.0);
                                                      ...
                                                      bool try_different_offsets)
{
    ...
    for (int distance_pattern_offset = 0;
         distance_pattern_offset < (int)(pulse_ratios.size() - distance_ratios.size());
         distance_pattern_offset++)
    {
        double difference_in_ratios = ComputeRatioDistance(distance_ratios,
                                                           pulse_ratios,
                                                           distance_pattern_offset);

        GS_LOG_TRACE_MSG(trace,
                         "difference_in_ratios for offset " +
                         std::to_string(distance_pattern_offset) + " is: " +
                         std::to_string(difference_in_ratios));

        // If the current offset of the distance ratios within the pulse ratio
        // pattern
        // results in the lowest error (distance), then assume it's the best for
        // now.
        if (difference_in_ratios < delta_to_closest_ratio)
        {
            // This is the smallest difference we've seen so far, so keep it!
            // Also, figure out if the interval is to the left or to the right
            // of the
        ...
        // If we are, for example, enumerating all possible strobe vector
        // patterns,
...
// Returns a score of the closeness of the vector of distance_ratios within the
// pulse_ratios at an offset
                                           ...
                                           int &distance_pattern_offset)
{
    ...
    // Compute the differences between each distance ratio in the pattern of
    // distances as compared
    // to each possible offset of those ratios to the pulse interval ratios.
    for (size_t distance_ratio_index = 0;
         distance_ratio_index < distance_ratios.size();
         distance_ratio_index++)
    {
        // If we got more ball distance ratios than we have collapsed (and thus
        // down-sized) pulse
        // ratios, then just stop and return a big error number to drop this
        // comparison from the
        // best-of list.
        ...
        {
            LoggingTools::Warning(
                "GolfSimCamera::ComputeRatioDistance received a distance_ratio_index higher than the number of pulse ratios.");
            return kMaxRatioDistance;
        }
        // Compute the difference as a percent of the distance ratio so that
        // each element
        // of the pattern of ratios can contribute a meaningful amount of
        // error/difference
        ...
        // Get a difference that is >= 0 so that squaring it will not decrease
        // the number
        // double single_ratio_difference = 100. * std::abs(distance_ratio -
        // pulse_ratio) / std::min(distance_ratio, pulse_ratio);
        double single_ratio_difference = 100. * std::abs(distance_ratio - pulse_ratio);

        // If we get a crazy number, cap it so that we don't go out of bounds of
        // our variable
        ...
        GS_LOG_TRACE_MSG(trace,
                         "   single_ratio_difference: " + std::to_string(single_ratio_difference));
...
// Set the element of the vector to true when there is a 1 bit (a flag to remove
// the corresponding strobe pulse) in the vector
                                             ...
                                             GsBallsAndTimingVector &return_balls_and_timing)
{
    ...
    {
        LoggingTools::Warning(
            "GetBallDistancesAndRatios returned no data.  Has the strobe vector been established?");
        return false;
    }

    LoggingTools::Trace( "Return_balls distances: ", distances);
    LoggingTools::Trace(
        "--------------------Return_balls distance ratios (adjusted for slow-down): ",
        distance_ratios);

    // We will get the full set of pulse ratios to see if we can confirm that
    // there are fewer
    // distances than pulses.  TBD - Not sure useful?
    // We also need the original, actual intervals to figure out how many we
    // want to collapse
    // further down in this function.
    std::vector<double>test_pulse_ratios;
    std::vector<float>test_pulse_intervals;

    bool result = GetPulseIntervalsAndRatios(PulseStrobe::GetPulseIntervals(),
                                             test_pulse_intervals,
                                             test_pulse_ratios);

    LoggingTools::Trace( "The pulse_interval ratios were: ", test_pulse_ratios);

    // Look at each pulse interval ratio that we have and see which is closest
    // to the ratio(s) that
    // exist for distance deltas.
    // NOTE - Assumes near-constant ball speed such that the ratios of strobe
    // intervals is directly
    // proportional to the distances covered during those intervals.

    // Provide some sensible default for the interval time.  Will calculate in
    // code below.
    time_between_ball_images_uS = 0;

    // Ensure we have at least one distance ratio, which means at least 2
    // distances and 3 balls
    // If not, fall back to a simpler estimate
    if (distance_ratios.size() > 0)
    {
        // Each interval ratio we have will involve three balls
        // (left/right/middle), and should be
        // roughly equal to the ratio of the distance between the middle and
        // next ball divided
        // by the distance between the ball before the middle and the middle

        // Compute the correlation (closeness) of the ball distance ratio
        // pattern to the pulse ratio
        // pattern.  The distance ratios will always be <= the number of pulse
        // intervals, due to the
        // possibility of losing some highly-overlapped images early in the
        // pattern.

        // There shouldn't be too many missed pulses, but they could occur
        // anywhere, so make sure
        ...
        // We will now generate all combinations of fitting the <x> 'missing'
        // balls into the <y> possible
        // positions that exist in the pulse vector.  We had originally been
        // assuming there would just be one
        // contiguous group of missing balls, but that turned out not to be
        // true.  So, now go through all combinations
        ...
        // There might be 0 missing exposures, in which case, we won't have to
        // do any
        // interval collapsing
        ...
        // Because we're unlikely to have more than 8 or so possible strobes, we
        // will just use a
        // brute-force method to figure out all combinations of exposures in the
        // strobe vector.
        // This code iterates though all possible numbers of an n-bit number and
        // whenever the number
        // has the correct number of bits, we use that pattern as a possible
        // candidate for how the
        ...
        for (int i = 0; i < (1 << number_of_strobes) - 1; ++i)
        {
            if (CountSetBits(i) == number_missed_exposures)
            {
                ...
                // Too detailed to keep in production system -
        ...
        {
            std::vector<bool> intervals_to_collapse_vector =
                candidate_intervals_to_collapse_patterns_vector[i];
             ...
             *  GS_LOG_TRACE_MSG(trace, "----------> - Reached the vector of
             * interest.");
             * }
             **/

            // Formulate a new set of pulses that correspond to the exposures
            // that we found
            // with the pulses corresponding to the 'missing' exposures
            // collapsed/removed.
            ...
            if (!GetPulseIntervalsAndRatiosFromIntervalVector(intervals_to_collapse_vector,
                                                              current_pulse_intervals_ms,
                                                              pulse_intervals, pulse_ratios))
            {
                GS_LOG_TRACE_MSG(error, "Failed to GetPulseIntervalsAndRatiosFromIntervalVector");
                return false;
            }

            // Too chatty- LoggingTools::Trace("The (potentially collapsed)
            // pulse_intervals were (ignore last '0' interval): ",
            // pulse_intervals);
            // LoggingTools::Trace("The (potentially collapsed) pulse_ratios
            // were : ", pulse_ratios);

            double delta_to_closest_ratio;

            int best_local_offset_of_distance_ratios =
                FindClosestRatioPatternMatchOffset(distance_ratios,
                                                   pulse_ratios,
                                                   delta_to_closest_ratio,
                                                   true /* Try any offset */);

            // If this is the closest match seen so far, save the information
            if (best_local_offset_of_distance_ratios >= 0 &&
                delta_to_closest_ratio <= best_ratio_distance)
            {
                ...
                GS_LOG_TRACE_MSG(trace,
                                 "------------> Found best (so far) pulse ratio pattern match.  best_ratio_distance= "
                                 + std::to_string(best_ratio_distance)
                                 + " best_final_offset_of_distance_ratios= " +
                                 std::to_string(best_ratio_distance)
                                 + " best_intervals_pattern_index= " +
                                 std::to_string(best_intervals_pattern_index) + ".  Vector was : ");
                PrintPulseVector(
                    candidate_intervals_to_collapse_patterns_vector[best_intervals_pattern_index]);
            }
        }

        GS_LOG_TRACE_MSG(trace,
                         "------------> Best-fitting pulse vector was number: " +
                         std::to_string(best_intervals_pattern_index) + ".  With score of: " +
                         std::to_string(best_ratio_distance) + ".  Vector was : ");
        PrintPulseVector(
            candidate_intervals_to_collapse_patterns_vector[best_intervals_pattern_index]);

        // If we found a best correllation, re-create the corresponding set of
        // ratios and intervals
        std::vector<double>pulse_ratios;
        std::vector<float>pulse_intervals;

        // We will retrieve the actual pulse interval (in uS) from the list of
        // such intervals.
        // Just need to figure out WHICH interval corresponds to the two balls
        // of interest.
        if (!GetPulseIntervalsAndRatiosFromIntervalVector(
                candidate_intervals_to_collapse_patterns_vector[best_intervals_pattern_index],
        ...
        LoggingTools::Trace( "The best set of pulse_intervals was (ignore last '0' interval): ",
                             pulse_intervals);

        // Transfer the pulse intervals to the array of balls and associated
        // timing
        // The first ball doesn't get a prior interval
        // Input_balls area assumed to be sorted based on the handedness of the
        // shot,
        ...
        for (size_t i = 0; i < input_balls.size(); i++)
        {
            ...
            if (i > 0)
            {
                be.time_interval_before_ball_us = 1000 *
                                                  pulse_intervals[
                    best_final_offset_of_distance_ratios + i - 1];
            }
        ...
        std::sort(return_balls_and_timing.begin(), return_balls_and_timing.end(),
                  [](const GsBallAndTimingElement &a, const GsBallAndTimingElement &b)
            {
        ...
        if (second_ball_index > most_centered_ball_index)
        {
            ...
            // of the middle ball.  Because of the sort we just did, this will
            // also
            // be correct for left-handed playing, where the
            time_between_ball_images_uS = (long)std::round(1000 *
                                                           pulse_intervals[most_centered_ball_index
                                                                           +
                                                                           best_final_offset_of_distance_ratios]);
        }
        else
    ...
    else
    {
        ...
        {
            GS_LOG_MSG(warning,
                       "DetermineStrobeInterval received only two recognized balls - will make a guess that this was the last two exposures.");

            // We only have two valid ball images
            // Special cases where we only have 2 balls initially, or if we
            // ultimately only end up with two.
            // Having only two balls might occur when the ball was hit really
            // fast, and we only got
            // two strobes before the ball went out of the FoV.  In this case,
            // we (MAYBE) can assume that the first interval
            // must be the first strobe delay.
            //    We could do:   time_between_ball_images_uS =
            // pulse_intervals[0];
            // OR...
            // Maybe we trust that we actually managed to identify EACH of the
            // strobes (even though we threw some out earlier)
            // In that case, just count the number of images up to the two balls
            // of interest and pick that pulse length:
            ...
            // We will retrieve the actual pulse interval (in uS) from the list
            // of such intervals.
            // Just need to figure out WHICH interval coresponds to the two
            // balls of interest.
            if (!GetPulseIntervalsAndRatios(PulseStrobe::GetPulseIntervals(),
                                            pulse_intervals,
                                            pulse_ratios))
            {
            ...
            if (input_balls.size() == 2)
            {
                ...
                time_between_ball_images_uS = (long)std::round(1000 *
                                                               pulse_intervals[pulse_intervals.size()
                                                                               - 2]);
            ...
            {
                GS_LOG_MSG(error,
                           "GetPulseIntervalsAndRatios failed - Input balls < 3 and not 2 (?.");
                return false;
            }
        }
        else
        {
            GS_LOG_MSG(warning,
                       "DetermineStrobeInterval received only two recognized balls - will make a guess that this was the first two exposures.");
            ...
            // We will retrieve the actual pulse interval (in uS) from the list
            // of such intervals.
            // Just need to figure out WHICH interval corresponds to the two
            // balls of interest.
            if (!GetPulseIntervalsAndRatios(PulseStrobe::GetPulseIntervals(),
                                            pulse_intervals,
                                            pulse_ratios))
...
bool GolfSimCamera::GetPulseIntervalsAndRatiosFromIntervalVector(
    const std::vector<bool> &intervals_to_collapse_vector,
    const std::vector<float> &
    initial_pulse_intervals_ms,
    std::vector<float> &
    pulse_intervals,
    std::vector<double> &
    pulse_ratios)
{
    ...
    for (int v = 0; v < (int)intervals_to_collapse_vector.size() - 1; v++)
    {
        ...
        {
            // Ignore the current pulse_ratios for right now as we are building
            // the complete pulse_interval set
            // At the end of this loop, ths pulse_ratios should hold the final
            // ratio set corresponding to the
            // current_pulse_intervals_ms

            bool result = GetPulseIntervalsAndRatios(current_pulse_intervals_ms,
                                                     pulse_intervals,
                                                     pulse_ratios,
                                                     1,
                                                     v - number_collapsed_intervals_so_far);

            number_collapsed_intervals_so_far++;
            // We are going to continue to work on the result vector, and
...
{
    GS_LOG_TRACE_MSG(trace,
                     "GolfSimCamera::GetPulseIntervalsAndRatios: number_pulses_to_collapse: " +
                     std::to_string(number_pulses_to_collapse) +
    ...
    // "Collapsing" a pulse ratio means taking two pulses and treating them as
    // one.  Which is
    // how the rest of the code would see the world if two strobed ball images
    // could not be
    // separately resolved.  In that scenario, it's as if a ball was lost, so
    // the way to correct
    // for it is to treat things as if that strobe pulse never happened, and
    // that the prior strobe
    ...
    if (collapse_offset >= 0 && number_pulses_to_collapse > 0)
    {
        ...
        {
            GS_LOG_MSG(error,
                       "GolfSimCamera::GetPulseRatios - collapse_offset of " +
                       std::to_string(collapse_offset) + " was too large.");
            return false;
        }
        ...
        {
            working_pulse_intervals[collapse_offset] += working_pulse_intervals[collapse_offset +
                                                                                1];

            // The erase() will both remove the collapsed element and also move
                                             ...
                                             std::vector<GolfBall> &exposure_balls)
{
    ...
    else
    {
        ...
        {
            GS_LOG_MSG(warning,
                       "ProcessReceivedCam2Image - not using kUsePreImageSubtraction, or received empty camera2_pre_image_.");
        }
        else
        {
            // TBD - For test:
            /*
             *
             * // cv::erode(camera2_pre_image_, camera2_pre_image_,
             * cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)),
             * cv::Point(-1, -1), 2);
             * // cv::GaussianBlur(camera2_pre_image_, camera2_pre_image_,
             * cv::Size(7, 7), 0);
             * // cv::dilate(camera2_pre_image_, camera2_pre_image_,
             * cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)),
             * cv::Point(-1, -1), 2);
             *
             * LoggingTools::LogImage("", bgr[0], std::vector < cv::Point >{},
             * true, "pre_image (blue).png");
             * LoggingTools::LogImage("", bgr[1], std::vector < cv::Point >{},
             * true, "pre_image (green).png");
             * LoggingTools::LogImage("", bgr[2], std::vector < cv::Point >{},
             * true, "pre_image (red).png");
             *
             *
             */
            ...
            // cv::GaussianBlur(camera2_pre_image_, camera2_pre_image_,
            // cv::Size(3, 3), 0);
            // MAY HURT HOUGH cv::erode(camera2_pre_image_, camera2_pre_image_,
            // cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)),
            // cv::Point(-1, -1), 1);

            GolfSimConfiguration::SetConstant(
                "gs_config.ball_exposure_selection.kPreImageWeightingOverall",
                kPreImageWeightingOverall);
            GolfSimConfiguration::SetConstant(
                "gs_config.ball_exposure_selection.kPreImageWeightingBlue",
                kPreImageWeightingBlue);
            GolfSimConfiguration::SetConstant(
                "gs_config.ball_exposure_selection.kPreImageWeightingGreen",
                kPreImageWeightingGreen);
            GolfSimConfiguration::SetConstant(
                "gs_config.ball_exposure_selection.kPreImageWeightingRed",
                kPreImageWeightingRed);
            ...
            // LoggingTools::LogImage("", final_pre_image, std::vector <
            // cv::Point >{}, true, "scaled_pre_image.png");

            // Subtract the pre-image from the incoming strobed image to
            // (hopefully) end up with just
            ...
            LoggingTools::LogImage("",
                                   prepared_strobed_ball_mat,
                                   std::vector < cv::Point >{},
                                   true,
                                   "strobed_img_minus_pre_image.png");
        }
    }

    // TBD - Are we doing this just to allow us to use non-const images?
    //  Refactor?
    cv::Mat ball1ImgColor;

    if (GolfSimOptions::GetCommandLineOptions().GetCameraNumber() == GsCameraNumber::kGsCamera2)
    {
        // Special case - if we are using this function just to get the ball
        // location
    ...
    // One set of positions, below describes the relationship of camera2 to
    // itself and the z-plane of the ball.
    // That set does not contain any displacement in the X,Y plane.
    // The offsets are from the origin, which is assumed to be where the ball is
    // placed
    // A second set of positions describes the relationship of camera2 to
    // camera1 so that trajectories
    // may be calculated as between the initial ball image and the second
    // images.
    ...
    // Get the location information about the first ball from the initial,
    // static, image
    GolfBall calibrated_ball;

    /*****************************  Get the first (teed) ball
     *  ***************************/
    bool success = camera_1.GetCalibratedBall(camera_1,
                                              ball1_mat,
                                              calibrated_ball,
                                              expectedBallCenter);
    ...
    {
        GS_LOG_TRACE_MSG(trace,
                         "ProcessReceivedCam2Image returning early, as we are just here to find the ball location for testing.");
        return true;
    }

    GS_LOG_TRACE_MSG(trace,
                     "ProcessReceivedCam2Image - Calibrated Ball is:\n" + calibrated_ball.Format());
    ...
    // First, determine a velocity based on the two best balls as determined by
    // the
    // AnalyzeStrobedBall method.

    GolfBall ball1, ball2;

    // Normalize the balls such that ball1 is to the left and ball2 is to the
    // right
    // NOTE - This should still be the same for left-handed shots.  Although
    // doing so
    // will mean that the spin analysis will essentially be backward, the shot
    // is also
    // in a sense reversed, and TBD I think the two effects will cancel each
    // other out with respect to spin.
    ...
    // Now use those two 'best' balls to determine the position deltas for the
    // balls so that we
    ...
    GS_LOG_TRACE_MSG(trace,
                     "ProcessReceivedCam2Image - ball2 (with delta information) is:\n" +
                     ball2.Format());

    // At this point, ball2 now holds the important delta information from which
    // things like velocity will be
    // computed.  Transfer all of that to the result ball.
    result_ball = ball2;

    // Next, calculate launch and side angles as between the initial,
    // stationary, ball and each of
    // the strobed images.  Given the distance from the initial ball and the
    // later in-flight
    // exposures, the average angles should be pretty accurate, even if, for
    // example, there is
    // some noisy calculations of the radius of the strobed ball exposures.
    // TBD - Because the ball moves in a non-linear manner for the period of
    // time that the ball
    // is in contact with the club, we may want to compute the Ball Deltas using
    // only the strobed
    // balls!
    ...
    for (size_t first_index = 0; first_index < return_balls_and_timing.size(); first_index++)
    {
        ...
        {
            GS_LOG_MSG(error,
                       "ProcessReceivedCam2Image - failed to ComputeBallLocation between initial ball and strobed ball.");
            return false;
        }
            ...
            GolferOrientation::kLeftHanded)
        {
            ...
            {
                GS_LOG_MSG(error,
                           "ProcessReceivedCam2Image - failed to ReverseBallDeltas for ball2.");
                return false;
            }
        }

        GS_LOG_TRACE_MSG(trace,
                         "ProcessReceivedCam2Image - Strobed Ball (for averaging) is:\n" +
                         ball2.Format());

        // Get ready to average the measurements of this calculated ball with
        // any others
        camera1_average_ball_vector.push_back(ball2);
    }

    // We want to average the launch angles, but we don't want to average any
    // spins or distance or velocities.
    // Doesn't really make sense to average the two pairs of balls' distances,
    // for example,
    // as those would be different by design since it's (usually) different
    // pairs
    GolfBall camera1_averaged_ball;
    GolfBall::AverageBalls(camera1_average_ball_vector, camera1_averaged_ball);

    GS_LOG_TRACE_MSG(trace,
                     "Averaged angles from the initial, stationary ball to each strobed ball:\n" +
                     camera1_averaged_ball.Format());

    // Initially overwrite the angle information with the (hopefully) more
    // accurate angles formed by the
    ...
    result_ball.angles_camera_ortho_perspective_ =
        camera1_averaged_ball.angles_camera_ortho_perspective_;

    // At this point, we also have a more accurate idea of the launch side-angle
    // than we could have
    // derived from just the change in the radius of the ball in the camera2
    // image.  So, re-calculate
    // the velocity based on that side angle in combination with the other two
    // original angles
    result_ball.position_deltas_ball_perspective_[0] =
        result_ball.distances_ortho_camera_perspective_[0] *
        sin(CvUtils::DegreesToRadians(
                result_ball.angles_ball_perspective_[0]));

    // The velocity will be calculated from the updated
    // position_deltas_ball_perspective_
    ...
    // TBD - Let's see how the entire group of strobed balls BY THEMSELVES do in
    // terms of HLA, VLA, velocity, etc.
    GolfBall average_of_strobed_ball_data;

    if (!ComputeAveragedStrobedBallData(camera_2,
                                        return_balls_and_timing,
                                        average_of_strobed_ball_data))
    {
        GS_LOG_MSG(error,
                   "ProcessReceivedCam2Image - failed to ComputeBallLocation between initial ball and strobed ball.");
        return false;
    ...
    GS_LOG_TRACE_MSG(trace,
                     "ComputeAveragedStrobedBallData returned ball=:" +
                     average_of_strobed_ball_data.Format());

    // Overwrite the VLA angle information with the (hopefully) more accurate
    // angles formed by the angles between each of the strobed balls
    result_ball.angles_ball_perspective_[1] =
        average_of_strobed_ball_data.angles_ball_perspective_[1];

    // Send a quick IPCResult message here to allow the user to quickly
    // see the angular and velocity information before we do the (lengthy) spin
    // measurement.
#ifdef __unix__
    // TBD - Note the sleep in the send will slow us down getting to the spin
    // measurement
    ...
    GolfSimConfiguration::SetConstant("gs_config.PiTraculator_interfaces.kSkipSpinCalculation",
                                      kSkipSpinCalculation);
    ...
    else
    {
        if (non_overlapping_balls_and_timing.size() < 2)
        {
            ...
            // We probably still calculated non-spin values like HLA, VLA and
            // velocity,
            // so return successfully and set the spin values to something we
            // can
        ...
        // non-overlapping set of balls, and apply that information to the
        // result_ball
        ...
        {
            // If we can't compute spin, it's a bummer, but it shouldn't be
            // fatal
                                ...
                                cv::Vec3d &rotationResults)
{
    ...
    // Try to find the two closest balls while avoiding any balls really close
    // to the edge if we can.
    // Back off if necessary
    if (!FindBestTwoSpinBalls(strobed_balls_gray_image,
                              non_overlapping_balls_and_timing,
                              true,
                              spin_ball1,
                              spin_ball2,
                              spin_timing_interval_uS))
    {
        if (!FindClosestTwoBalls(strobed_balls_gray_image,
                                 non_overlapping_balls_and_timing,
                                 false,
                                 spin_ball1,
                                 spin_ball2,
    ...
    // Now use the two 'best' balls to determine the position deltas for the
    // balls so that we
    // can, for example, compute velocity
    ...
    ShowAndLogBalls("ProcessSpin - Final Spin Balls",
                    strobed_balls_gray_image,
                    finalSpinBalls,
                    kLogIntermediateExposureImagesToFile);

    // The best spin analysis will likely be between the two closest balls that
    // are non-overlapping
    rotationResults = BallImageProc::GetBallRotation(strobed_balls_gray_image,
                                                     spin_ball1,
                                                     strobed_balls_gray_image,
                                                     spin_ball2);
    ...
    camera.CalculateBallSpinRates(result_ball, rotationResults,
                                  (long)std::round(spin_timing_interval_uS));
                                        ...
                                        double &timing_interval_uS)
{
    ...
    // A bunched-up group of balls in the x dimension is pretty unlikely, but
    // check just in case
    ...
    // However, if we found a pair that was actually touching or overlapping a
    // bit,
    // we do NOT want to continue to look at potential pairs further to the
    // left, as those
    // ball are likely to be more heavily overlapped with other exposures,
    // including
    // exposures that were potentially missed during the original
    // filtering/identification.
    // Loop from right to left so we can stop once we find balls that are
    // actually touching
    for (int first_index = (int)balls.size() - 1;
         first_index > 0 && !found_touching_pair;
         first_index--)
    {
        for (int second_index = first_index - 1;
             second_index >= 0 && !found_touching_pair;
             second_index--)
        {
            ...
            double next_distance =
                balls[first_index].ball.PixelDistanceFromBall(balls[second_index].ball);
            ...
            if (next_distance < closest_distance_so_far)
            {
                ...
                // If the balls we just found are touching or overlapped, bail
                // out
...
bool GolfSimCamera::ComputeAveragedStrobedBallData(const GolfSimCamera &camera,
                                                   ...
                                                   GolfBall &output_averaged_ball)
{
    ...
    for (size_t i = 0; i < balls_and_timing.size() - 1; i++)
    {
        ...
        for (size_t j = i + 1; j < balls_and_timing.size(); j++)
        {
            ...
            GS_LOG_MSG(trace,
                       "ComputeAveragedStrobedBallData comparing the following two balls (indexes are within the vector): Balls ("
                                         ...
                                         double &timing_interval_uS)
{
    ...
    for (size_t i = 0; i < balls_and_timing.size(); i++)
    {
        ...
        for (size_t j = i + 1; j < balls_and_timing.size(); j++)
        {
            ...
            // Really close but not overlapping pairs should get about a 10
            // score

            // If the balls are overlapping, give the result a low score - they
            // will likely
            // be too smudgy for a good spin calculation
            if (pair_proximity <
                0.95 * (ball1.measured_radius_pixels_ + ball2.measured_radius_pixels_))
            {
                pair_proximity_score = 0;
            }
            else
            {
                pair_proximity_score = (10.0 *
                                        (ball1.measured_radius_pixels_ +
                                         ball2.measured_radius_pixels_)) / pair_proximity;
            }
            ...
            double distance_from_screen_center_to_edge = CvUtils::GetDistance(screen_edge,
                                                                              screen_center);
            double ball1_distance_from_screen_center = CvUtils::GetDistance(ball1_center,
                                                                            screen_center);
            double ball2_distance_from_screen_center = CvUtils::GetDistance(ball2_center,
                                                                            screen_center);

            double ball1_middle_proximity_score = 5.0 *
                                                  ((distance_from_screen_center_to_edge -
                                                    ball1_distance_from_screen_center) /
                                                   distance_from_screen_center_to_edge);
            double ball2_middle_proximity_score = 5.0 *
                                                  ((distance_from_screen_center_to_edge -
                                                    ball2_distance_from_screen_center) /
                                                   distance_from_screen_center_to_edge);

            middle_proximity_score = ball1_middle_proximity_score + ball2_middle_proximity_score;

            // A large difference in color STD suggests that one ball has some
            // overlap with
            // something bright that will affect its ability to be accurately
            // filtered for spin
            double std_diff = CvUtils::ColorDistance(ball1.std_color_, ball2.std_color_);

            color_std_score = std::max(0.0, (30.0 - std_diff) / 3.0);

            // The 13.6 and 8 just allows the too-big-of-a-radius-change limit
            // to be relative to the
            // number of pixels we have to work with.  Should be about 08.
            radius_similarity_score = std::max(0.0,
                                               (img.rows / 13.6) - 3.0 *
                                               pow((ball1.measured_radius_pixels_ -
                                                    ball2.measured_radius_pixels_), 2.0)) / 8.;
    ...
    std::sort(ball_pair_elements.begin(), ball_pair_elements.end(),
              [](const GsBallPairAndSpinCandidateScoreElement &a,
                 const GsBallPairAndSpinCandidateScoreElement &b)
        {
    ...
    {
        std::string spin_ball_score_text = "TOTAL: " +
                                           std::to_string(ball_pair_element.total_pair_score) +
                                           ", edge_proximity_score: " +
                                           std::to_string(ball_pair_element.edge_proximity_score) +
                                           ", pair_proximity_score: " +
                                           std::to_string(ball_pair_element.pair_proximity_score) +
                                           ", color_std_score: " +
                                           std::to_string(ball_pair_element.color_std_score) +
                                           ", middle_proximity_score: " +
                                           std::to_string(
            ball_pair_element.middle_proximity_score) +
                                           ", leg_proximity_score: " +
                                           std::to_string(ball_pair_element.leg_proximity_score) +
                                           ", radius_similarity_score: " +
                                           std::to_string(
            ball_pair_element.radius_similarity_score);

        GS_LOG_TRACE_MSG(trace,
                         "Potential Spin Ball Combination of balls ( " +
                         std::to_string(ball_pair_element.ball1_index) + ", " +
                         std::to_string(ball_pair_element.ball2_index) + ") scored: " +
                         spin_ball_score_text);
    }
    ...
    // If necessary, reverse the ball order so that the ball on the left will be
    // first.
                                    ...
                                    const int thickness)
{
    for (size_t i = 0; i < lines.size(); i++)
    {
        ...
        // std::cout << "rho, theta = " << std::to_string(rho) << ", " <<
        // std::to_string(CvUtils::RadiansToDegrees(theta)) << "." << std::endl;

        bool is_high_priority_angle = (angle > kExternallyStrobedEnvLinesAngleLower) &&
                                      (angle < kExternallyStrobedEnvLinesAngleUpper);

        double line_length = sqrt((pow((double)(pt1.x - pt2.x), 2.) + pow((double)(pt1.y - pt2.y),
                                                                          2.)));
...
bool GolfSimCamera::CleanExternalStrobeArtifacts(const cv::Mat &image,
                                                 cv::Mat &output_image,
                                                 std::vector<cv::Vec4i> &lines)
{
    ...
    cv::GaussianBlur(image_gray, image_gray, cv::Size(kExternallyStrobedEnvPreCannyBlurSize,
                                                      kExternallyStrobedEnvPreCannyBlurSize), 0);

    // Get a good picture of the edges of the balls.  Will probably have way too
    // many shaft lines
    cv::Mat cannyOutput_for_balls;
    cv::Canny(image_gray,
              cannyOutput_for_balls,
              kExternallyStrobedEnvCannyLower,
              kExternallyStrobedEnvCannyUpper);
    ...
    if (kExternallyStrobedEnvPreHoughBlurSize > 0)
    {
        ...
        cv::GaussianBlur(cannyOutput_for_balls, cannyOutput_for_balls,
                         cv::Size(kExternallyStrobedEnvPreHoughBlurSize,
                                  kExternallyStrobedEnvPreHoughBlurSize), 0);
    }
    ...
    // Color Filtering - commented out (TBD) because this hasn't actually worked
    // very well.  There's too much of a mix of colors

    /****
     * cv::Scalar lowerHsv{ (float)kExternallyStrobedEnvFilterHsvLowerH,
     * (float)kExternallyStrobedEnvFilterHsvLowerS,
     * (float)kExternallyStrobedEnvFilterHsvLowerV };
     * cv::Scalar upperHsv{ (float)kExternallyStrobedEnvFilterHsvUpperH,
     * (float)kExternallyStrobedEnvFilterHsvUpperS,
     * (float)kExternallyStrobedEnvFilterHsvUpperV };
     *
     * cv::Mat hsvImage;
     * cv::cvtColor(image, hsvImage, cv::COLOR_BGR2HSV);
     *
     * cv::Mat color_mask_image = BallImageProc::GetColorMaskImage(hsvImage,
     * lowerHsv, upperHsv);
     *
     * cv::dilate(color_mask_image, color_mask_image,
     * cv::getStructuringElement(cv::MORPH_ELLIPSE, cv::Size(1, 1)),
     * cv::Point(-1, -1), 1);
     *
     *
     * // LoggingTools::DebugShowImage("External Strobe Color Mask-
     ...
     * cv::split(dest, output_image_planes);  // now we have the L image in
     * lab_planes[0]
     *
     * cv::bitwise_and(output_image_planes[0], color_mask_image,
     * output_image_planes[0]);
     * cv::bitwise_and(output_image_planes[1], color_mask_image,
     * output_image_planes[1]);
     * cv::bitwise_and(output_image_planes[2], color_mask_image,
     * output_image_planes[2]);
     *
    ...
    if (kExternallyStrobedEnvBottomIgnoreHeight > 0)
    {
        ...
        cv::rectangle(output_image,
                      floor_blackout_area.tl(),
                      floor_blackout_area.br(),
                      black_color,
                      cv::FILLED);
    }

    // LoggingTools::DebugShowImage("External Strobe Final Result Image",
    // output_image);

    return true;
}

bool GolfSimCamera::TakeStillPicture(const GolfSimCamera &camera,
                                     cv::Mat &color_image)
{
    const GsCameraNumber camera_number = camera.camera_hardware_.camera_number_;

    GS_LOG_TRACE_MSG(trace,
                     "TakeStillPicture called with camera number = " +
                     std::to_string(camera_number));

#ifdef __unix__  // Ignore in Windows environment

    // The process for taking a picture in the Pi environment will depend on
    // which camera
    // is in use.  For the camera 2, we need to rely on a separate executable to
    // take
    ...
    // We are taking a picture with the camera that is (presumably) controlled
    // from
    ...
    // At this point, the camera2 system should take a image and return it via
    // IPC
    ...
    GolfSimConfiguration::SetConstant("gs_config.calibration.kTestAutoCalibrationFileName",
                                      kTestAutoCalibrationFileName);
...
// TBD - MOVE to where the other parameters are.  This is just here for
// development convenience for now
// These parameters are used for auto-calibration

// This parameter will be set from the config .json file based on the known
...
{
    GS_LOG_TRACE_MSG(trace,
                     "RetrieveAutoCalibrationConstants called with camera number = " +
                     std::to_string(camera_number));

    std::string camera_number_string = std::to_string(camera_number);

    GolfSimConfiguration::SetConstant(
        "gs_config.calibration.kAutoCalibrationBallPositionFromCamera" + camera_number_string +
        "Meters",
        kAutoCalibrationBallPositionFromCameraMeters);

    GolfSimConfiguration::SetConstant("gs_config.calibration.kNumberPicturesForFocalLengthAverage",
                                      kNumberPicturesForFocalLengthAverage);

    return true;
}

double GolfSimCamera::DetermineFocalLengthForAutoCalibration(const cv::Mat &color_image,
                                                             const GolfSimCamera &camera)
{
    ...
    // The search mode depends on the camera we are calibrating.  The camera2
    // pictures will be more like that
    // of typical strobed (ball in flight) pictures.
    // TBD - Still not sure this is the best mode?  Seems like kStrobed is best
    // for camera 2 calibration
    BallImageProc::BallSearchMode search_mode = (camera.camera_hardware_.camera_number_ ==
                                                 1) ?
                                                BallImageProc::BallSearchMode::kFindPlacedBall :
                                                BallImageProc::BallSearchMode::kStrobed;
    ...
    {
        GS_LOG_MSG(error,
                   "GetBall() failed to get a ball.  Consider setting  --show_images=1  in order to determine why no ball was found.");
        return -1.0;
    }

    ball = return_balls[0];

    // Because we are auto-calibrating, we know the exact distance from the ball
    // to the lens
    double distance_direct_to_ball =
        CvUtils::GetDistance(kAutoCalibrationBallPositionFromCameraMeters);

    if (distance_direct_to_ball <= 0.0001)
    {
        LoggingTools::Warning(
            "DetermineFocalLengthForAutoCalibration called without setting the kAutoCalibrationBallPositionFromCameraMeters values.");
        return -1.0;
    }
    ...
    {
        GS_LOG_MSG(error,
                   "DetermineFocalLengthForAutoCalibration() failed to get a ball with a non-zero radius.");
        return -1.0;
    }

    double calibrated_focal_length = computeFocalDistanceFromBallData(camera,
                                                                      measured_radius_pixels,
                                                                      distance_direct_to_ball);
    GS_LOG_MSG(info,
               "Calibrated focal length for distance " + std::to_string(distance_direct_to_ball) +
               " and Radius: " + std::to_string(measured_radius_pixels) +
               " mm is " + std::to_string(calibrated_focal_length) + ".");

    return calibrated_focal_length;
}

bool GolfSimCamera::DetermineCameraAngles(const cv::Mat &color_image,
                                          const GolfSimCamera &camera,
                                          cv::Vec2d &camera_angles)
{
    ...
    // toward
    // the ball flight plane.
    // The Z-distance in this scenario would measure as if the image plane is
    // orthogonal to the camera's
    // bore.  The image plane would only actually go through the ball's center
    // if the
    ...
    {
        GS_LOG_MSG(error,
                   "DetermineCameraAngles called without kAutoCalibrationBallPositionFromCameraMeters constants being set.");
        return false;
    }

    // We have the direct-to-ball-PLANE distance - it is already in real-world
    // meters.
    // However, we do not have the exact direct-to-ball distance due to the fact
    // the lens will slightly
    // enlarge objects that are actually further away the camera.

    // Use the direct-to-ball-plane distance as the direct-to-ball distance to
    // calculate the offset of the ball from center.
    double xDistanceFromCamCenter = convertXDistanceToMeters(camera,
                                                             distance_direct_to_ball,
                                                             xFromCameraCenter);
    camera_perspective_distances[0] = xDistanceFromCamCenter;          // X distance,
    ...
    GS_LOG_TRACE_MSG(trace,
                     "GolfSimCamera::DetermineCameraAngles computed camera_perspective_distances of: "
                     +
                     std::to_string(camera_perspective_distances[0]) + ", " +
                     std::to_string(camera_perspective_distances[1]));

    // Determine the angles from the center-bore of the camera at which the ball
    // exists to the ball

    // Angles in this section are taken using a ray that extends out from the
    // camera
    // Positive X angle is counter-clockwise looking down on the camera/ball
    // from above
    // Positive Y angle is looking up from level to the ball
    double x_angle_degrees_of_ball_camera_perspective =
        -CvUtils::RadiansToDegrees(atan(camera_perspective_distances[0] / distance_direct_to_ball));
    double y_angle_degrees_of_ball_camera_perspective =
        CvUtils::RadiansToDegrees(atan(camera_perspective_distances[1] / distance_direct_to_ball));

    GS_LOG_TRACE_MSG(trace,
                     "GolfSimCamera::DetermineCameraAngles computed angles to ball from center-bore of camera of: "
                     +
                     std::to_string(x_angle_degrees_of_ball_camera_perspective) + ", " +
                     std::to_string(y_angle_degrees_of_ball_camera_perspective));

    // Determine the angles at which the camera would be if the ball were
    // centered (in other
    // words, the angle of the ball from the center of the lens if the camera
    // was
    // pointing straight out).

    double x_angle_degrees_of_ball_lm_perspective =
        -CvUtils::RadiansToDegrees(atan(kAutoCalibrationBallPositionFromCameraMeters[0] /
                                        kAutoCalibrationBallPositionFromCameraMeters[2]));

    // Need to calculate the adjacent (tan x = opposite/adjacent) distance by
    // using the known x and z distances) to determine the y angle
    double horizontal_distance_to_ball_vertical_axis =
        sqrt(pow(kAutoCalibrationBallPositionFromCameraMeters[0],
                 2) + pow(kAutoCalibrationBallPositionFromCameraMeters[2], 2));
    double y_angle_degrees_of_ball_lm_perspective =
        CvUtils::RadiansToDegrees(atan(kAutoCalibrationBallPositionFromCameraMeters[1] /
                                       horizontal_distance_to_ball_vertical_axis));

    GS_LOG_TRACE_MSG(trace,
                     "GolfSimCamera::DetermineCameraAngles computed angles to ball from the perspective of the LM (from the center of the camera lens if the camera was pointing straight out): "
                     +
    ...
    camera_angles[0] = x_angle_degrees_of_ball_lm_perspective -
                       x_angle_degrees_of_ball_camera_perspective;
    camera_angles[1] = y_angle_degrees_of_ball_lm_perspective -
                       y_angle_degrees_of_ball_camera_perspective;

    GS_LOG_TRACE_MSG(trace,
                     "GolfSimCamera::DetermineCameraAngles computed angles to the camera of: " +
...
bool GolfSimCamera::AutoCalibrateCamera(GsCameraNumber camera_number)
{
    GS_LOG_TRACE_MSG(trace,
                     "AutoCalibrateCamera called with camera number = " +
                     std::to_string(camera_number));
    ...
    // We will need a camera for context
    const CameraHardware::CameraModel camera_model = (camera_number ==
                                                      GsCameraNumber::kGsCamera1) ?
                                                     GolfSimCamera::kSystemSlot1CameraType :
                                                     GolfSimCamera::kSystemSlot2CameraType;
    GS_LOG_TRACE_MSG(trace,
                     "AutoCalibrateCamera called with camera model = " +
                     std::to_string(camera_model));
    GolfSimCamera camera;
    // Use the default focal length for the camera, as the focal length is one
    // parameter
    ...
    // Now that we have the correct angles, determine the focal length

    double average_focal_length = 0.0;
#ifdef __unix__
    // In the "real" Pi environment, the focal length computation can vary from
    // image to image,
...
#else
    // It's the same canned picture in the non-Pi environment, so no need to do
    // averaging
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Expected (x,y,z) distances to ball: " +
                     LoggingTools::FormatVec3f(kAutoCalibrationBallPositionFromCameraMeters));
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Expected distance_direct_to_ball is: " +
                     std::to_string(distance_direct_to_ball));

    // Because we know the exact distance to the ball, the expected radius
    // ranges
    // should be pretty tight
    double expectedRadius = getExpectedBallRadiusPixels(camera.camera_hardware_,
                                                        camera.camera_hardware_.resolution_x_,
                                                        distance_direct_to_ball);

    // The problem with calculating the min/max ball radii using a
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Min/Max expected ball radii are: " + std::to_string(ip->min_ball_radius_) +
                     " / " + std::to_string(ip->max_ball_radius_));

    GS_LOG_TRACE_MSG(trace,
                     "Determining focal length for auto-calibration. Will average " +
                     std::to_string(number_attempts) + " samples.");

    // Focal length can be touchy because of small changes in the perceived
    // radius of the ball due to small changes in, for example, lighting
    ...
    for (int i = 0; i < number_attempts; i++)
    {
        ...
        LoggingTools::LogImage("",
                               ...
                               std::vector < cv::Point >{},
                               true,
                               "Focal_Length_Autocalibration_Input_Image_" + std::to_string(i) +
                               ".png");

        // This code will take the place of determining the angles by hand
        // measurements
        // At this point, we don't know at what angles the camera we're
        // calibrating is oriented.
        // We cannot determine this without determining the focal length, so do
        // that first and
        // then use is to determine the angles.

        double focal_length = DetermineFocalLengthForAutoCalibration(color_image, camera);

        if (focal_length < 0.0)
        {
            GS_LOG_MSG(error, "Could not DetermineFocalLengthForAutoCalibration.");
            return false;
        }

        // The intermediate image is useful to see if the circles are being
        // identified accurately
        LoggingTools::LogImage("",
                               ip->final_result_image_,
                               std::vector < cv::Point >{},
                               true,
                               "Focal_Length_Autocalibration_Results_Image_" + std::to_string(i) +
                               ".png");

        number_samples++;

        average_focal_length += focal_length;
        std::string calibration_results_message = "Next Sampled Focal Length = " +
    ...
    GS_LOG_MSG(info,
               ...
               ". Will set this value into the gs_config.json file.");

    // Re-set the camera_hardware object's focal length to reflect the
    // real-world focal length we just determined.
    ...
    LoggingTools::LogImage("",
                           ...
                           std::vector < cv::Point >{},
                           true,
                           "Base Autocalibration Image.png");

    // Also reset the expected radius numbers based on the (hopefully improved)
    // focal length
    expectedRadius = getExpectedBallRadiusPixels(camera.camera_hardware_,
                                                 color_image.cols,
                                                 distance_direct_to_ball);
    ...
    // Use the last-taken image to determine at what angle the ball is to the
    // bore-line of the camera's center
    ...
    std::string focal_length_tag_name = "gs_config.cameras.kCamera" + camera_number_string +
                                        "FocalLength";
    std::string camera_angles_tag_name = "gs_config.cameras.kCamera" + camera_number_string +
                                         "Angles";
    ...
    std::string config_file_name = "PiTrac_config.json";
    ...
    // Add only to the tail of the file name to ensure that any prefixed path
    // will remain valid
    std::string backup_json_file_name = config_file_name + "_BACKUP_" +
                                        LoggingTools::GetUniqueLogName() + ".json";

    GS_LOG_TRACE_MSG(info,
                     "Saving current PiTrac_config.json file to filename = " +
                     backup_json_file_name);
    ...
    {
        GS_LOG_TRACE_MSG(trace,
                         "system(cp_command) failed. Could not backup existing PiTrac_config.json file.  Exiting");
        return false;
    }
