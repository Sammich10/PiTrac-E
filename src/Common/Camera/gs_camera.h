...
class GolfSimCamera
{
  public:
    ...
    static bool ComputeBallDeltas(GolfBall &ball1,
                                  GolfBall &ball2,
    ...
    static bool ComputeSingleBallXYZOrthoCamPerspective(const GolfSimCamera &camera,
    ...
    static void CalculateBallSpinRates(GolfBall &b,
    ...
    int GetMostCenteredBallIndex(const std::vector<GolfBall> &balls,
    ...
    static std::vector<cv::Scalar> GetBallHSVRange(const cv::Scalar &ball_color_RGB);
    ...
    static double computeFocalDistanceFromBallData(const GolfSimCamera &camera,
    ...
    // axes
    static bool ComputeXyzDeltaDistances(const GolfBall &b1,
                                         const GolfBall &b2,
    ...
    static bool ComputeXyzDistanceFromOrthoCamPerspective(const GolfSimCamera &camera,
                                                          const GolfBall &b1,
    ...
    static double convertXDistanceToMeters(const GolfSimCamera &camera,
                                           double zDistanceMeters,
                                           double xDistancePixels);
    static double convertYDistanceToMeters(const GolfSimCamera &camera,
                                           double zDistanceMeters,
    ...
    double GetPerpendicularDistanceFromLine(double x,
                                            double y,
                                            double x1,
                                            double y1,
                                            double x2,
    ...
    void RemoveTooSmallOrBigBalls(std::vector<GolfBall> &initial_balls,
    ...
    static bool CleanExternalStrobeArtifacts(const cv::Mat &image,
                                             cv::Mat &output_image,
    ...
    static bool DetermineCameraAngles(const cv::Mat &color_image,
    ...
    static double DetermineFocalLengthForAutoCalibration(const cv::Mat &color_image,
                                                         const GolfSimCamera &camera);
  ...
  private:
    ...
    // function is called
    static int getExpectedBallRadiusPixels(const CameraHardware &camera_hardware,
    ...
    // the real world
    static double ComputeDistanceToBallUsingRadius(const GolfSimCamera &camera,
                                                   const GolfBall &ball);
};
}
