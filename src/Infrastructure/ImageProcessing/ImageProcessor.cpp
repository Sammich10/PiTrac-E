...
namespace PiTrac {
    ...
    cv::RotatedRect BallImageProc::FindBestEllipseFornaciari(cv::Mat& img, const cv::Vec3f& reference_ball_circle, int mask_radius) {
    ...
    cv::RotatedRect BallImageProc::FindLargestEllipse(cv::Mat& img, const cv::Vec3f& reference_ball_circle, int mask_radius) {
    ...
    void BallImageProc::RemoveReflections(const cv::Mat& original_image, cv::Mat& filtered_image, const cv::Mat& mask) {
        ...
        // cv::Scalar lower = ((uchar)brightness_cutoff, (uchar)brightness_cutoff, (uchar)brightness_cutoff);
        cv::Scalar lower = ((uchar)kReflectionMinimumRGBValue, (uchar)kReflectionMinimumRGBValue, (uchar)kReflectionMinimumRGBValue);
    ...
    cv::Mat BallImageProc::ReduceReflections(const cv::Mat& img, const cv::Mat& mask) {
        ...
        cv::Scalar lower{ kReflectionMinimumRGBValue,kReflectionMinimumRGBValue,kReflectionMinimumRGBValue };
        cv::Scalar upper{ 255,255,255 };
