...
#include "Common/Utils/Logging/logging_tools.h"
#include "Common/GolfSim/Options/gs_config.h"
#include "Common/GolfSim/Options/gs_options.h"
#include "Application/GolfSim/UI/gs_ui_options.h"

// Image processor
#include "Infrastructure/ImageProcessing/ImageProcessor.h"

// Our utility functions
#include "Common/Utils/CVUtils/cv_utils.h"

// Ellipse detection
#include "Infrastructure/ImageProcessing/EllipseDetectorCommon.h"
#include "Infrastructure/ImageProcessing/EllipseDetectorYaed.h"

// Edge detection
#include "Infrastructure/ImageProcessing/EdgeDrawing/ED.h"
#include "Infrastructure/ImageProcessing/EdgeDrawing/EDPF.h"
#include "Infrastructure/ImageProcessing/EdgeDrawing/EDColor.h"

namespace PiTrac
{
// Currently, equalizing the brightness of the input images appears to help the
// results
    #define GS_USING_IMAGE_EQ

const int MIN_BALL_CANDIDATE_RADIUS = 10;

// Balls with an average color that is too far from the searched-for color will
// not be considered
// good candidates.The tolerance is based on a Euclidian distance. See
// differenceRGB in CvUtils module.
// The tolerance is relative to the closest - in - RGB - value candidate.So if
// the "best" candidate ball is,
// for example, 100 away from the expected color, than any balls with a RGB
...
const bool IS_COLOR_MASKING = false;       // Probably not effective on IR
                                           // pictures
...
BallImageProc::BallImageProc()
{
    ...
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseXRotationDegreesIncrement",
                                      kCoarseXRotationDegreesIncrement);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseXRotationDegreesStart",
                                      kCoarseXRotationDegreesStart);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseXRotationDegreesEnd",
                                      kCoarseXRotationDegreesEnd);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseYRotationDegreesIncrement",
                                      kCoarseYRotationDegreesIncrement);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseYRotationDegreesStart",
                                      kCoarseYRotationDegreesStart);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseYRotationDegreesEnd",
                                      kCoarseYRotationDegreesEnd);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseZRotationDegreesIncrement",
                                      kCoarseZRotationDegreesIncrement);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseZRotationDegreesStart",
                                      kCoarseZRotationDegreesStart);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kCoarseZRotationDegreesEnd",
                                      kCoarseZRotationDegreesEnd);

    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kGaborMinWhitePercent",
                                      kGaborMinWhitePercent);
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kGaborMaxWhitePercent",
                                      kGaborMaxWhitePercent);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallCannyLower",
                                      kPlacedBallCannyLower);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallCannyUpper",
                                      kPlacedBallCannyUpper);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallStartingParam2",
                                      kPlacedBallStartingParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallMinParam2",
                                      kPlacedBallMinParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallMaxParam2",
                                      kPlacedBallMaxParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallCurrentParam1",
                                      kPlacedBallCurrentParam1);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallParam2Increment",
                                      kPlacedBallParam2Increment);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedMinHoughReturnCircles",
                                      kPlacedMinHoughReturnCircles);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedMaxHoughReturnCircles",
                                      kPlacedMaxHoughReturnCircles);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsCannyLower",
                                      kStrobedBallsCannyLower);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsCannyUpper",
                                      kStrobedBallsCannyUpper);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsPreCannyBlurSize",
                                      kStrobedBallsPreCannyBlurSize);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsPreHoughBlurSize",
                                      kStrobedBallsPreHoughBlurSize);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsStartingParam2",
                                      kStrobedBallsStartingParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsMinParam2",
                                      kStrobedBallsMinParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsMaxParam2",
                                      kStrobedBallsMaxParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsCurrentParam1",
                                      kStrobedBallsCurrentParam1);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsParam2Increment",
                                      kStrobedBallsParam2Increment);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedBallsMinHoughReturnCircles",
        kStrobedBallsMinHoughReturnCircles);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedBallsMaxHoughReturnCircles",
        kStrobedBallsMaxHoughReturnCircles);

    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedBallsUseAltHoughAlgorithm",
        kStrobedBallsUseAltHoughAlgorithm);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsAltCannyLower",
                                      kStrobedBallsAltCannyLower);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsAltCannyUpper",
                                      kStrobedBallsAltCannyUpper);

    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedBallsAltPreCannyBlurSize",
        kStrobedBallsAltPreCannyBlurSize);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedBallsAltPreHoughBlurSize",
        kStrobedBallsAltPreHoughBlurSize);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedBallsAltStartingParam2",
        kStrobedBallsAltStartingParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsAltMinParam2",
                                      kStrobedBallsAltMinParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsAltMaxParam2",
                                      kStrobedBallsAltMaxParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsAltCurrentParam1",
                                      kStrobedBallsAltCurrentParam1);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsAltHoughDpParam1",
                                      kStrobedBallsAltHoughDpParam1);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedBallsAltParam2Increment",
        kStrobedBallsAltParam2Increment);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kUseCLAHEProcessing",
                                      kUseCLAHEProcessing);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kCLAHEClipLimit",
                                      kCLAHEClipLimit);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kCLAHETilesGridSize",
                                      kCLAHETilesGridSize);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingBallStartingParam2",
                                      kPuttingBallStartingParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingBallMinParam2",
                                      kPuttingBallMinParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingBallMaxParam2",
                                      kPuttingBallMaxParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingBallCurrentParam1",
                                      kPuttingBallCurrentParam1);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingBallParam2Increment",
                                      kPuttingBallParam2Increment);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingMinHoughReturnCircles",
                                      kPuttingMinHoughReturnCircles);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingMaxHoughReturnCircles",
                                      kPuttingMaxHoughReturnCircles);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingHoughDpParam1",
                                      kPuttingHoughDpParam1);

    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvCurrentParam1",
                                      kExternallyStrobedEnvCurrentParam1);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvMaxParam2",
                                      kExternallyStrobedEnvMaxParam2);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvStartingParam2",
                                      kExternallyStrobedEnvStartingParam2);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvNarrowingParam2",
                                      kExternallyStrobedEnvNarrowingParam2);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvNarrowingDpParam",
                                      kExternallyStrobedEnvNarrowingDpParam);
    GolfSimConfiguration::SetConstant(
        "gs_config.testing.kExternallyStrobedEnvNarrowingPreCannyBlurSize",
        kExternallyStrobedEnvNarrowingPreCannyBlurSize);
    GolfSimConfiguration::SetConstant(
        "gs_config.testing.kExternallyStrobedEnvNarrowingPreHoughBlurSize",
        kExternallyStrobedEnvNarrowingPreHoughBlurSize);

    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvParam2Increment",
                                      kExternallyStrobedEnvParam2Increment);
    GolfSimConfiguration::SetConstant(
        "gs_config.testing.kExternallyStrobedEnvMinHoughReturnCircles",
        kExternallyStrobedEnvMinHoughReturnCircles);
    GolfSimConfiguration::SetConstant(
        "gs_config.testing.kExternallyStrobedEnvMaxHoughReturnCircles",
        kExternallyStrobedEnvMaxHoughReturnCircles);
    ...
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedBestCircleCannyLower",
                                      kExternallyStrobedBestCircleCannyLower);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedBestCircleCannyUpper",
                                      kExternallyStrobedBestCircleCannyUpper);
    GolfSimConfiguration::SetConstant(
        "gs_config.testing.kExternallyStrobedBestCirclePreCannyBlurSize",
        kExternallyStrobedBestCirclePreCannyBlurSize);
    GolfSimConfiguration::SetConstant(
        "gs_config.testing.kExternallyStrobedBestCirclePreHoughBlurSize",
        kExternallyStrobedBestCirclePreHoughBlurSize);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedBestCircleParam1",
                                      kExternallyStrobedBestCircleParam1);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedBestCircleParam2",
                                      kExternallyStrobedBestCircleParam2);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedBestCircleHoughDpParam1",
                                      kExternallyStrobedBestCircleHoughDpParam1);

    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedUseCLAHEProcessing",
                                      kExternallyStrobedUseCLAHEProcessing);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedCLAHEClipLimit",
                                      kExternallyStrobedCLAHEClipLimit);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedCLAHETilesGridSize",
                                      kExternallyStrobedCLAHETilesGridSize);

    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvHoughDpParam1",
                                      kExternallyStrobedEnvHoughDpParam1);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvMaximumSearchRadius",
                                      kExternallyStrobedEnvMaximumSearchRadius);
    GolfSimConfiguration::SetConstant("gs_config.testing.kExternallyStrobedEnvMinimumSearchRadius",
                                      kExternallyStrobedEnvMinimumSearchRadius);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedPreHoughBlurSize",
                                      kPlacedPreHoughBlurSize);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedPreCannyBlurSize",
                                      kPlacedPreCannyBlurSize);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsPreHoughBlurSize",
                                      kStrobedBallsPreHoughBlurSize);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPuttingPreHoughBlurSize",
                                      kPuttingPreHoughBlurSize);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedBallHoughDpParam1",
                                      kPlacedBallHoughDpParam1);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedBallsHoughDpParam1",
                                      kStrobedBallsHoughDpParam1);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kUseBestCircleRefinement",
                                      kUseBestCircleRefinement);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kUseBestCircleLargestCircle",
                                      kUseBestCircleLargestCircle);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kBestCircleCannyLower",
                                      kBestCircleCannyLower);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kBestCircleCannyUpper",
                                      kBestCircleCannyUpper);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kBestCirclePreCannyBlurSize",
                                      kBestCirclePreCannyBlurSize);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kBestCirclePreHoughBlurSize",
                                      kBestCirclePreHoughBlurSize);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kBestCircleParam1",
                                      kBestCircleParam1);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kBestCircleParam2",
                                      kBestCircleParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kBestCircleHoughDpParam1",
                                      kBestCircleHoughDpParam1);

    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kBestCircleIdentificationMinRadiusRatio",
        kBestCircleIdentificationMinRadiusRatio);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kBestCircleIdentificationMaxRadiusRatio",
        kBestCircleIdentificationMaxRadiusRatio);


    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kUseDynamicRadiiAdjustment",
                                      kUseDynamicRadiiAdjustment);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kNumberRadiiToAverageForDynamicAdjustment",
        kNumberRadiiToAverageForDynamicAdjustment);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedNarrowingRadiiMinRatio",
        kStrobedNarrowingRadiiMinRatio);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kStrobedNarrowingRadiiMaxRatio",
        kStrobedNarrowingRadiiMaxRatio);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedNarrowingRadiiDpParam",
                                      kStrobedNarrowingRadiiDpParam);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kStrobedNarrowingRadiiParam2",
                                      kStrobedNarrowingRadiiParam2);

    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedNarrowingRadiiMinRatio",
                                      kPlacedNarrowingRadiiMinRatio);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedNarrowingRadiiMaxRatio",
                                      kPlacedNarrowingRadiiMaxRatio);
    GolfSimConfiguration::SetConstant(
        "gs_config.ball_identification.kPlacedNarrowingStartingParam2",
        kPlacedNarrowingStartingParam2);
    GolfSimConfiguration::SetConstant("gs_config.ball_identification.kPlacedNarrowingRadiiDpParam",
                                      kPlacedNarrowingRadiiDpParam);


    GolfSimConfiguration::SetConstant("gs_config.logging.kLogIntermediateSpinImagesToFile",
                                      kLogIntermediateSpinImagesToFile);
}
                                            ...
                                            BallSearchMode search_mode)
{
    ...
    {
        GS_LOG_MSG(error,
                   "PreProcessStrobedImage called with no image to work with (search_image)");
        return false;
    }

    // setup CLAHE processing dependent on PiTrac-only strobing or
    // externally-strobed
    ...
    if (use_clahe_processing)
    {
        ...
        GS_LOG_TRACE_MSG(trace,
                         "Using CLAHE Pre-processing with GridSize = " +
                         std::to_string(clahe_tiles_grid_size) +
        ...
        LoggingTools::DebugShowImage(image_name_ +
                                     "  Strobed Ball Image - After CLAHE equalization",
                                     search_image);
    }
    ...
    // The size for the blur must be odd - force it up in value by 1 if
    // necessary
    ...
    GS_LOG_MSG(trace,
               "Main HoughCircle Image Prep - Performing Pre-Hough Blur and Canny for kStrobed mode.");
    GS_LOG_MSG(trace,
               "  Blur Parameters are: pre_canny_blur_size = " +
               std::to_string(pre_canny_blur_size) +
    ...
    if (pre_canny_blur_size > 0)
    {
        cv::GaussianBlur(search_image, search_image, cv::Size(pre_canny_blur_size,
    ...
    for (int i = 0; i < 0; i++)
    {
        cv::erode(search_image,
                  search_image,
                  cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3,
                                                                     3)),
                  cv::Point(-1, -1),
                  3);
        cv::dilate(search_image,
                   search_image,
                   cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3,
                                                                      3)),
                   cv::Point(-1, -1),
    ...
    LoggingTools::DebugShowImage(image_name_ + "  Strobed Ball Image - Ready for Edge Detection",
                                 search_image);

    cv::Mat cannyOutput_for_balls;
    if (search_mode == kExternallyStrobed && pre_canny_blur_size == 0)
    {
        // Don't do the Canny at all if the blur size is zero and we're in
        // comparison mode
    ...
    // Blur the lines-only image back to the search_image that the code below
    // uses
    cv::GaussianBlur(cannyOutput_for_balls, search_image, cv::Size(pre_hough_blur_size,
                                                                   pre_hough_blur_size), 0);                            // Nominal
                                                                                                                        // is
                                                                                                                        // 7x7
...
// Should be much more successful if called with a calibrated golf ball so that
// the code has
...
{
    GS_LOG_TRACE_MSG(trace,
                     "GetBall called with PREBLUR_IMAGE = " + std::to_string(PREBLUR_IMAGE) +
                     " IS_COLOR_MASKING = " +
                     std::to_string(IS_COLOR_MASKING) + " FINAL_BLUR = " +
                     std::to_string(FINAL_BLUR) + " search_mode = " + std::to_string(search_mode));
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Looking for a ball with color{ " +
                     LoggingTools::FormatGsColorTriplet(baseBallWithSearchParams.average_color_));
    ...
    if (PREBLUR_IMAGE)
    {
        cv::GaussianBlur(rgbImg, blurImg, cv::Size(7, 7), 0);      // nominal
                                                                   // was 11x11
    ...
    // Note - We want to UNDER-colorMask if anything.Just get rid of stuff that
    // is
    ...
    {
        GS_LOG_MSG(error,
                   "GetBall called with a 1-channel (grayscale?) image.  Expecting 3 channel RGB");
        return false;
    }

    // We will create our own colorMask if we don't have one already
    // We will not do anything with the areaMask(other than to apply it further
    // below if it exists)
    ...
    // LoggingTools::DebugShowImage(image_name_ + "  cv::GaussianBlur(...)
    // hsvImage", hsvImage);
    // LoggingTools::DebugShowImage(image_name_ + "  color_mask_image_",
    // color_mask_image_);

    // Perform a Hough conversion to identify circles or near-circles

    // Convert the blurred version of the original image to required gray-scale
    // for Hough Transform circle detection
    cv::Mat grayImage;
    cv::cvtColor(blurImg, grayImage, cv::COLOR_BGR2GRAY);

    // LoggingTools::DebugShowImage(image_name_ + "  gray image (as well as the
    // result if no colorMasking)", grayImage);
    ...
    if (IS_COLOR_MASKING)
    {
        ...
        LoggingTools::DebugShowImage(image_name_ + "  colorMasked image (search_image)",
                                     search_image);
    }
    else
    {
    ...
    LoggingTools::DebugShowImage(image_name_ + "  Final color AND area-masked image (search_image)",
                                 search_image);

    switch (search_mode)
    {
        case kFindPlacedBall: {
            cv::GaussianBlur(search_image, search_image, cv::Size(kPlacedPreCannyBlurSize,
                                                                  kPlacedPreCannyBlurSize), 0);
            ...
            LoggingTools::DebugShowImage(image_name_ +
                                         "  Placed Ball Image - Ready for Edge Detection",
                                         search_image);
             ...
             */
            cv::Mat cannyOutput_for_balls;
            cv::Canny(search_image,
                      cannyOutput_for_balls,
                      kPlacedBallCannyLower,
                      kPlacedBallCannyUpper);

            LoggingTools::DebugShowImage(image_name_ + "  cannyOutput_for_balls",
                                         cannyOutput_for_balls);

            // Blur the lines-only image back to the search_image that the code
            // below uses
            cv::GaussianBlur(cannyOutput_for_balls,
                             search_image,
                             cv::Size(kPlacedPreHoughBlurSize,
                                      kPlacedPreHoughBlurSize),
                             0);                                                                                                         // Nominal
                                                                                                                                         // is
                                                                                                                                         // 7x7
        ...
        case kExternallyStrobed: {
            // Attempt to remove the lines of the golf-shaft in an
            // externally-strobed environment.
            // Sadly, this is better accomplished by simply putting IR-black
            // felt over the shaft.
            ...
            if (GolfSimCamera::kExternallyStrobedEnvFilterImage)
            {
                ...
                {
                    GS_LOG_MSG(warning,
                               "ProcessReceivedCam2Image - failed to CleanExternalStrobeArtifacts.");
                }

                LoggingTools::DebugShowImage(image_name_ + "After CleanExternalStrobeArtifacts",
                                             search_image);
            }
        ...
        case kPutting: {
            ...
            LoggingTools::DebugShowImage(image_name_ + "  Putting Image - Ready for Edge Detection",
                                         search_image);
            ...
            cv::GaussianBlur(search_image, search_image, cv::Size(5, 5), 0);       // Nominal
                                                                                   // is
                                                                                   // 7x7
    ...
    LoggingTools::DebugShowImage(image_name_ +
                                 "  FINAL blurred/eroded/dilated Putting search_image for Hough Transform{ ",
                                 search_image);

    if (GolfSimOptions::GetCommandLineOptions().artifact_save_level_ !=
        ArtifactSaveLevel::kNoArtifacts)
    {
        // TBD - REMOVE - Not really  useful any more
        // LoggingTools::LogImage("", search_image, std::vector < cv::Point >{},
        // true, "log_view_final_search_image_for_Hough.png");
    }

    // Apply hough transform on the image - NOTE - param2 is critical to balance
    // between over - and under - identification
    // works            circles = cv::HoughCircles(img_blur, cv::HOUGH_GRADIENT,
    // 1, minDist = 50, param1 = 200, param2 = 25, minRadius = 10, maxRadius =
    // 50)
    // should be image_blur, not search_image ?

    // Param 1 will set the sensitivity; how strong the edges of the circles
    // need to be.Too high and it won't detect anything, too low and it
    // will find too much clutter.Param 2 will set how many edge points it needs
    // to find to declare that it's found a circle. Again, too high
    ...
    // We will start with a best-guess transform parameter.If that results in
    // one circle, great.And we're done.
    // If we get more than one circle, tighten the parameter so see if we can
    // get just one.If not, we'll sort through the
    // circles further below.But if we don't get any circles with the starting
    // point, loosen the parameter up to see if we
    ...
    // This is only small for when we are REALLY sure of where the ball is, like
    // during calibration
    ...
    // If we are in strobed mode, allow for circles that are overlapping and of
    // lower quality, etc.

    double minimum_distance;

    double currentParam1;        // nominal is 200.  Touchy - higher values
                                 // sometimes do not work - CURRENT = 100
    double param2_increment;
    double currentDp;

    // Otherwise,if highly-certain we will find just one ball, crank the
    // requirements to prevent false positives, otherwise, relax them
    switch (search_mode)
    {
        case kFindPlacedBall:
        {
            ...
            currentParam1 = kPlacedBallCurrentParam1;        // nominal is 200.
                                                             //  Touchy - higher
                                                             // values sometimes
                                                             // do not work -
                                                             // CURRENT = 100
            ...
            // In the expected image, there should be only one candidate
            // anywhere near the ball
            minimum_distance = (double)minimum_search_radius * 0.5;

            currentDp = kPlacedBallHoughDpParam1;             // Must be between
                                                              // 0 and 2
                                                              // (double).Nominal
                                                              // is 2, CURRENT =
                                                              // 1.2
        ...
        case kStrobed:
        {
            ...
            starting_param2 =
                use_alt ? kStrobedBallsAltStartingParam2 : kStrobedBallsStartingParam2;
            ...
            // In the strobed image, there may be overlapping balls. so the
            // search distance should be small

            // The lower the value, the sloppier the found circles can be.  But
            // crank it up too far and
            // we don't pick up overlapped circles.
            currentParam1 = use_alt ? kStrobedBallsAltCurrentParam1 : kStrobedBallsCurrentParam1;
            // Don't want to get too crazy loose too fast in order to find more
            // balls
            param2_increment =
                use_alt ? kStrobedBallsAltParam2Increment : kStrobedBallsParam2Increment;

            minimum_distance = minimum_search_radius * .3;     // 0.18f;  // TBD
                                                               // - Parameterize
                                                               // this!
            ...
            currentDp = use_alt ? kStrobedBallsAltHoughDpParam1 : kStrobedBallsHoughDpParam1;             // Must
                                                                                                          // be
                                                                                                          // between
                                                                                                          // 0
                                                                                                          // and
        ...
        case kExternallyStrobed:
        {
            ...
            /** TBD - REMOVE?  Any reason to have this mode's own radius
             * parameters?
        ...
        case kPutting:
        {
            ...
            currentDp = kPuttingHoughDpParam1;             // Must be between 0
                                                           // and 2
                                                           // (double).Nominal
                                                           // is 2, CURRENT =
                                                           // 1.2
    ...
    // HoughCircles() is expensive - use it only in the region of interest if we
    // have an ROI
        ...
        expectedBallArea.br().x != 0 || expectedBallArea.br().y != 0)
    {
        ...
        final_search_image = CvUtils::GetSubImage(search_image,
                                                  expectedBallArea,
                                                  offset_sub_to_full,
                                                  offset_full_to_sub);
    }
    ...
    {
        // Do nothing if we don't have a sub-image.  Any later offsets will be
        // 0, so will do nothing
        final_search_image = search_image;
    }

    // LoggingTools::DebugShowImage(image_name_ + "  Final sub-image
    // search_image for Hough Transform{ ", final_search_image);
    // LoggingTools::LogImage("", final_search_image, std::vector < cv::Point
    // >{}, true, "log_view_final_sub_image_for_Hough.png");
    ...
    if (search_mode == kStrobed || search_mode == kExternallyStrobed ||
        search_mode == kFindPlacedBall)
    {
        if (kUseDynamicRadiiAdjustment && search_mode != kFindPlacedBall)
        {
            ...
            // For some reason, odd maximum_search_radius values were resulting
            // in bad circle identification
            // These are the wider-ranging radii to make sure we find the ball,
            // however near/far it may be
            ...
            GS_LOG_TRACE_MSG(trace,
                             "Executing INITIAL houghCircles (to determine narrowed ball diameters) with currentDP = "
                             + std::to_string(narrowing_dp_param) +
                             ", minDist = " + std::to_string(minimum_distance) + ", param1 = " +
                             std::to_string(currentParam1) +
                             ", param2 = " + std::to_string(narrowing_radii_param2) +
                             ", minRadius = " + std::to_string(int(minimum_search_radius)) +
                             ", maxRadius = " + std::to_string(int(maximum_search_radius)));

            // TBD - May want to adjust min / max radius
            // NOTE - Param 1 may be sensitive as well - needs to be 100 for
            // large pictures ?
            // TBD - Need to set minDist to rows / 8, roughly ?
            // The _ALT mode seems to work best for this purpose
            std::vector<cv::Vec3f> test_circles;
...

            {
                ...
                if (test_circles.size() == 0)
                {
                    if (report_find_failures)
                    {
                        GS_LOG_TRACE_MSG(warning,
                                         "Initial (narrowing) Hough Transform found 0 balls.");
                    }
                    return false;
                }
                ...
                for (auto &c : test_circles)
                {
                    ...
                    LoggingTools::DrawCircleOutlineAndCenter(test_hough_output,
                                                             c,
                                                             std::to_string(i),
                                                             i,
                                                             (i > kMaxCirclesToEmphasize));
                }
                LoggingTools::DebugShowImage("Initial (for narrowing) Hough-identified Circles",
                                             test_hough_output);
                GS_LOG_TRACE_MSG(trace,
                                 "Narrowing Hough found the following circles: {     " +
                                 LoggingTools::FormatCircleList(test_circles));
            }

            const int number_balls_to_average = std::min(kNumberRadiiToAverageForDynamicAdjustment,
                                                         (int)test_circles.size());
            double average = 0.0;
             ...
             * if (kUseDynamicRadiiAdjustment && (search_mode ==
             * kFindPlacedBall)) {
             *  // If we're using dynamic radii adjustment, we'd like to look at
             * potentially several circles in a tight area
             *  minimum_distance = 1;
             * }
             */

            GS_LOG_TRACE_MSG(trace,
                             "Dynamically narrowing search radii to { " +
                             std::to_string(minimum_search_radius) +
                             ", " + std::to_string(maximum_search_radius) + " } pixels.");
        }
    }

    // Adaptive algorithm to dynamically adjust the (very touchy) Hough circle
    // parameters depending on how things are going
    while (!done)
    {
        minimum_search_radius = CvUtils::RoundAndMakeEven(minimum_search_radius);
        maximum_search_radius = CvUtils::RoundAndMakeEven(maximum_search_radius);
        ...
        GS_LOG_TRACE_MSG(trace,
                         "Executing houghCircles with currentDP = " + std::to_string(currentDp) +
                         ", minDist = " + std::to_string(minimum_distance) + ", param1 = " +
                         std::to_string(currentParam1) +
                         ", param2 = " + std::to_string(currentParam2) + ", minRadius = " +
                         std::to_string(int(minimum_search_radius)) +
                         ", maxRadius = " + std::to_string(int(maximum_search_radius)));

        // TBD - May want to adjust min / max radius
        // NOTE - Param 1 may be sensitive as well - needs to be 100 for large
        // pictures ?
        // TBD - Need to set minDist to rows / 8, roughly ?
        std::vector<cv::Vec3f> test_circles;
        cv::HoughCircles(final_search_image,
                         ...
                         hough_mode,
                         currentDp,
                         /* minDist = */ minimum_distance, // Does this really
                                                           // matter if we are
                                                           // only looking for
                                                           // one circle ?
        ...
        if (!circles.empty())
        {
            priorNumCircles = (int)round(circles.size());           // round
                                                                    // just to
                                                                    // make sure
                                                                    // we get an
                                                                    // int -
        ...
        if (numCircles >= min_circles_to_return_from_hough &&
            numCircles <= max_circles_to_return_from_hough)
        {
        ...
        if (numCircles > max_circles_to_return_from_hough)
        {
            ...
            // // Hopefully, we can either further tighten the transform to
            // reduce the number of candidates,
            // of else we've been broadening and the prior attempt gave 0
            // circles but now we have too many (more than 1)
            // (but at least we have SOME circles instead of 0 now)
            GS_LOG_TRACE_MSG(trace,
                             "Found more circles than desired (" + std::to_string(numCircles) +
                             " circles).");

            if ((priorNumCircles == 0) && (currentParam2 != starting_param2))
            {
                // We have too many circles now, and we had no circles before.So
                // this is as good as we can do, at least
            ...
            // We had too many balls before, and we still do now. So, see if we
            // can tighten up our Hough transform
            if (currentParam2 >= max_param2)
            {
                // We've tightened things as much as we want to, but still have
                // too many possible balls
                // We'll try to sort them out later
                GS_LOG_TRACE_MSG(trace,
                                 "Could not narrow number of balls to just 1.  Produced " +
                                 std::to_string(numCircles) + " balls.");

                // Save what we have now because maybe it's as good as things
                // get
                circles.assign(test_circles.begin(), test_circles.end());
                finalNumberOfFoundCircles = numCircles;
                done = true;
            ...
            {
                // Next time we might not get any circles, so save what we have
                // now
                circles.assign(test_circles.begin(), test_circles.end());
        ...
        else
        {
            ...
            // Hopefully we either can further loosen the transform to find
            // more, or we can't *BUT* we found some in the earlier attempt
            // Two possible conditions here -
            //   1 - either we have been progressively tightening(increasing)
            // currentParam2 and we went too far and now
            //       we have zero potential balls; OR
            //   2 - we started not finding ANY balls, kept
            // loosening(decreasing) currentParam2, but we still failed
            if (numCircles == 0 && priorNumCircles == 0)
            {
                // We have no circles now, and we had no circles before.So we
                // never found any.
                // In this case, keep trying to broaden if we can, otherwise, we
                // fail
                if (currentParam2 <= min_param2)
                {
                    // We've loosened things as much as we want to, but still
                    // haven't identified a single ball
                    if (report_find_failures)
                    {
            ...
            else if (((numCircles > 0 && numCircles < min_circles_to_return_from_hough) &&
                      priorNumCircles == 0) ||
                     (currentlyLooseningSearch == true))
            {
                // We found SOME circles, but not as many as we'd like, and we
                // had no circles previously.
                // So, continue to broaden the search parameters to try to get
                // more if we can

                // Loosen up our seach parameters to see if we can get some more
                // circles
                if (currentParam2 <= min_param2)
                {
                    // We've loosened things as much as we want to, but still
                    ...
                    // Save what we have now because it's as good as things are
                    // going to get
                    circles.assign(test_circles.begin(), test_circles.end());
                    finalNumberOfFoundCircles = numCircles;
                    done = true;
                ...
                else
                {
                    currentParam2 -= param2_increment;
                    currentlyLooseningSearch = true;
                    // Save what we have now because maybe it's as good as
                    // things get
                    circles.assign(test_circles.begin(), test_circles.end());
                    done = false;
                }
            ...
            {
                // We had some circles previously, but we presumably went too
                // far in terms of tightening and now we have none
                // Return the prior set of balls(which was apparently more than
                // 1)
                GS_LOG_TRACE_MSG(trace,
                                 "Could only narrow down to " + std::to_string(numCircles) +
                                 " balls");
                finalNumberOfFoundCircles = numCircles;
                done = true;
            }
    ...
    // Create a list of the circles with their corresponding criteria for quick
    // sorting
    ...
    if (finalNumberOfFoundCircles > 0)
    {
        ...
        cv::Scalar expectedBallRGBAverage;
        cv::Scalar expectedBallRGBMedian;
        cv::Scalar expectedBallRGBStd;

        if (baseBallWithSearchParams.average_color_ != cv::Scalar(0, 0, 0))
        {
        ...
        {
            // We don't have an expected ball color, so determine how close the
            // candidate
            // is to the center of the masking color range
            expectedBallRGBAverage = baseBallWithSearchParams.GetRGBCenterFromHSVRange();
            expectedBallRGBMedian = expectedBallRGBAverage;      // We don't
                                                                 // have
                                                                 // anything
                                                                 // better
        ...
        GS_LOG_TRACE_MSG(trace,
                         "Center of expected ball color (BGR){ " +
                         LoggingTools::FormatGsColorTriplet(expectedBallRGBAverage));
        GS_LOG_TRACE_MSG(trace,
                         "Expected ball median = " +
                         LoggingTools::FormatGsColorTriplet(expectedBallRGBMedian) + " STD{ " +
                         LoggingTools::FormatGsColorTriplet(expectedBallRGBStd));
        ...
        for (auto &c : circles)
        {
            ...
            LoggingTools::DrawCircleOutlineAndCenter(candidates_image_, c, std::to_string(i), i,
                                                     (i > kMaxCirclesToEmphasize));
            ...
            if (found_radius >= MIN_BALL_CANDIDATE_RADIUS)
            {
                ...
                // Putting currently uses ball colors to weed out balls that are
                // formed from the noise of the putting green.
                if (expectedBallColorExists || search_mode == kPutting)
                {
                    // Only deal with color if we will be comparing colors
                    std::vector<cv::Scalar> stats = CvUtils::GetBallColorRgb(rgbImg, c);
                    avg_RGB = { stats[0] };
                    medianRGB = { stats[1] };
                    stdRGB = { stats[2] };
                    ...
                    GS_LOG_TRACE_MSG(trace,
                                     "Circle of above-minimum radius " +
                                     std::to_string(MIN_BALL_CANDIDATE_RADIUS) +
                                     " pixels. Average RGB is{ " +
                                     LoggingTools::FormatGsColorTriplet(avg_RGB)
                                     + ". Average HSV is{ " +
                                     LoggingTools::FormatGsColorTriplet(CvUtils::ConvertRgbToHsv(
                                                                            avg_RGB)));

                    // Determine how "different" the average color is from the
                    // expected ball color
                    // If we don't have an expected ball color, than we use the
                    // RGB center from the
                    // current mask
                    ...
                    // Even if a potential ball has a really close median color,
                    // if the STD is even a little off, we want to down - grade
                    // it
                    // The following works to mix the three statistics together
                    // appropriately
                    // Will also penalize balls that are found toward the tail
                    // end of the list
                    ...
                    // + (float)(125. * pow(i, 4.));
                    // NOTE - if the flash-times are different for the ball we
                    // are using for the color, this is likely to pick the wrong
                    // thing.
                    calculated_color_difference = pow(rgb_avg_diff,
                                                      2) + (float)(20. * pow(rgb_std_diff,
                                                                             2.)) +
                                                  (float)(200. * pow(10 * i, 3.));

                    /* GS_LOG_TRACE_MSG(trace, "Found circle number " +
                     * std::to_string(i) + " radius = " +
                     * std::to_string(found_radius) +
                     *  " rgb_avg_diff = " + std::to_string(rgb_avg_diff) +
                     *  " CALCDiff = " +
                     * std::to_string(calculated_color_difference) + " rgbDiff =
                     * " + std::to_string(rgb_avg_diff) +
            ...
            {
                GS_LOG_TRACE_MSG(trace,
                                 "Skipping too-small circle of radius = " + std::to_string(c[2]));
            }
        }

        LoggingTools::DebugShowImage(image_name_ + "  Hough-only-identified Circles{",
                                     candidates_image_);
    }
    else
    {
    ...
    // Determine the average color of a rectangle within each circle, and see
    // which is
    // closest to the color we were expecting(e.g., white)

    // GS_LOG_TRACE_MSG(trace, "Pre-sorted circle list{ " +
    // FormatCircleCandidateList(foundCircleList));

    if (search_mode != BallSearchMode::kStrobed && expectedBallColorExists)
    {
        // Sort by the difference between the found ball's color and the
        // expected oolor
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Sorted circle list{     " + FormatCircleCandidateList(foundCircleList));

    // Only proceed if at least one circle was found
    // The hough transfer will have returned the "best" circle first(TBD -
    // Confirm)
    // we will still do some post - processing to get rid of anything that looks
    // unreasonable,
    ...
    if ((search_mode == BallSearchMode::kStrobed) && expectedBallColorExists)
    {
        // Remove any balls whose RGB difference is too great, and then re -
        // sort based on radius and
        // return the biggest radius ball.
        struct CircleCandidateListElement &firstCircleElement = foundCircleList.front();
        float maxRGBDistance = (float)(firstCircleElement.calculated_color_difference +
                                       CANDIDATE_BALL_COLOR_TOLERANCE);
        ...
        GS_LOG_TRACE_MSG(trace,
                         "Candidates after removing color mismatches{     " +
                         FormatCircleCandidateList(candidates));

        // Sort by radius, largest first, and copy the list to the
        // finalCandidates
        ...
        std::copy(std::begin(candidates), std::end(candidates),
                  std::back_inserter(finalCandidates));
    }
    else
    {
        // If we didn't find a ball with the expected color, then the final
        // candidates are just whatever the
        // interim candidates were
        std::copy(std::begin(foundCircleList), std::end(foundCircleList),
                  std::back_inserter(finalCandidates));
    }
    ...
    cv::Vec3f bestCircle = finalCandidates.front().circle;
    ...
    {
        // We have one or more (possibly sketchy) initial ball candidates.
        //  Create a ball and setup its color information
        // so that we can (if desired) use that information to further isolate
        // the ball before we calculate the final
        // x, y, and radius information.  The color mask to get rid of stuff
        // that is 'obviously' not the golf ball
        GolfBall b;

        // TBD - refactor so that the x & y are set from the circle for the ball
        // instead of having to keep separate
        ...
        LoggingTools::DrawCircleOutlineAndCenter(initial_ball_candidates_image_,
                                                 c.circle,
                                                 std::to_string(index),
                                                 index,
                                                 (index > kMaxCirclesToEmphasize));

        index++;
    }

#ifdef PERFORM_FINAL_TARGETTED_BALL_ID   // NOTE - This will currently return
                                         // only a SINGLE ball, not all the
                                         // candidates

    cv::Vec3f finalCircle;
    ...
    cv::Vec3f finalCircle = bestCircle;

#endif

    // Take the refined (hopefully more precise) circle for the "best" ball and
    // assign that information to
    // update the ball.

    final_result_image_ = rgbImg.clone();
    LoggingTools::DrawCircleOutlineAndCenter(final_result_image_, finalCircle, "Ball");

    // LoggingTools::DebugShowImage(image_name_ + "  Resulting Circle on image",
    // final_result_image_);
    ...
    std::vector<cv::Scalar> stats = CvUtils::GetBallColorRgb(rgbImg, finalCircle);
    best_ball.ball_color_ = GolfBall::BallColor::kCalibrated;
    best_ball.average_color_ = stats[0];      // Average RGB
    best_ball.radius_at_calibration_pixels_ =
        baseBallWithSearchParams.radius_at_calibration_pixels_;
                                        ...
                                        cv::Vec3f &final_circle)
{
    ...
    // We are pretty sure we got the correct ball, or at least something really
    // close.
    // Now, try to find the best circle within the area around the candidate
    // ball to see
    // if we can get a more precise position and radius.
    // Current theory is to NOT use any color masking in order to make this as
    // precise
    // as possible(since we are already looking for a really narrow area and
    // radii)

    const cv::Vec3f &reference_ball_circle = reference_ball.ball_circle_;
    ...
    GS_LOG_TRACE_MSG(trace,
                     "DetermineBestCircle using reference_ball_circle with radius = " +
                     std::to_string(ballRadius) +
                     ".  (X,Y) center = (" + std::to_string(circleX) + "," +
                     std::to_string(circleY) + ")");
    ...
    // If the ball is near the screen edge, reduce the width or height
    // accordingly.
    ...
    cv::Mat finalChoiceSubImg = CvUtils::GetSubImage(gray_image,
                                                     ball_ROI_rect,
                                                     offset_sub_to_full,
                                                     offset_full_to_sub);

    // LoggingTools::DebugShowImage("DetermineBestCircle - finalChoiceSubImg",
    // finalChoiceSubImg);
    ...
    for (int i = 0; i < 0; i++)
    {
        cv::erode(finalChoiceSubImg,
                  finalChoiceSubImg,
                  cv::getStructuringElement(cv::MORPH_RECT,
                                            cv::Size(3, 3)),
                  cv::Point(-1, -1),
                  3);
        cv::dilate(finalChoiceSubImg,
                   finalChoiceSubImg,
                   cv::getStructuringElement(cv::MORPH_RECT,
                                             cv::Size(3, 3)),
                   cv::Point(-1, -1),
    ...
    LoggingTools::DebugShowImage("Best Circle" + std::to_string(expandedRadiusForHough) +
                                 "  BestBall Image - Ready for Edge Detection",
                                 finalChoiceSubImg);
    ...
    {
        // We're using the same image preparation as for a single, placed ball
        // for now -
        // TBD - Ensure that's the best approach - Current turned off (see 0 at
        // end)
        cv::GaussianBlur(finalChoiceSubImg,
                         finalChoiceSubImg,
                         cv::Size(kBestCirclePreCannyBlurSize,
                                  kBestCirclePreCannyBlurSize),
                         0);

        cv::Canny(finalChoiceSubImg,
                  cannyOutput_for_balls,
                  kBestCircleCannyLower,
                  kBestCircleCannyUpper);

        LoggingTools::DebugShowImage("Best Circle (Non-externally-strobed)" +
                                     std::to_string(expandedRadiusForHough) +
                                     "  cannyOutput for best ball",
                                     cannyOutput_for_balls);

        // Blur the lines-only image back to the search_image that the code
        // below uses
        cv::GaussianBlur(cannyOutput_for_balls, finalChoiceSubImg,
                         cv::Size(kBestCirclePreHoughBlurSize,
                                  kBestCirclePreHoughBlurSize), 0);                                                                              // Nominal
                                                                                                                                                 // is
                                                                                                                                                 // 7x7
    }
    else
    {
        // cv::GaussianBlur(finalChoiceSubImg, finalChoiceSubImg,
        // cv::Size(kExternallyStrobedBestCirclePreCannyBlurSize,
        // kExternallyStrobedBestCirclePreCannyBlurSize), 0);

        // cv::Canny(finalChoiceSubImg, cannyOutput_for_balls,
        // kExternallyStrobedBestCircleCannyLower,
        // kExternallyStrobedBestCircleCannyUpper);
        cannyOutput_for_balls = finalChoiceSubImg.clone();

        LoggingTools::DebugShowImage("Best Circle (externally-strobed)" +
                                     std::to_string(expandedRadiusForHough) +
                                     "  cannyOutput for best ball",
                                     cannyOutput_for_balls);
        ...
        // below uses
        cv::GaussianBlur(cannyOutput_for_balls, finalChoiceSubImg,
                         cv::Size(kExternallyStrobedBestCirclePreHoughBlurSize,
                                  kExternallyStrobedBestCirclePreHoughBlurSize), 0);                                                                                               // Nominal
                                                                                                                                                                                   // is
                                                                                                                                                                                   // 7x7
    }
    /***** THIS WAS PERFORMING POORLY - TBD - Probably remove
     * cv::GaussianBlur(finalChoiceSubImg, finalChoiceSubImg, cv::Size(7, 7),
     * 0);   // Nominal is 7x7
     *
     *
     * for (int i = 0; i < 0; i++) {
     *  cv::erode(finalChoiceSubImg, finalChoiceSubImg,
     * cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)), cv::Point(-1,
     * -1), 2);
     *  cv::dilate(finalChoiceSubImg, finalChoiceSubImg,
     * cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)), cv::Point(-1,
     * -1), 2);
     * }
     *
     * LoggingTools::DebugShowImage("DetermineBestCircle Image After
     * Morphology", finalChoiceSubImg);
     */
    double currentParam1 =
        is_externally_strobed ? kExternallyStrobedBestCircleParam1 : kBestCircleParam1;
    double currentParam2 =
        is_externally_strobed ? kExternallyStrobedBestCircleParam2 : kBestCircleParam2;                         // TBD
                                                                                                                // -
                                                                                                                // was
                                                                                                                // 25
    double currentDp =
        is_externally_strobed ? kExternallyStrobedBestCircleHoughDpParam1 :
        kBestCircleHoughDpParam1;                                                                                         // TBD
                                                                                                                          // -
                                                                                                                          // was
                                                                                                                          // 1.3?

    // TBD - Increase?  We want to be able to find several circles really close
    // to one another
    int minimum_inter_ball_distance = 20;     // has to be at least 1  .  Larger
                                              // than 1 effectively turns off
                                              // multiple balls

    LoggingTools::DebugShowImage("FINAL Best Circle image" +
                                 std::to_string(expandedRadiusForHough) +
                                 "  finalChoiceSubImg for best ball",
                                 finalChoiceSubImg);

    GS_LOG_MSG(info,
               "DetermineBestCircle - Executing houghCircles with currentDP = " +
               std::to_string(currentDp) +
               ", minDist (1) = " + std::to_string(minimum_inter_ball_distance) + ", param1 = " +
               std::to_string(currentParam1) +
               ", param2 = " + std::to_string(currentParam2) + ", minRadius = " +
               std::to_string(int(min_ball_radius)) +
               ", maxRadius = " + std::to_string(int(max_ball_radius)));

    std::vector<cv::Vec3f> finalTargetedCircles;
    ...
    {
        GS_LOG_TRACE_MSG(trace,
                         "Hough FOUND " + std::to_string(finalTargetedCircles.size()) +
                         " targeted circles.");
    }
    else
    {
        GS_LOG_TRACE_MSG(trace,
                         "Could not find any circles after performing targeted  Hough Transform");
        // TBD - WAIT - Worst case, we need to at least return the #1 ball that
        // we found from the original Hough search
        return false;
    }
    ...
    // Show the final group of candidates.  They should all be centered around
    // the correct ball
    ...
    for (auto &c : finalTargetedCircles)
    {
        ...
        double found_radius = c[2];        // Why were we rounding??? TBD =
                                           // std::round(c[2]);
        GS_LOG_TRACE_MSG(trace,
                         "Found targeted circle with radius = " + std::to_string(found_radius) +
                         ".  (X,Y) center = (" + std::to_string(c[0]) + "," + std::to_string(c[1]) +
                         ")");
        if (i <= MaxFinalCandidateBallsToAverage)
        {
            LoggingTools::DrawCircleOutlineAndCenter(targetedCandidatesImage,
                                                     c,
                                                     std::to_string(i),
                                                     i);
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Average Radius was: " + std::to_string(averageRadius) + ". Average (X,Y) = "
                     + std::to_string(averageX) + ", " + std::to_string(averageY) + ").");

    LoggingTools::DebugShowImage("DetermineBestCircle Hough-identified Targeted Circles{",
                                 targetedCandidatesImage);
    // LoggingTools::LogImage("", targetedCandidatesImage, std::vector <
    // cv::Point >{}, true, "log_view_targetted_circles.png");

    // Assume that the first ball will be the highest - quality match
    // Set to false if we want (instead) to use the largeet radius.  For some
    // elliptical
...
cv::RotatedRect BallImageProc::FindBestEllipseFornaciari(cv::Mat &img,
                                                         ...
                                                         int mask_radius)
{
    ...
    cv::Rect ball_ROI_rect{ (int)(circleX - expandedRadiusForCanny),
                            (int)(circleY - expandedRadiusForCanny),
                            (int)(2. * expandedRadiusForCanny),
                            (int)(2. * expandedRadiusForCanny) };

    cv::Point offset_sub_to_full;
    cv::Point offset_full_to_sub;

    cv::Mat processedImg = CvUtils::GetSubImage(img,
                                                ball_ROI_rect,
                                                offset_sub_to_full,
                                                offset_full_to_sub);

    LoggingTools::DebugShowImage(
        " BallImageProc::FindLargestEllipse_fornaciari - Original (SUB) input image for final choices",
        processedImg);

    // TBD - worth it before Canny?
    // Try to remove the noise around the ball
    // TBD - This can be made better than it is.  Possibly more iterations,
     ...
     * LoggingTools::DebugShowImage("
     * BallImageProc::FindLargestEllipse_fornaciari - sharpened image",
     * processedImg);
     ***/

    cv::GaussianBlur(processedImg, processedImg, cv::Size(3, 3), 0);      // nominal
                                                                          // was
                                                                          // 11x11
    cv::erode(processedImg,
              processedImg,
              cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)),
              cv::Point(-1, -1),
              2);
    cv::dilate(processedImg,
               processedImg,
               cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)),
               cv::Point(-1, -1),
               2);
    ...
    LoggingTools::DebugShowImage(
        " BallImageProc::FindLargestEllipse_fornaciari - blurred/eroded/dilated image",
        processedImg);
    ...
    // LoggingTools::DebugShowImage("
    // BallImageProc::FindLargestEllipse_fornaciari - equalized, processed final
    // image", processedImg);
#endif
    ...
    int iNs = 16;
    float fMaxCenterDistance = sqrt(float(sz.width * sz.width + sz.height * sz.height)) *
                               fTaoCenters;
    ...
    Size szPreProcessingGaussKernelSize = Size(5, 5);           // Nominal is 5,
                                                                // 5
    double dPreProcessingGaussSigma = 1.0;

    float fDistanceToEllipseContour = 0.1f;         // (Sect. 3.3.1 -
                                                    // Validation)
    float fMinReliability = 0.4f;       // Const parameters to discard bad
                                        // ellipses
    ...
    // Look at as many ellipses as we need to in order to find the best (highest
    // ranked) ellipse that is reasonable
    // given the ball that we are looking for
    for (auto &es : ellipses)
    {
        Ellipse ellipseStruct = es;
        RotatedRect e(Point(cvRound(es._xc), cvRound(es._yc)),
                      Size(cvRound(2.0 * es._a), cvRound(2.0 * es._b)),
                      (float)(es._rad * 180.0 / CV_PI));

        cv::Scalar color = cv::Scalar(rng.uniform(0, 256), rng.uniform(0, 256),
                                      rng.uniform(0, 256));

        // Note - All ellipses will be in the coordinate system of the FULL
        // image, not the sub-image

        // Translate the ellipse to the full image coordinates for comparison
        // with the expected position of the ball
        ...
        {
            GS_LOG_TRACE_MSG(trace,
                             "Found and REJECTED ellipse, x,y = " + std::to_string(xc) + "," +
                             std::to_string(yc) + " rw,rh = " + std::to_string(a) + "," +
                             std::to_string(b) + " rectArea = " + std::to_string(a * b) +
                             " theta = " + std::to_string(theta) + " aspectRatio = " +
                             std::to_string(aspectRatio) + "(REJECTED)");
            GS_LOG_TRACE_MSG(trace,
                             "     Expected max found ball radius was = " +
                             std::to_string(ballRadius / 1.5) + ", min area: " +
                             std::to_string(pow(ballRadius,
                                                2.0)) + ", max area: " +
                             std::to_string(5 * pow(ballRadius,
                                                    2.0))
            ...
            {
                GS_LOG_TRACE_MSG(trace,
                                 "Too many ellipses to draw (skipping no. " +
                                 std::to_string(numDrawn) + ").");
            }
            else
            {
        ...
        {
            GS_LOG_TRACE_MSG(trace,
                             "Found ellipse, x,y = " + std::to_string(xc) + "," +
                             std::to_string(yc) + " rw,rh = " + std::to_string(a) + "," +
                             std::to_string(b) + " rectArea = " + std::to_string(a * b));
            ...
            if (area > largestArea)
            {
                ...
                // break;  // If we're only going to take the first (best) fit -
                // TBD - this often breaks stuff!
            }
        }
    }

    LoggingTools::DebugShowImage("BallImageProc::FindBestEllipseFornaciari - Ellipses(" +
                                 std::to_string(numEllipses) + "):",
                                 ellipseImg);
...
cv::RotatedRect BallImageProc::FindLargestEllipse(cv::Mat &img,
                                                  const cv::Vec3f &reference_ball_circle,
                                                  int mask_radius)
{
    LoggingTools::DebugShowImage(
        " BallImageProc::FindLargestEllipse - input image for final choices",
        img);
    ...
    cv::Mat finalChoiceSubImg = CvUtils::GetSubImage(img,
                                                     ball_ROI_rect,
                                                     offset_sub_to_full,
                                                     offset_full_to_sub);
    bool edgeDetectionFailed = false;
    ...
    LoggingTools::DebugShowImage(
        " BallImageProc::FindLargestEllipse - after erode/dilate of grayscale:",
        finalChoiceSubImg);
    ...
    while (!edgeDetectDone)
    {
        cv::Canny(finalChoiceSubImg, cannyOutput, lowThresh, highThresh);      // <--
                                                                               ...
                                                                               // -
                                                                               // TBD
        // Remove the contour lines that develop at the edge of the mask - they
        // are just artifacts, not real, also
        // try to get rid of some of the noise that should be clearly outside
        // the ball
        cv::circle(cannyOutput,
                   cv::Point(circleX, circleY) + offset_full_to_sub,
                   mask_radius,
                   cv::Scalar{ 0, 0, 0 },
                   (int)((double)ballRadius / 12.0));
        // Also remove the inner part of the ball, at least to the extent we can
        // safely write that area off
        cv::circle(cannyOutput,
                   cv::Point(circleX,
                             circleY) + offset_full_to_sub,
                   (int)(ballRadius * 0.7),
                   cv::Scalar{ 0, 0, 0 },
                   cv::FILLED);

        // LoggingTools::DebugShowImage(image_name_ + "  Current Canny
        // SubImage:", cannyOutput);
        ...
        GS_LOG_TRACE_MSG(trace,
                         "Ball circle finalization - Canny edges at tolerance (low,high)= " +
                         std::to_string(lowThresh) + ", " + std::to_string(highThresh) +
                         "): mean: " + std::to_string(mean) + "std : " + std::to_string(stddev));

        // Adjust to get more/less edge lines depending on how busy (percentage
        // white) the image currently is
    ...
    RemoveLinearNoise(cannyOutput);       // This has been problematic because
                                          // it can rip up an otherwise good
                                          // circle
    ...
    {
        cv::dilate(cannyOutput, cannyOutput, cv::getStructuringElement(cv::MORPH_RECT,
                                                                       cv::Size(3, 3)),
                   cv::Point(-1,
                             -1), 2);
        cv::erode(cannyOutput,
                  cannyOutput,
                  cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)),
                  cv::Point(-1, -1),
                  2);
    }
    LoggingTools::DebugShowImage("BallImageProc::FindLargestEllipse - Dilated/eroded Canny:",
                                 cannyOutput);

    std::vector<std::vector<cv::Point> > contours;
    std::vector<cv::Vec4i> hierarchy;
    cv::findContours(cannyOutput,
                     contours,
                     hierarchy,
                     cv::RETR_CCOMP,
    ...
    for (size_t i = 0; i < contours.size(); i++)
    {
        ...
        if (contours[i].size() > 25)
        {
            ...
            // Translate the ellipse to the full image coordinates for
            // comparison with the expected position of the ball
                ...
                (!CvUtils::IsUprightRect(theta) && false))
            {
                GS_LOG_TRACE_MSG(trace,
                                 ...
                                 std::to_string(yc) + " rw,rh = " + std::to_string(a) + "," +
                                 std::to_string(b) + " rectArea = " + std::to_string(a * b) +
                                 " theta = " + std::to_string(theta) + "(REJECTED)");
    ...
    LoggingTools::DebugShowImage("BallImageProc::FindLargestEllipse - Ellipses(" +
                                 std::to_string(numEllipses) + "):", ellipseImg);

    return largestEllipse;
}

// Not working very well yet.  May want to try instead some closing/opening or
// convex hull model
bool BallImageProc::RemoveLinearNoise(cv::Mat &img)
{
    LoggingTools::DebugShowImage(
        " BallImageProc::FindLargestEllipse - before removing horizontal/vertical lines",
        img);

#ifndef USING_HORIZ_VERT_REMOVAL

#else
    // Get rid of strongly horizontal and vertical lines, given that the ball
    // should not be affected much
    int minLineLength = std::max(2, img.cols / 25);
    cv::Mat horizontalKernel = cv::getStructuringElement(cv::MORPH_RECT,
                                                         cv::Size(minLineLength, 1));
    cv::Mat verticalKernel = cv::getStructuringElement(cv::MORPH_RECT, cv::Size(1, minLineLength));
    // cv::morphologyEx(cannyOutput, cannyOutput, cv::MORPH_ERODE,
    // horizontal_kernel, cv::Point(-1, -1), 2);
    // TBD - shouldn't have to XOR the images, should be able to remove the
    // lines in-place?
    ...
    LoggingTools::DebugShowImage(" BallImageProc::FindLargestEllipse - horizontal lines to filter",
                                 horizontalLinesImg);
    LoggingTools::DebugShowImage(" BallImageProc::FindLargestEllipse - vertical lines to filter",
                                 verticalLinesImg);
    cv::bitwise_xor(img, horizontalLinesImg, img);
    cv::bitwise_xor(img, verticalLinesImg, img);

    LoggingTools::DebugShowImage(
        " BallImageProc::FindLargestEllipse - after removing horizontal/vertical lines",
        img);
#endif
    return true;
}

// Returns a mask with 1 bits wherever the corresponding pixel is OUTSIDE the
// upper/lower HSV range
...
{
    cv::Scalar lowerHsv = input_lowerHsv;
    cv::Scalar upperHsv = input_upperHsv;

    // TBD - Straighten out double versus uchar/int here

    for (int i = 0; i < 3; i++)
    {
        lowerHsv[i] -= kColorMaskWideningAmount;       // (int)std::round(((double)lowerHsv[i]
                                                       // * kColorMaskWideningRatio));
        upperHsv[i] += kColorMaskWideningAmount;       //(int)std::round(((double)upperHsv[i]
                                                       // * kColorMaskWideningRatio));
    }
    ...
    // Because we are creating a binary mask, it should be CV_8U or CV_8S (TBD -
    // I think?)
    ...
    // We will need TWO masks if the hue range crosses over the 180 - degreee
    // "loop" point for reddist colors
    ...
    {
        // 'First' and 'Second' refer to the Hsv triplets that will be used for
        // he first and second masks
        ...
        if (lowerHsv[0] < 0)
        {
            ...
            leftMostUpperHsv = cv::Vec3f((float)upperHsv[0], (float)upperHsv[1],
                                         (float)upperHsv[2]);
            rightMostLowerHsv = cv::Vec3f((float)CvUtils::kOpenCvHueMax + (float)lowerHsv[0],
                                          (float)lowerHsv[1],
                                          (float)lowerHsv[2]);
            rightMostUpperHsv = cv::Vec3f((float)CvUtils::kOpenCvHueMax,
                                          (float)upperHsv[1],
                                          (float)upperHsv[2]);
        }
        else
        {
            ...
            leftMostLowerHsv = cv::Vec3f(0.f, (float)lowerHsv[1], (float)lowerHsv[2]);
            leftMostUpperHsv = cv::Vec3f((float)upperHsv[0] - 180.f,
                                         (float)upperHsv[1],
                                         (float)upperHsv[2]);
            rightMostLowerHsv = cv::Vec3f((float)lowerHsv[0], (float)lowerHsv[1],
                                          (float)lowerHsv[2]);
            rightMostUpperHsv = cv::Vec3f((float)CvUtils::kOpenCvHueMax,
                                          (float)upperHsv[1],
                                          (float)upperHsv[2]);
        ...
        //GS_LOG_TRACE_MSG(trace, "leftMost Lower/Upper HSV{ " +
        // LoggingTools::FormatVec3f(leftMostLowerHsv) + ", " +
        // LoggingTools::FormatVec3f(leftMostUpperHsv) + ".");
        //GS_LOG_TRACE_MSG(trace, "righttMost Lower/Upper HSV{ " +
        // LoggingTools::FormatVec3f(rightMostLowerHsv) + ", " +
        // LoggingTools::FormatVec3f(rightMostUpperHsv) + ".");
        ...
        //LoggingTools::DebugShowImage(image_name_ + "  firstColorMaskImage",
        // firstColorMaskImage);
        //LoggingTools::DebugShowImage(image_name_ + "  secondColorMaskImage",
        // secondColorMaskImage);

        cv::bitwise_or(firstColorMaskImage, secondColorMaskImage, color_mask_image_);
    }

    //LoggingTools::DebugShowImage("BallImagProc::GetColorMaskImage returning
    // color_mask_image_", color_mask_image_);
...
cv::Mat BallImageProc::GetColorMaskImage(const cv::Mat &hsvImage,
                                         const GolfBall &ball,
                                         double widening_amount)
{
    cv::Scalar lowerHsv = ball.GetBallLowerHSV(ball.ball_color_);
    cv::Scalar upperHsv = ball.GetBallUpperHSV(ball.ball_color_);
...
{
    // std::locale::global(std::locale("es_CO.UTF-8"));   // Try to get comma
    // for thousands separators - doesn't work?  TBD

    auto f =
        GS_FORMATLIB_FORMAT(
            "[{: <7}: {: <18} cd={: <15.2f} fr={: <4d} av={: <10} ad={: <9.1f} md={: <9.1f}    sd={: <9.1f}]",
            e.name,
...
std::string BallImageProc::FormatCircleCandidateList(
    const std::vector<struct CircleCandidateListElement> &candidates)
{
    std::string s =
...
void BallImageProc::RoundCircleData(std::vector<cv::Vec3f> &circles)
{
    for (auto &c : circles)
    {
        // TBD - original was causing a compile problem?  Maybe just use regular
        // around? nc::around(circles, 0);
        c[0] = std::round(c[0]);
        c[1] = std::round(c[1]);
        c[2] = std::round(c[2]);
    }
...
{
    // The area of interest is right in front (ball-fly direction) of the ball.
    //  Anything in
    // the ball or behind it could just be lighting changes or the human teeing
    // up.
    int x = (int)ball.ball_circle_[0];
    int y = (int)ball.ball_circle_[1];
    int r = (int)ball.ball_circle_[2];

    // The 1.1 just makes sure we are mostely outside of where the ball
    // currently is
...
bool BallImageProc::WaitForBallMovement(GolfSimCamera &c,
                                        ...
                                        const long waitTimeSecs)
{
    ...
    //min area of motion detectable - based on ball radius, should be at least
    // as large as a third of a ball
    int min_area = (int)pow(ball.ball_circle_[2], 2.0);     // Rougly a third of
                                                            // the ball size
    ...
    while (!foundMotion)
    {
        ...
        // We will skip a few frames first for everything stabilize (TBD - is
        // this necessary?)
        ...
        // We don't want to look at changes in the image just anywhere, instead
        // narrow down to the
        ...
        // WAS ORIGINALLY - cv::GaussianBlur(gray, gray, cv::Size(21, 21), 0,
        // 0);
        // A 7x7 kernel is plenty of blurring for our purpose (of removing
        // transient spikes).
        // It is almost twice as fast as a larger 21x21 kernel!
        cv::GaussianBlur(gray, gray, cv::Size(7, 7), 0, 0);

        //initialize first frame if necessary and don't do any comparison yet
        // (as we only have one frame)
        if (firstFrame.empty())
        {
        ...
        // Maintain a circular file of recent images so that we can, e.g.,
        // perform club face analysis
        // TBD
        //
        ...
        cv::threshold(imageDifference, thresh, kThreshLevel, 255.0, cv::THRESH_BINARY );      //  |
                                                                                              // cv::THRESH_OTSU);
        // GS_LOG_TRACE_MSG(trace, "Otsu Threshold Value was:" +
        // std::to_string(t));
        ...
        for (size_t i = 0; i < contours.size(); i++)
        {
            ...
            /* Only use if the original ball will be included in the area of
             * interest
             * // Quick way to test for rectangle inclusion
             * if ((boundRect & ballRect) == boundRect) {
             *  // Ignore any changes where the ball is - it could just be a
             * lighting change
             *  continue;
             * }
             */
        ...
        // If we didn't find at least one substantial change in the area of
        // interest, keep waiting
        if (!atLeastOneLargeAreaOfChange || (totalAreaOfDeltas < min_area))
        {
            //GS_LOG_TRACE_MSG(trace, "Didn't find any substantial changes
            // between frames");
            continue;
        }
...
{
    /******  I found out the images are not distributed as a normal
     * distribution, so this doesn't work
     * cv::Scalar meanArray;
     * cv::Scalar stdDevArray;
     ...
     * double stddev = stdDevArray.val[0];
     *
     * double zScore = sqrt(2) *
     * boost::math::erf_inv((double)brightness_percentage / 100.0);
     *
     * brightness_cutoff = (int)std::round(mean + ((stddev) * zScore));
     * if (brightness_cutoff > 255) {
     *  brightness_cutoff = 255;
     *  LoggingTools::Warning("brightness_cutoff was > 255.
     *  brightness_percentage (" + std::to_string(brightness_percentage) + ")
     * may be set too high ? ");
     * }
     */
...
bool BallImageProc::RemoveSmallestConcentricCircles(std::vector<cv::Vec3f> &circles)
{
    // Remove any concentric (nested) circles that share the same center but
    // have different radii
    // TBD - this shouldn't occur, but the HOUGH_ALT_GRADIENT mode does not seem
    ...
    {
        cv::Vec3f &circle_current = circles[i];

        for (int j = (int)circles.size() - 1; j > i; j--)
        {
            cv::Vec3f &circle_other = circles[j];
            ...
            if (CvUtils::CircleXY(circle_current) == CvUtils::CircleXY(circle_other))
            {
                ...
                else
                {
                    ...
                    // NOTE - i could go negative for a moment before it's
                    // incremented
                    // above.  That's why we are using an int
                    i--;

                    // There should only be one concentric pair, so we can move
                    // onto the next
                    // outer loop circle.  If there are more pairs, we will deal
                    // with that on
                    // a later loop
                    break;
                }
...
const int kReflectionMinimumRGBValue = 245;      // Nominal is 235.  TBD - Not
                                                 // used - remove?

void BallImageProc::RemoveReflections(const cv::Mat &original_image,
                                      ...
                                      const cv::Mat &mask)
{
    ...
    // LoggingTools::DebugShowImage("RemoveReflections - input img# " +
    // std::to_string(imgNumber) + " = ", original_image);
    // LoggingTools::DebugShowImage("filtered_image - input img# " +
    // std::to_string(imgNumber) + " = ", filtered_image);
    imgNumber++;

    // LoggingTools::DebugShowImage("RemoveReflections - mask = ", mask);

    // Define the idea of a "bright" relfection dynamically.  The reflection
    // brightness will be in the
    // xx% percentile (e.g., above 98%)
    // Dynamically determine the reflection minimum based on the other values on
    // the
    // golf ball.  Basically figure out "bright" based on being on the high side
    // of the histogram
    const int brightness_percentage = 99;
    int brightness_cutoff;
    int lowestBrightess;
    int highest_brightness;
    GetImageCharacteristics(original_image,
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Lower cutoff for brightness is " + std::to_string(brightness_percentage) +
                     "%, grayscale value = " + std::to_string(brightness_cutoff));

    brightness_cutoff--;      // Make sure we don't filter out EVERYTHING
    // cv::Scalar lower = ((uchar)brightness_cutoff, (uchar)brightness_cutoff,
    // (uchar)brightness_cutoff);
    cv::Scalar lower = ((uchar)kReflectionMinimumRGBValue, (uchar)kReflectionMinimumRGBValue,
                        (uchar)kReflectionMinimumRGBValue);
    ...
    // LoggingTools::DebugShowImage("RemoveReflections - Initial thresholded
    // image = ", thresh);

    // Expand the bright reflection areas, because they are likely to be areas
    // where
    // the Gabor filters will show a lot of edges that will otherwise pollute
    // the statistics
    ...
    cv::Mat kernel = cv::getStructuringElement(cv::MORPH_ELLIPSE, cv::Size(kCloseKernelSize,
                                                                           kCloseKernelSize));
    // Morph is a binary (0 or 255) mask
    cv::Mat morph;
    cv::morphologyEx(thresh, morph, cv::MORPH_CLOSE, kernel, cv::Point(-1, -1),
                     /*iterations = */ 1);

    kernel = cv::getStructuringElement(cv::MORPH_ELLIPSE, cv::Size(kReflectionKernelDilationSize,
                                                                   kReflectionKernelDilationSize));                                      // originally
                                                                                                                                         // 25,25
    cv::morphologyEx(morph, morph, cv::MORPH_DILATE, kernel, cv::Point(-1, -1),
                     /*iterations = */ 1);

    // LoggingTools::DebugShowImage("RemoveReflections - Expanded thresholded
    // image = ", morph);

    // Iterate through the morphed, expanded mask image and set the
    // corresponding pixels to "ignore" in the filtered_image
...
cv::Mat BallImageProc::ReduceReflections(const cv::Mat &img, const cv::Mat &mask)
{
    ...
    cv::Scalar lower{ kReflectionMinimumRGBValue, kReflectionMinimumRGBValue,
                      kReflectionMinimumRGBValue };
    cv::Scalar upper{ 255, 255, 255 };
    ...
    kernel = cv::getStructuringElement(cv::MORPH_ELLIPSE, cv::Size(8, 8));       // originally
                                                                                 // 25,25
    cv::morphologyEx(morph, morph, cv::MORPH_DILATE, kernel, cv::Point(-1, -1),
                     /*iterations = */ 1);

    // Now re-apply the appropriate mask outside the circle to ensure that those
    // pixels are not considered, given
    ...
    LoggingTools::DebugShowImage("ReduceReflections - result1 (INPAINT_TELEA) (radius=" +
                                 std::to_string(inPaintRadius) + ") = ",
                                 result1);
...
cv::Mat BallImageProc::IsolateBall(const cv::Mat &img, GolfBall &ball)
{
    ...
    cv::Point offset_sub_to_full;
    cv::Point offset_full_to_sub;
    cv::Mat ball_image = CvUtils::GetSubImage(img, ballRect, offset_sub_to_full,
                                              offset_full_to_sub);

    // Draw the mask circle slightly smaller than the ball to prevent any bright
    // prenumbra around the isolated ball
    ...
    cv::Mat finalResult = MaskAreaOutsideBall(ball_image,
                                              ball,
                                              referenceBallMaskReductionFactor,
                                              cv::Scalar(0, 0, 0));
...
cv::Mat BallImageProc::MaskAreaOutsideBall(cv::Mat &ball_image,
                                           const GolfBall &ball,
                                           float mask_reduction_factor,
                                           const cv::Scalar &maskValue)
{
    // LoggingTools::DebugShowImage("MaskAreaOutsideBall - ball_image",
    // ball_image);

    // A white circle on a black background will act as our first mask to
    // preserve the ball portion of the image
    ...
    cv::circle(maskImage, cv::Point(ball.x(), ball.y()), mask_radius, cv::Scalar(255, 255, 255),
               -1);
    //LoggingTools::DebugShowImage("1st maskImage", maskImage);

    // At this point, maskImage is an image with a white circle and a black
    // outside
    ...
    // Now XOR the image-on-black with a on a rectangle of desired color and a
...
{
    // NOTE - This function (and downstream functions) assumes that ball1 is the
    // earlier-in-time ball
    // for a right-handed shot.  So, for example, the expected spin will be
    // largely counter-clockwise
    // from ball 1 to ball 2.
    // Make sure that for left-handed shots this is correct - we will assume
    // that for
    ...
    GS_LOG_TRACE_MSG(trace,
                     "GetBallRotation called with ball1 = " + ball1.Format() + ",\nball2 = " +
                     ball2.Format());
    ...
    // First, get a clean picture of each ball with nothing in the background,
    // both sized the exactly same way
    // Resize the images so that the balls are the same radius.

    GolfBall local_ball1 = ball1;
    GolfBall local_ball2 = ball2;

    // NOTE - The ball that is passed into the IsolateBall image will be
    // adjusted
    // to have the new x, y, and radius values relative to the smaller, isolated
    // picture
    ...
    if (GolfSimOptions::GetCommandLineOptions().artifact_save_level_ !=
        ArtifactSaveLevel::kNoArtifacts && kLogIntermediateSpinImagesToFile)
    {
        LoggingTools::LogImage("",
                               ball_image1,
                               std::vector < cv::Point >{},
                               true,
                               "log_view_ISOLATED_full_gray_image1.png");
        LoggingTools::LogImage("",
                               ball_image2,
                               std::vector < cv::Point >{},
                               true,
                               "log_view_ISOLATED_full_gray_image2.png");
    }
    ...
    local_ball1.measured_radius_pixels_ = local_ball1.measured_radius_pixels_ *
                                          ball1RadiusMultiplier;
    ...
    local_ball2.measured_radius_pixels_ = local_ball2.measured_radius_pixels_ *
                                          ball2RadiusMultiplier;
    ...
    cv::Mat ball_image1DimpleEdges = ApplyGaborFilterToBall(ball_image1,
                                                            local_ball1,
                                                            calibrated_binary_threshold);
    //  Suggest the same binary threshold between the images as a starting point
    // for the second ball - they are probably similar
    cv::Mat ball_image2DimpleEdges = ApplyGaborFilterToBall(ball_image2,
                                                            local_ball2,
                                                            calibrated_binary_threshold,
                                                            calibrated_binary_threshold);

    // TBD = Consider inverting the image to focus only on the inner parts of
    // the dimples that will
    // have fewer pixels?
    //cv::bitwise_not(ball_image1, ball_image1);
    //cv::bitwise_not(ball_image2, ball_image2);

    // LoggingTools::DebugShowImage("Ball1 Dimple Image",
    // ball_image1DimpleEdges);
    // LoggingTools::DebugShowImage("Ball2 Dimple Image",
    // ball_image2DimpleEdges);
    ...
    // TBD - In addition to removing reflections, we may also want to remove
    // really dark areas which will
    // comprise the registration marks.  That seems counter-intuitive, but those
    // marks sometimes create large
    ...
    ball_image1DimpleEdges = MaskAreaOutsideBall(ball_image1DimpleEdges,
                                                 local_ball1,
                                                 finalBallMaskReductionFactor,
                                                 ignoreColor);
    ball_image2DimpleEdges = MaskAreaOutsideBall(ball_image2DimpleEdges,
                                                 local_ball2,
                                                 finalBallMaskReductionFactor,
                                                 ignoreColor);
    LoggingTools::DebugShowImage("Final ball_image1DimpleEdges after masking outside",
                                 ball_image1DimpleEdges);
    LoggingTools::DebugShowImage("Final ball_image2DimpleEdges after masking outside",
                                 ball_image2DimpleEdges);

    // Finally, rotate the second ball image to make up for the angle imparted
    // by any offset of the ball from the
    // center of the camera's view.  Just reset the view using the angle offsets
    ...
    cv::Vec3f angleOffset1 = cv::Vec3f((float)ball1.angles_camera_ortho_perspective_[0],
                                       (float)ball1.angles_camera_ortho_perspective_[1],
                                       0);
    cv::Vec3f angleOffset2 = cv::Vec3f((float)ball2.angles_camera_ortho_perspective_[0],
                                       (float)ball2.angles_camera_ortho_perspective_[1],
                                       0);

    // We will split the difference in the angles so that the amount of
    // de-rotation we need to do is spread evenly
    // across the two images

    // angleOffsetDeltas1 (and the floating-point version) are the angles that
    // ball 1 must be rotated in
    // order to take it halfway to where ball 2 is
    cv::Vec3f angleOffsetDeltas1Float = (angleOffset2 - angleOffset1) / 2.0;

    // For left-handed shots, the first ball will be higher (and have a larger y
    // angle), than the first, so account for that here
    if (GolfSimOptions::GetCommandLineOptions().golfer_orientation_ ==
        GolferOrientation::kLeftHanded)
    {
        angleOffsetDeltas1Float[1] = -angleOffsetDeltas1Float[1];      // Account
                                                                       // for
                                                                       // how
                                                                       // our
                                                                       // rotations
    ...
    GetRotatedImage(unrotatedBallImg1DimpleEdges,
                    local_ball1,
                    angleOffsetDeltas1,
                    ball_image1DimpleEdges);

    GS_LOG_TRACE_MSG(trace,
                     "Adjusting rotation for camera view of ball 1 to offset (x,y,z)=" +
                     std::to_string(angleOffsetDeltas1[0]) + "," +
                     std::to_string(angleOffsetDeltas1[1]) + "," +
                     std::to_string(angleOffsetDeltas1[2]));
    LoggingTools::DebugShowImage("Final perspective-de-rotated filtered ball_image1DimpleEdges: ",
                                 ball_image1DimpleEdges,
                                 center1);

    // The second rotation deltas will be the remainder of (approximately) the
    // other half of the necessary degrees to get everything to be the same
    // perspective
    cv::Vec3i angleOffsetDeltas2 = CvUtils::Round(  -((angleOffset2 - angleOffset1) -
                                                      angleOffsetDeltas1Float));
    if (GolfSimOptions::GetCommandLineOptions().golfer_orientation_ ==
        GolferOrientation::kLeftHanded)
    {
        angleOffsetDeltas2[1] = std::round( -((angleOffset1[1] - angleOffset2[1]) -
                                              angleOffsetDeltas1Float[1]));
    }

    cv::Mat unrotatedBallImg2DimpleEdges = ball_image2DimpleEdges.clone();
    GetRotatedImage(unrotatedBallImg2DimpleEdges,
                    local_ball2,
                    angleOffsetDeltas2,
                    ball_image2DimpleEdges);
    GS_LOG_TRACE_MSG(trace,
                     "Adjusting rotation for camera view of ball 2 to offset (x,y,z)=" +
                     std::to_string(angleOffsetDeltas2[0]) + "," +
                     std::to_string(angleOffsetDeltas2[1]) + "," +
                     std::to_string(angleOffsetDeltas2[2]));
    LoggingTools::DebugShowImage("Final perspective-de-rotated filtered ball_image2DimpleEdges: ",
                                 ball_image2DimpleEdges,
                                 center1);

    // Although unnecessary for the algorithm, the following DEBUG code shows
    // the original image as it would appear rotated in the same way as the
    // Gabor-filtered balls
    ...
    LoggingTools::DebugShowImage("Final rotated originalBall1: ",
                                 normalizedOriginalBallImg1,
                                 center1);
    ...
    LoggingTools::DebugShowImage("Final rotated originalBall2: ",
                                 normalizedOriginalBallImg2,
                                 center2);

#ifdef __unix__
    // Save the normalized ball images to the webserver shared directory so that
    // the user
    // can compare them to the final rotated image.
    GsUISystem::SaveWebserverImage(GsUISystem::kWebServerResultSpinBall1Image,
                                   normalizedOriginalBallImg1);
    GsUISystem::SaveWebserverImage(GsUISystem::kWebServerResultSpinBall2Image,
                                   normalizedOriginalBallImg2);
#endif

    // Now compute all the possible rotations of the first image so we can
    // figure out which angles make it look like the second ball image
    ...
    ComputeCandidateAngleImages(ball_image1DimpleEdges,
                                initialSearchSpace,
                                outputCandidateElementsMat,
                                output_candidate_elements_mat_size,
                                candidates,
                                local_ball1);

    // Compare the second (presumably rotated) ball image to different candidate
    // rotations of the first ball image to determine the angular change
    std::vector<std::string> comparison_csv_data;
    int best_candidate_index = CompareCandidateAngleImages(&ball_image2DimpleEdges,
                                                           &outputCandidateElementsMat,
                                                           &output_candidate_elements_mat_size,
                                                           &candidates,
                                                           comparison_csv_data);
    ...
    GolfSimConfiguration::SetConstant("gs_config.spin_analysis.kWriteSpinAnalysisCsvFiles",
                                      write_spin_analysis_CSV_files);
    ...
    if (write_spin_analysis_CSV_files)
    {
        ...
        {
            // Don't use logging utility so that we don't have all the timing
            // crap in the output
    ...
    // See which angle looked best and then iterate more closely near those
    // angles
    RotationCandidate c = candidates[best_candidate_index];

    std::string s = "Best Coarse Initial Rotation Candidate was #" +
                    std::to_string(best_candidate_index) + " - Rot: (" +
                    std::to_string(c.x_rotation_degrees) + ", " +
                    std::to_string(c.y_rotation_degrees) + ", " +
                    std::to_string(c.z_rotation_degrees) + ") ";
    GS_LOG_MSG(debug, s);

    // Now iterate more closely in the area that looks best
    RotationSearchSpace finalSearchSpace;

    int anglex_window_width =
        (int)std::round(ceil(initialSearchSpace.anglex_rotation_degrees_increment / 2.));
    int angley_window_width =
        (int)std::round(ceil(initialSearchSpace.angley_rotation_degrees_increment / 2.));
    int anglez_window_width =
        (int)std::round(ceil(initialSearchSpace.anglez_rotation_degrees_increment / 2.));
    ...
    finalSearchSpace.angley_rotation_degrees_increment =
        (int) std::round(kCoarseYRotationDegreesIncrement / 2.);
    ...
    // After this, the finalOutputCandidateElementsMat will have X,Y,Z elements
    // with an index into the finalCandidates vector.
    // Each candidate in finalCandidates will have an image, associated X,Y,Z
    // information and a place to put a score
    ComputeCandidateAngleImages(ball_image1DimpleEdges,
                                finalSearchSpace,
                                finalOutputCandidateElementsMat,
                                finalOutputCandidateElementsMatSize,
                                finalCandidates,
                                local_ball1);

    // TBD - change CompareCandidateAngleImages to work directly with the "3D"
    // images
    best_candidate_index = CompareCandidateAngleImages(&ball_image2DimpleEdges,
                                                       &finalOutputCandidateElementsMat,
                                                       &finalOutputCandidateElementsMatSize,
                                                       &finalCandidates,
                                                       comparison_csv_data);
    ...
    if (best_candidate_index >= 0)
    {
        ...
        std::string s = "Best Raw Fine (and final) Rotation Candidate was #" +
                        std::to_string(best_candidate_index) + " - Rot: (" +
                        std::to_string(best_rot_x) + ", " + std::to_string(best_rot_y) + ", " +
                        std::to_string(best_rot_z) + ") ";
        GS_LOG_MSG(debug, s);

        /*** FOR DEBUG ***/
        cv::Mat bestImg3D = finalCandidates[best_candidate_index].img;
        cv::Mat bestImg2D = cv::Mat::zeros(ball_image1DimpleEdges.rows,
                                           ball_image1DimpleEdges.cols,
                                           ball_image1DimpleEdges.type());
    ...
    // The above angular deltas were calculated relative to a coordinate system
    // that is at an angle
    // from the camera to the balls. So...
    // Now translate the spin angles so that the axes are the same as the
    // PiTrac's and Sim's axes, where,
    // for example, the Z and Y axes are parallel to the ground plane on which
    // PiTrac sits, and the X axis
    // is orthogonal to that plane

    // We negated the Y offset delta before to account for the Sim's rotational
    // scheme, so will undo here.
    // The idea is to determine the angle to the point in space that was between
    // the two balls.
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Now normalizing for spin_offset_angle = (" +
                     std::to_string(spin_offset_angle[0]) + ", " +
                     std::to_string(spin_offset_angle[1]) + ", " +
                     std::to_string(spin_offset_angle[2]) + ").");
    ...
    int normalized_rot_x = (int)round((double)best_rot_x * cos(spin_offset_angle_radians_Y) +
                                      (double)best_rot_z * sin(spin_offset_angle_radians_Y));
    int normalized_rot_y = (int)round((double)best_rot_y * cos(spin_offset_angle_radians_X) -
                                      (double)best_rot_z * sin(spin_offset_angle_radians_X));

    int normalized_rot_z = (int)round((double)best_rot_z * cos(spin_offset_angle_radians_X) *
                                      cos(spin_offset_angle_radians_Y));
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Normalized spin angles (X,Y,Z) = (" + std::to_string(normalized_rot_x) +
                     ", " + std::to_string(normalized_rot_y) + ", " +
                     std::to_string(normalized_rot_z) + ").");

    // TBD _ DEBUG
    // See how the original image would look if rotated as the GetBallRotation
    // function calculated
    // We will NOT use the normalized rotations, as the UN-normalized rotations
    // will look most correct
    // in the context of the manner they are imaged by the camera.

    cv::Mat resultBball2DImage;

    GetRotatedImage(ball_image1DimpleEdges, local_ball1, cv::Vec3i(best_rot_x,
                                                                   best_rot_y,
                                                                   best_rot_z), resultBball2DImage);
        ...
        ArtifactSaveLevel::kNoArtifacts && kLogIntermediateSpinImagesToFile)
    {
        LoggingTools::LogImage("",
                               ...
                               std::vector < cv::Point >{},
                               true,
                               "Filtered Ball1_Rotated_By_Best_Angles.png");
    }

    // We want to show apples to apples, so show the normalized images
    cv::Mat test_ball1_image = normalizedOriginalBallImg1.clone();
    GetRotatedImage(normalizedOriginalBallImg1, local_ball1, cv::Vec3i(best_rot_x,
                                                                       best_rot_y,
                                                                       best_rot_z),
                    test_ball1_image);

    // We'll draw a center-dot on the final image here, but we're not going to
    // re-use that image, so it's ok
    cv::Scalar color{ 0, 0, 0 };
    const cv::Vec3f &circle = local_ball1.ball_circle_;
    cv::circle(test_ball1_image, cv::Point((int)local_ball1.x(),
                                           (int)local_ball1.y()), (int)circle[2], color,
               2 /*thickness*/);
    LoggingTools::DebugShowImage("Final rotated-by-best-angle originalBall1: ",
                                 test_ball1_image,
                                 center1);

#ifdef __unix__
    // Save the final, rotated, normalized ball result image to the webserver
    // shared directory so that the user
    // can compare them to the original normalized images.
    GsUISystem::SaveWebserverImage(GsUISystem::kWebServerResultBallRotatedByBestAngles,
                                   test_ball1_image);
#endif

    // Looks like golf folks consider the X (side) spin to be positive if the
    // surface is
...
struct ImgComparisonOp
{
    ...
    void operator ()(ushort &unusedValue, const int *position) const
    {
        ...
        //   " Rot: (" + std::to_string(c.x_rotation_degrees) + ", " +
        // std::to_string(c.y_rotation_degrees) + ", " +
        // std::to_string(c.z_rotation_degrees) + ") ";
        // GS_LOG_TRACE_MSG(trace, "Rotation Candidate: " + s);
        // LoggingTools::DebugShowImage("Img #" + std::to_string(c.index),
        // c.img);

        // Compare the second ball image to each of the rotated versions of the
        // first ball image to see which is closest
        ...
        // GS_LOG_TRACE_MSG(trace, "I=" + std::to_string(elementIndex) + ", Rot:
        // (" + std::to_string(c.x_rotation_degrees) + ", " +
        // std::to_string(c.y_rotation_degrees) + ", " +
        // std::to_string(c.z_rotation_degrees) + ") " + ".Score : " +
        // std::to_string(results[0]) + " out of " + std::to_string(results[1])
        // +
        //    ". Scaled = " + std::to_string(scaledScore);

        // CSV (Excel) File format - Comma-Seperated-Values for Excel
        // spreadsheet export
        // Columns are Idx, Rotx, Roty, Rotz, Score, Out-of, ScaledScore
        std::string s = std::to_string(c.index) + "\t" + std::to_string(c.x_rotation_degrees) +
                        "\t" + std::to_string(c.y_rotation_degrees) + "\t" +
                        std::to_string(c.z_rotation_degrees) + "\t" + std::to_string(results[0]) +
                        "\t" + std::to_string(results[1]) +
...
// Create temporary nonce objects because C++ requires references to point to a
// valid object.
// the null/nonce references will go out of scope after setup() is called and
// these references
                                               ...
                                               std::vector<std::string> &comparison_csv_data)
{
    ...
    // Assume candidates is a vector that is already pre-sized and filled with
    // candidate information
    // and that the candidate_elements_mat has x, y, and z bounds that are
    // commensurate with the candidates vector
    ...
    for (auto &element : *candidates)
    {
        ...
        low_count_penalty = std::pow((maxPixelsExamined - (double)c.pixels_examined) /
                                     kSpinLowCountDifferenceWeightingFactor,
    ...
    std::string s = "Best Candidate based on number of matching pixels was #" +
                    std::to_string(maxPixelsMatchingIndex) +
                    " - Rot: (" + std::to_string(bestPixelsMatchingRotX) + ", " +
                    std::to_string(bestPixelsMatchingRotY) + ", " +
                    std::to_string(bestPixelsMatchingRotZ) + ") ";
    // GS_LOG_MSG(debug, s);

    s = "Best Candidate based on its scaled score of (" + std::to_string(maxScaledScore) +
        ") was # " + std::to_string(maxScaledScoreIndex) +
                                              ...
                                              const int index)
{
    ...
    // DEBUG - create a binary image showing what pixels are the same between
    // them
    ...
    // LoggingTools::DebugShowImage("testCorrespondenceImg #" +
    // std::to_string(index), testCorrespondenceImg);
    // WON'T WORK BECAUSE IMG2 is 3D
    // LoggingTools::DebugShowImage("testCandidateImg #" +
    // std::to_string(index), img2);

    cv::Vec2i result(score, totalPixelsExamined);
    return result;
}

cv::Mat BallImageProc::CreateGaborKernel(int ks,
                                         double sig,
                                         double th,
                                         double lm,
                                         double gm,
                                              ...
                                              float prior_binary_threshold)
{
    ...
    // This two-step calculation of the kernel parameters allows us to use the
    // first set in a
    // testing/playground environment with easier-to-control parameters and then
    // convert as necessary to
    ...
    int pos_sigma = 2;
    int pos_lambda = 6;       // Nominal: 13.  Lambda = 5 and Gamma = 4 or 3
                              // also works well. last was 8
    int pos_gamma = 4;       // Nominal: 4, might try 3
    int pos_th = 60;       // Nominal:
    int pos_psi = 9;      // Seems to have to be 9 or 27.  Will be multiplied by
                          // 3 degrees - CRITICAL - other values do not work at
                          // all
    ...
    int pos_th = 60;       // Nominal:
    int pos_psi = 27;      // Will be multiplied by 3 degrees - CRITICAL - other
    ...
    cv::Mat dimpleImg = ApplyTestGaborFilter(img_f32,
                                             kernel_size,
                                             sig,
                                             lm,
                                             th,
    ...
    GS_LOG_TRACE_MSG(trace,
                     "Initial Gabor filter white percent = " + std::to_string(white_percent));

    bool ratheting_threshold_down = (white_percent < kGaborMinWhitePercent);

    // Give it a second go if we're too white or too black and haven't already
    // overridden the binary threshold
    if (prior_binary_threshold < 0 &&
        (white_percent < kGaborMinWhitePercent || white_percent >= kGaborMaxWhitePercent))
    {
        // Keep going down or up (depending on the ractchet direction) until we
        // get within a reasonable
        // white-ness range
        while (white_percent < kGaborMinWhitePercent || white_percent >= kGaborMaxWhitePercent)
        {
            ...
            if (ratheting_threshold_down)
            {
                ...
                GS_LOG_TRACE_MSG(trace,
                                 "Trying lower gabor binary_threshold setting of " +
                                 std::to_string(binary_threshold) + " for better balance.");
            }
            else
            {
                ...
                GS_LOG_TRACE_MSG(trace,
                                 "Trying higher gabor binary_threshold setting of " +
                                 std::to_string(binary_threshold) + " for better balance.");
            }

            dimpleImg = ApplyTestGaborFilter(img_f32,
                                             kernel_size,
                                             sig,
                                             lm,
                                             th,
                                             ...
                                             white_percent);
            GS_LOG_TRACE_MSG(trace,
                             "Next, refined, Gabor white percent = " +
                             std::to_string(white_percent));

            // If we've gone as far as we can, just return
            if (binary_threshold > 30 || binary_threshold < 2)
            {
                GS_LOG_MSG(warning,
                           "Binaary threshold for Gabor filter reached limit of " +
                           std::to_string(binary_threshold));
                break;
            }
        }

        // Return the final threshold so that the caller can use for subsequent
        // calls
                                            ...
                                            int &white_percent  )
{
    ...
    // Sweep through a bunch of different angles for the filter in order to pick
    // up features
    // in all directions
    const double thetaIncrement = 11.25;     //  5.625; // CURRENT 11.25;  //
                                             // degrees.  Nominal: 11.25 also
                                             // works
    ...
    white_percent = (int)std::round(((double)cv::countNonZero(dimpleEdges) * 100.) /
                                    ((double)dimpleEdges.rows * dimpleEdges.cols));
                                                ...
                                                const GolfBall &ball)
{
    ...
    // The ball may not be perfectly centered in the middle of the camera's
    // gaze.  To account for that,
    // the system will essentially rotate the ball to the view the camera would
    // have if it were centered.
    // This is done here by shifting the angles that will be simulated by
    // offsets that account for the
    // ball placement

    // TBD - Think hard about how we want to apply the angle offset.  For
    // example, we don't want to
    // "lose" some of the image because of (for example) moving pixels to the
    // front of the ball from behind it,
    // only to then apply the offset and move the ball back where it was before
    // the pixels were lost.

    // CHANGE - we are going to deal with any camera perspective by
    // pre-de-rotating both of the balls
    ...
    int xSize = (int)std::ceil((anglex_rotation_degrees_end - anglex_rotation_degrees_start) /
                               anglex_rotation_degrees_increment) + 1;
    int ySize = (int)std::ceil((angley_rotation_degrees_end - angley_rotation_degrees_start) /
                               angley_rotation_degrees_increment) + 1;
    int zSize = (int)std::ceil((anglez_rotation_degrees_end - anglez_rotation_degrees_start) /
                               anglez_rotation_degrees_increment) + 1;

    // Let the caller know what size of matrix we are going to return.  OpenCv
    // only gives rows and columns,
    // so we need to handle this ourselves.

    output_candidate_elements_mat_size = cv::Vec3i(xSize, ySize, zSize);

    GS_LOG_TRACE_MSG(trace,
                     "ComputeCandidateAngleImages will compute " +
                     std::to_string(xSize * ySize * zSize) + " images.");

    // Create a new 3D Mat to hold indexes to the results in the vector.  Use a
    // Mat in order to exploit the forEach() function
    ...
    for (int x_rotation_degrees = anglex_rotation_degrees_start, xIndex = 0;
         x_rotation_degrees <= anglex_rotation_degrees_end;
         x_rotation_degrees += anglex_rotation_degrees_increment, xIndex++)
    {
        for (int y_rotation_degrees = angley_rotation_degrees_start, yIndex = 0;
             y_rotation_degrees <= angley_rotation_degrees_end;
             y_rotation_degrees += angley_rotation_degrees_increment, yIndex++)
        {
            for (int z_rotation_degrees = anglez_rotation_degrees_start, zIndex = 0;
                 z_rotation_degrees <= anglez_rotation_degrees_end;
                 z_rotation_degrees += anglez_rotation_degrees_increment, zIndex++)
            {
                cv::Mat ball2DImage;
                // TBD - Instead of this, call the projectTo3D function and then
                // use the resulting
                // matrix directly in the comparison
                // GetRotatedImage(base_dimple_image, ball,
                // cv::Vec3i(x_rotation_degrees, y_rotation_degrees,
                // z_rotation_degrees), ball2DImage);

                // Project the ball out onto a 3D hemisphere at the current x,
                // y, and z-axis rotation
                cv::Mat ball13DImage = Project2dImageTo3dBall(base_dimple_image, ball,
                                                              cv::Vec3i(x_rotation_degrees,
                                                                        y_rotation_degrees,
                                                                        z_rotation_degrees));

                // Save the current image as a possible candidate to compare to
                // later
                RotationCandidate c;

                // The angles in the set of images we are building are angles
                // calculated as if the ball was
                ...
                // For now, just throw all of the candidates into a big vector
                // indexed by the entries in the matrix
                ...
                /* std::string s = "ComputeCandidateAngleImages - Rotation
                 * Candidate: Idx: " + std::to_string(c.index) +
                 *  " Rot: (" + std::to_string(c.x_rotation_degrees) + ", " +
                 * std::to_string(c.y_rotation_degrees) + ", " +
                 * std::to_string(c.z_rotation_degrees) + ") ";
                 * GS_LOG_MSG(debug, s);
                 ...
                 * cv::Mat::zeros(base_dimple_image.rows,
                 * base_dimple_image.cols, base_dimple_image.type());
                 * Unproject3dBallTo2dImage(ball13DImage, outputGrayImg, ball);
                 * LoggingTools::DebugShowImage("Candidate Image at Rot: (" +
                 * std::to_string(c.x_rotation_degrees) + ", " +
                 * std::to_string(c.y_rotation_degrees) + ", " +
                 * std::to_string(c.z_rotation_degrees) + "): ", outputGrayImg);
                 */
            }
        }
    }
...
void BallImageProc::GetRotatedImage(const cv::Mat &gray_2D_input_image,
                                    const GolfBall &ball,
                                    ...
                                    cv::Mat &outputGrayImg)
{
    ...
    // Project the ball out onto a 3D hemisphere at the current x, y, and z-axis
    // rotation
    ...
    outputGrayImg = cv::Mat::zeros(gray_2D_input_image.rows,
                                   gray_2D_input_image.cols,
                                   gray_2D_input_image.type());
...
struct projectionOp
{
                      ...
                      const double &z_rotation_degreesAngleRad )
    {
        ...
        // Copy the rows/cols from the image because openCV will not do so
        // otherwise
        // TBD - Kind of a hack
        ...
        // Pre-compute the trig functions for speed.  They will be the same for
        ...
        // If some of the angles are 0, then we don't need to do any math at all
        // for that axis or axes
        /* DELETE OLD
         * rotatingOnX_ = ((int)std::round(1000 * x_rotation_degreesAngleRad_)
         * != 0) ? true : false;
         * rotatingOnY_ = ((int)std::round(1000 * y_rotation_degreesAngleRad_)
         * != 0) ? true : false;
         * rotatingOnZ_ = ((int)std::round(1000 * z_rotation_degreesAngleRad_)
         * != 0) ? true : false;
         */
    ...
    // The returned imageXFromCenter and imageYFromCenter are the original
    // imageX & Y in a new coordinate system with the center of the ball at
    // (0,0)
    static void getBallZ(const double imageX,
                         const double imageY,
                         double &imageXFromCenter,
                         double &imageYFromCenter,
                         double &ball3dZ)
    {
        // Basic idea:  x2 + y2 + z2 = r2  (2's are squared).  Just solve for z
        // where we can
        ...
        // Project the x,y coordinate onto the hemisphere to get the Z-axis
        // position
    ...
    // The sparse Z values associated with the X,Y pairs of the 3D images will
    // be >= 0, because
    // the X,Y rays from the 2D image will be projected only on the closest
    // hemisphere
    void operator ()(uchar &pixelValue, const int *position) const
    {
        ...
        bool prerotatedPointNotValid = (ball3dZOfUnrotatedPoint <= 0.0001);      // A
                                                                                 // 0
                                                                                 // value
                                                                                 // from
                                                                                 // getBallZ
        ...
        // If the point we are rotating FROM is not on the visible hemisphere,
        // set its pixel value to Ignore it.
        // Really, any point outside the sphere should already be set to ignore.
        if (prerotatedPointNotValid)
        {
            // ignore the original, pre-rotated pixel - it came from somehwere
            // outside the hemisphere,
            // possibly from behind it.
            // std::cout << "CV_ELEM_SIZE1(traits::Depth<_Tp>::value): " <<
            // CV_ELEM_SIZE1(projectedImg_.traits::Depth<_Tp>::value) <<
            // "elemSize1()" << projectedImg_.elemSize1() << std::endl;
            // TBD - Not sure we even need to bother with this?

            projectedImg_.at<cv::Vec2i>((int)imageX, (int)imageY)[0] = (int)ball3dZOfUnrotatedPoint;        // TBD
                                                                                                            // -
                                                                                                            // Wait,
                                                                                                            // is
                                                                                                            // this
        ...
        // Note - this method is likely to leave a lot of gaps in the
        // unprojected image.  Consider interpolation?
        // GS_LOG_TRACE_MSG(trace, "projectionOp Result:  [" +
        // std::to_string(imageX) + ", " + std::to_string(imageX) + ", " +
        // std::to_string(ball3dZ) + "]=" + std::to_string(pixelValue));

        double imageZ = ball3dZOfUnrotatedPoint;     // Note - the z axis is
                                                     // already situated with
                                                     // the origin in the center

        // X-axis rotation
        if (rotatingOnX_)
        {
            double tmpImageYFromCenter = imageYFromCenter;      // Want to
                                                                // change both Y
                                                                // and Z at the
                                                                // same time
        ...
        double dummy_rotatedImageXFromCenter;      // Just used as a dummy
                                                   // variable to get the new Z
        double dummy_rotatedImageYFromCenter;      // Just used as a dummy
                                                   // variable to get the new Z

        getBallZ(imageX,
                 imageY,
                 dummy_rotatedImageXFromCenter,
                 dummy_rotatedImageYFromCenter,
                 ball3dZOfRotatedPoint);

        if (currentBall_->PointIsInsideBall(imageX, imageY) && ball3dZOfRotatedPoint < 0.001)
        {
            GS_LOG_TRACE_MSG(trace,
                             "Project2dImageTo3dBall Z-value pixel within ball at (" +
                             std::to_string(imageX) +
                             ", " + std::to_string(imageY) + ").");
        }

        // Some of the points (like the corners) may rotate out to a place that
        // is outside of the image Mat
        // If so, just ignore that point
        // Also, if the Z point that we've rotated the current pixel to is now
        // *behind* the ball surface that the camera sees, then just ignore it
            ...
            ball3dZOfRotatedPoint > 0.0)
        {
            ...
            // Instead of performing a zillion round operations, we'll just
            // effectively floor (truncate)
            // each x and y value.  We'll lose some accuracy, but if everything
            // is floored, it should at least
            // still be consistent.
            // projectedImg_.at<cv::Vec2i>((int)imageX, (int)imageY)[0] =
            // (int)std::round(ball3dZOfRotatedPoint);

            int roundedImageX = (int)(imageX + 0.5);
            int roundedImageY = (int)(imageY + 0.5);

            // GS_LOG_TRACE_MSG(trace, "RoundedImage X&Y were: (" +
            // std::to_string(roundedImageX) + ", " +
            // std::to_string(roundedImageY) + ").");

            // If the final, new pixel came from an invalid place, don't allow
            // it to pollute the rotated image
            // Not rounding here helped increase performance
            projectedImg_.at<cv::Vec2i>(roundedImageX,
                                        roundedImageY)[0] = (int)(ball3dZOfRotatedPoint);

            /** TBD - DEBUG ONLY
             * if (currentBall_->PointIsInsideBall(roundedImageX, roundedImageY)
             * && pixelValue == kPixelIgnoreValue) {
             *  GS_LOG_TRACE_MSG(trace, "Project2dImageTo3dBall found ignore
             * pixel within ball at (" + std::to_string(roundedImageX) +
             *              ", " + std::to_string(roundedImageY) + ").");
             * }
             */
            projectedImg_.at<cv::Vec2i>(roundedImageX,
                                        roundedImageY)[1] =
                (prerotatedPointNotValid ? kPixelIgnoreValue : pixelValue);
        }
        else
        {
            /** TBD - DEBUG ONLY
             * if (currentBall_->PointIsInsideBall(imageX, imageY)) {
             *  GS_LOG_TRACE_MSG(trace, "Project2dImageTo3dBall SKIPPED a pixel
             * at (" + std::to_string(imageX) +
             *      ", " + std::to_string(imageY) + ").");
             * }
             */
        }
...
// Positive X-axis angles rotate so that the ball appears to go from left to
// right
...
// The image_gray input Mat is expected to have pixels with only 0, 255, or
// kPixelIgnoreValue
cv::Mat BallImageProc::Project2dImageTo3dBall(const cv::Mat &image_gray,
                                              const GolfBall &ball,
                                              const cv::Vec3i &rotation_angles_degrees)
{
    ...
    int sizes[2] = { image_gray.rows, image_gray.cols };      // , image_gray.rows
                                                              // };
    // It's possible that due to rotations, some of the 3D image might have
    // "holes" where
    // the pixel was not set to a value.  Make sure anything we don't set is
    // ignored.
    ...
    // Kind of a hack, because a 3D Mat won't usually have these values set.
    //  TBD
    projectedImg.rows = image_gray.rows;
    projectedImg.cols = image_gray.cols;

    // Setup the global structures we need before we do the parallelized
    // callback to process
    // the 2D image
    // Negative due to rotation in X axis being backward
    projectionOp::setup(
        &ball,
        projectedImg,
    ...
    if (kSerializeOpsForDebug)
    {
        /*  Serialized version for debugging - use the parallel stuff below for
         * release */
        for (int x = 0; x < image_gray.cols; x++)
        {
            for (int y = 0; y < image_gray.rows; y++)
            {
                ...
                // TBD - Translate x and y into a new coordinate system that has
                // the origin
                // at the center of the ball.
                if (ball.PointIsInsideBall(x, y) && pixel == kPixelIgnoreValue)
                {
                    GS_LOG_TRACE_MSG(trace,
                                     "Project2dImageTo3dBall found ignore pixel within ball at (" +
...
void BallImageProc::Unproject3dBallTo2dImage(const cv::Mat &src3D,
                                             cv::Mat &destination_image_gray,
                                             const GolfBall &ball)
{
    // TBD - We already essentially have a 2D Mat.  So why spend all this time
    // copying?
    // Can we just go on to use the 3D Mat?
    // Currently, this function is only used when we need to display one of the
    // 3D projections.
    for (int x = 0; x < destination_image_gray.cols; x++)
    {
        for (int y = 0; y < destination_image_gray.rows; y++)
        {
            ...
            // The reduced image is a set of uints, so we seem to need to
            // normalize to 0-255 - TBD - why??
             ...
             *  GS_LOG_TRACE_MSG(trace, "Unproject3dBallTo2dImage found
             * different pixel value of " + std::to_string(pixelValue) +
             *      " (was " + std::to_string(original_pixel_value) + ") at( " +
             * std::to_string(x) + ", " + std::to_string(y) + ").");
             * }
             * // std::cout << "pixel from 3D image: " << (int)pixelValue <<
             * std::endl;
             */
            destination_image_gray.at<uchar>(x, y) = pixelValue;      // was
                                                                      // uchar

            // FOR DEBUG ONLY
            /* ONLY FOR DEBUG - TBD
             * if (ball.PointIsInsideBall(x, y) && pixelValue ==
             * kPixelIgnoreValue) {
             *  GS_LOG_TRACE_MSG(trace, "Unproject3dBallTo2dImage found ignore
             * pixel within ball at (" + std::to_string(x) + ", " +
             * std::to_string(y) + ").");
             * }
             */
        }
    ...
    // LoggingTools::DebugShowImage("destination_image_gray",
    // destination_image_gray);
    // We're trying to fill in holes here, but this may be fuzzing up the
    // picture too much
    // See if there is a better morphology or interpolation or something
    // TBD- BAD???cv::morphologyEx(destination_image_gray,
    // destination_image_gray, cv::MORPH_CLOSE,
    // cv::getStructuringElement(cv::MORPH_RECT, cv::Size(3, 3)));

    /**** All of the following attempts for hole-filling have failed:
     * LoggingTools::DebugShowImage("(open) destination_image_gray",
     * destination_image_gray);
     *
     ...
     * cv::morphologyEx(destination_image_gray, single_pixels,
     * cv::MORPH_HITMISS, kernel);
     ...
     * cv::bitwise_and(destination_image_gray, destination_image_gray,
     * destination_image_gray, single_pixels_inv);
     * LoggingTools::DebugShowImage("(closed) destination_image_gray",
     * destination_image_gray);
     *
     *
     * OR-----------------
     ...
     * cv::bitwise_not(destination_image_gray,
     * destination_image_grayComplement);
     * LoggingTools::DebugShowImage("destination_image_grayComplement",
     * destination_image_grayComplement);
     *
     ...
     *
     * cv::Mat hitOrMiss1;
     * cv::morphologyEx(destination_image_gray, hitOrMiss1, cv::MORPH_HITMISS,
     * kernel2);
     * destination_image_gray = hitOrMiss1;
     * /*
     * cv::morphologyEx(destination_image_gray, hitOrMiss1, cv::MORPH_ERODE,
     * kernel1);
     * LoggingTools::DebugShowImage("hitOrMiss1", hitOrMiss1);
     * cv::Mat hitOrMiss2;
     * cv::morphologyEx(destination_image_grayComplement, hitOrMiss2,
     * cv::MORPH_ERODE, kernel2);
