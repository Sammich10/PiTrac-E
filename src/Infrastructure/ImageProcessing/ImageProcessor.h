...
// TBD - The separation of responsibilities with the PiTrac_camera needs to be clarified.
...
public:
    ...
    static cv::RotatedRect FindLargestEllipse(cv::Mat& img, const cv::Vec3f& reference_ball_circle, int mask_radius);
