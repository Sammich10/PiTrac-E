...
#ifndef GS_BLOCKING_QUEUE_H
#define GS_BLOCKING_QUEUE_H
...
// However, this one has a timed-out "pop" functionality, so that you don't wait
// forever on a pop call to an empty queue.
